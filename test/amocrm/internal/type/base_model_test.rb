...
class Amocrm::Test::PrimitiveModelTest < Minitest::Test
  A = Amocrm::Internal::Type::ArrayOf[-> { Integer }]
  H = Amocrm::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Amocrm::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Amocrm::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Amocrm::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Amocrm::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Amocrm::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Amocrm::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Amocrm::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Amocrm::Internal::Type::Boolean, true] => true,
      [Amocrm::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Amocrm::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Amocrm::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Amocrm::Internal::Type::Converter.new_coerce_state
      Amocrm::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Amocrm::Internal::Type::Converter.dump(target, input, state: state)
...
class Amocrm::Test::EnumModelTest < Minitest::Test
  class E0
    include Amocrm::Internal::Type::Enum
...
class Amocrm::Test::CollectionModelTest < Minitest::Test
  A1 = Amocrm::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Amocrm::Internal::Type::HashOf[Integer]

  A2 = Amocrm::Internal::Type::ArrayOf[H1]
  H2 = Amocrm::Internal::Type::HashOf[-> { A1 }]

  A3 = Amocrm::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Amocrm::Internal::Type::HashOf[Integer, nil?: true]
...
class Amocrm::Test::BaseModelTest < Minitest::Test
  class M1 < Amocrm::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Amocrm::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Amocrm::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Amocrm::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Amocrm::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Amocrm::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Amocrm::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Amocrm::Errors::ConversionError => e
...
class Amocrm::Test::UnionTest < Minitest::Test
  class U0
    include Amocrm::Internal::Type::Union
  ...
  class M2 < Amocrm::Internal::Type::BaseModel
  ...
  class M4 < Amocrm::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Amocrm::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Amocrm::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Amocrm::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Amocrm::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Amocrm::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Amocrm::Internal::Type::Unknown, Amocrm::Internal::Type::Unknown] => true,
      [Amocrm::Internal::Type::Boolean, Amocrm::Internal::Type::Boolean] => true,
      [Amocrm::Internal::Type::Unknown, Amocrm::Internal::Type::Boolean] => false,
...
class Amocrm::Test::MetaInfoTest < Minitest::Test
  A1 = Amocrm::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Amocrm::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
