...
class AmocrmTest < Minitest::Test
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: Amocrm::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Amocrm::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
