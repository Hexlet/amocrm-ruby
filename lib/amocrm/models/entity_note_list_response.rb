...
module Amocrm
  module Models
    ...
    module EntityNoteListResponse
      ...
      variant -> { Amocrm::Models::EntityNoteListResponse::NoteListResponse }

      variant -> { Amocrm::Models::EntityNoteListResponse::Problem }

      class NoteListResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::EntityNoteListResponse::NoteListResponse::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::EntityNoteListResponse::NoteListResponse::Embedded }
        ...
        #   @param _embedded [Amocrm::Models::EntityNoteListResponse::NoteListResponse::Embedded]
        #   @param _links [Object]
        #   @param _page [Integer]

        # @see Amocrm::Models::EntityNoteListResponse::NoteListResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute notes
          #
          #   @return [Array<Amocrm::Models::EntityNoteListResponse::NoteListResponse::Embedded::Note>, nil]
          optional :notes,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::EntityNoteListResponse::NoteListResponse::Embedded::Note] }

          # @!method initialize(notes: nil)
          #   @param notes [Array<Amocrm::Models::EntityNoteListResponse::NoteListResponse::Embedded::Note>]
      ...
      #   @return [Array(Amocrm::Models::EntityNoteListResponse::NoteListResponse, Amocrm::Models::EntityNoteListResponse::Problem)]
    end
  end
end
