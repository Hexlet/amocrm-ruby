...
module Amocrm
  module Models
    ...
    class APIUsersCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::APIUsersCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIUsersCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::APIUsersCreateParams::Body::Rights, nil]
        optional :rights, -> { Amocrm::APIUsersCreateParams::Body::Rights }
        ...
        #   @param rights [Amocrm::Models::APIUsersCreateParams::Body::Rights]

        # @see Amocrm::Models::APIUsersCreateParams::Body#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::APIUsersCreateParams::Body::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> {
                     Amocrm::Internal::Type::ArrayOf[Amocrm::APIUsersCreateParams::Body::Rights::StatusRight]
                   },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::APIUsersCreateParams::Body::Rights::StatusRight>, nil]
          #   @param tasks [Object]
