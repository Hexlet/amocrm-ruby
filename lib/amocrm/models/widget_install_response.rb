...
module Amocrm
  module Models
    ...
    module WidgetInstallResponse
      ...
      variant -> { Amocrm::Models::WidgetInstallResponse::Widget }

      variant -> { Amocrm::Models::WidgetInstallResponse::Problem }
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        optional :rating, union: -> { Amocrm::Models::WidgetInstallResponse::Widget::Rating }, nil?: true
        ...
        #
        #   @return [Array<Amocrm::Models::WidgetInstallResponse::Widget::SettingsTemplate>, nil]
        optional :settings_template,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::WidgetInstallResponse::Widget::SettingsTemplate] }

        # @!attribute version
        #
        #   @return [String, Integer, nil]
        optional :version, union: -> { Amocrm::Models::WidgetInstallResponse::Widget::Version }, nil?: true
        ...
        #   @param settings_template [Array<Amocrm::Models::WidgetInstallResponse::Widget::SettingsTemplate>]
        #   @param version [String, Integer, nil]

        # @see Amocrm::Models::WidgetInstallResponse::Widget#rating
        module Rating
          extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::WidgetInstallResponse::Widget#version
        module Version
          extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::WidgetInstallResponse::Widget, Amocrm::Models::WidgetInstallResponse::Problem)]
    end
  end
end
