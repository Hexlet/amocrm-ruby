...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#roles_update_by_id
    module APIRolesUpdateByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIRolesUpdateByIDResponse::Role }

      variant -> { Amocrm::Models::APIRolesUpdateByIDResponse::Problem }
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded }
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights, nil]
        optional :rights, -> { Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights }

        # @!method initialize(id: nil, _embedded: nil, _links: nil, name: nil, rights: nil)
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded]
        #   @param _links [Object]
        #   @param name [String]
        #   @param rights [Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights]

        # @see Amocrm::Models::APIRolesUpdateByIDResponse::Role#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute users
          #
          #   @return [Array<Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded::User>, nil]
          optional :users,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded::User] }

          # @!method initialize(users: nil)
          #   @param users [Array<Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded::User>]
        ...
        # @see Amocrm::Models::APIRolesUpdateByIDResponse::Role#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights::StatusRight] },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights::StatusRight>, nil]
          #   @param tasks [Object]
      ...
      #   @return [Array(Amocrm::Models::APIRolesUpdateByIDResponse::Role, Amocrm::Models::APIRolesUpdateByIDResponse::Problem)]
    end
  end
end
