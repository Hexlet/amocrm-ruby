...
module Amocrm
  module Models
    ...
    module APIEntityLinksLinkResponse
      ...
      variant -> { Amocrm::Models::APIEntityLinksLinkResponse::EmptyResponse }

      variant -> { Amocrm::Models::APIEntityLinksLinkResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIEntityLinksLinkResponse::EmptyResponse, Amocrm::Models::APIEntityLinksLinkResponse::Problem)]
    end
  end
end
