...
module Amocrm
  module Models
    ...
    module APIWebhooksSubscribeResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIWebhooksSubscribeResponse::Webhook }

      variant -> { Amocrm::Models::APIWebhooksSubscribeResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIWebhooksSubscribeResponse::Webhook, Amocrm::Models::APIWebhooksSubscribeResponse::Problem)]
    end
  end
end
