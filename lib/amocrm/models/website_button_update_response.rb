...
module Amocrm
  module Models
    ...
    module WebsiteButtonUpdateResponse
      ...
      variant -> { Amocrm::Models::WebsiteButtonUpdateResponse::WebsiteButton }

      variant -> { Amocrm::Models::WebsiteButtonUpdateResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::WebsiteButtonUpdateResponse::WebsiteButton, Amocrm::Models::WebsiteButtonUpdateResponse::Problem)]
    end
  end
end
