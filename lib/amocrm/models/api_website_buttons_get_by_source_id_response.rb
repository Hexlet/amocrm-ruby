...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#website_buttons_get_by_source_id
    module APIWebsiteButtonsGetBySourceIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIWebsiteButtonsGetBySourceIDResponse::WebsiteButton }

      variant -> { Amocrm::Models::APIWebsiteButtonsGetBySourceIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIWebsiteButtonsGetBySourceIDResponse::WebsiteButton, Amocrm::Models::APIWebsiteButtonsGetBySourceIDResponse::Problem)]
    end
  end
end
