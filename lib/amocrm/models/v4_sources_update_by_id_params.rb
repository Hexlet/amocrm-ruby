...
module Amocrm
  module Models
    ...
    class V4SourcesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      optional :services, union: -> { Amocrm::V4SourcesUpdateByIDParams::Services }
      ...
      module Services
        ...
        variant -> { Amocrm::Models::V4SourcesUpdateByIDParams::Services::UnionMember0Array }

        variant -> { Amocrm::Models::V4SourcesUpdateByIDParams::Services::StringArray }
