...
module Amocrm
  module Models
    ...
    class APILeadsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute _embedded
      #
      #   @return [Amocrm::Models::APILeadsUpdateByIDParams::Embedded, nil]
      optional :_embedded, -> { Amocrm::APILeadsUpdateByIDParams::Embedded }
      ...
      #
      #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue] }
      ...
      #   Tags to attach
      #
      #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #   Tags to delete
      #
      #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute companies
        #
        #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Company>, nil]
        optional :companies,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::Embedded::Company] }

        # @!attribute contacts
        #
        #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact>, nil]
        optional :contacts,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::Embedded::Contact] }

        # @!attribute metadata
        #
        #   @return [Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Metadata, nil]
        optional :metadata, -> { Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata }

        # @!attribute source
        #
        #   @return [Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Source, nil]
        optional :source, -> { Amocrm::APILeadsUpdateByIDParams::Embedded::Source }

        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::Embedded::Tag] }

        # @!method initialize(companies: nil, contacts: nil, metadata: nil, source: nil, tags: nil)
        #   @param companies [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Company>]
        #   @param contacts [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact>]
        #   @param metadata [Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Metadata]
        #   @param source [Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Source]
        #   @param tags [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Tag>]
        ...
        class Contact < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue>, nil]
          optional :custom_fields_values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue] }
          ...
          #   @param id [Integer]
          #
          #   @param custom_fields_values [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue>] Custom fields payload (same as contact create API)
          #
          ...
          class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value>]
            required :values,
                     -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value] }
            ...
            #   @param values [Array<Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
            #
            ...
            class Value < Amocrm::Internal::Type::BaseModel
              ...
              required :value,
                       union: -> { Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value::Value }
              ...
              # @see Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value#value
              module Value
        ...
        # @see Amocrm::Models::APILeadsUpdateByIDParams::Embedded#metadata
        class Metadata < Amocrm::Internal::Type::BaseModel
          # @!attribute category
          #   Unsorted category
          #
          #   @return [Symbol, Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Metadata::Category, nil]
          optional :category, enum: -> { Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::Category }

          # @!attribute form_id
          #   Form id in your system (string or numeric)
          #
          #   @return [String, Integer, nil]
          optional :form_id, union: -> { Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::FormID }
          ...
          #   @param category [Symbol, Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Metadata::Category] Unsorted category
          #
          ...
          # Unsorted category
          #
          # @see Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Metadata#category
          module Category
          ...
          # Form id in your system (string or numeric)
          #
          # @see Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Metadata#form_id
          module FormID
            extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::APILeadsUpdateByIDParams::Embedded#source
        class Source < Amocrm::Internal::Type::BaseModel
          # @!attribute external_id
          #   External id in your system
          #
          #   @return [String, Integer, Boolean, nil]
          optional :external_id, union: -> { Amocrm::APILeadsUpdateByIDParams::Embedded::Source::ExternalID }
          ...
          # External id in your system
          #
          # @see Amocrm::Models::APILeadsUpdateByIDParams::Embedded::Source#external_id
          module ExternalID
            extend Amocrm::Internal::Type::Union
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #   Values for the field (multiple values allowed)
        #
        #   @return [Array<Amocrm::Models::APILeadsUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        # @!method initialize(values:, field_code: nil, field_id: nil)
        #   @param values [Array<Amocrm::Models::APILeadsUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        #   @param field_code [String] Field code (e.g. PHONE/EMAIL)
        #
        #   @param field_id [Integer] Use either field_id or field_code (e.g. PHONE/EMAIL)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [String, Integer, Boolean]
          required :value, union: -> { Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::APILeadsUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
            extend Amocrm::Internal::Type::Union
