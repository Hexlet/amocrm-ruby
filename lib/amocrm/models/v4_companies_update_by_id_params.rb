...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#companies_update_by_id
    class V4CompaniesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute _embedded
      #
      #   @return [Amocrm::Models::V4CompaniesUpdateByIDParams::Embedded, nil]
      optional :_embedded, -> { Amocrm::V4CompaniesUpdateByIDParams::Embedded }
      ...
      #
      #   @return [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue] }
      ...
      #   Tags to attach
      #
      #   @return [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CompaniesUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #   Tags to delete
      #
      #   @return [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CompaniesUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CompaniesUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(tags: nil)
        #   @param tags [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
