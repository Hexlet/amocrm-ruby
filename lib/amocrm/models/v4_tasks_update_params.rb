...
module Amocrm
  module Models
    ...
    class V4TasksUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4TasksUpdateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4TasksUpdateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute result
        #
        #   @return [Amocrm::Models::V4TasksUpdateParams::Body::Result, nil]
        optional :result, -> { Amocrm::V4TasksUpdateParams::Body::Result }
        ...
        #
        #   @param result [Amocrm::Models::V4TasksUpdateParams::Body::Result]
        #
        #   @param task_type_id [Integer]
        #
        #   @param text [String]

        # @see Amocrm::Models::V4TasksUpdateParams::Body#result
