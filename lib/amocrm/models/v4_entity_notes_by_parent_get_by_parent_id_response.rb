...
module Amocrm
  module Models
    ...
    module V4EntityNotesByParentGetByParentIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4EntityNotesByParentGetByParentIDResponse::Note }

      variant -> { Amocrm::Models::V4EntityNotesByParentGetByParentIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::V4EntityNotesByParentGetByParentIDResponse::Note, Amocrm::Models::V4EntityNotesByParentGetByParentIDResponse::Problem)]
    end
  end
end
