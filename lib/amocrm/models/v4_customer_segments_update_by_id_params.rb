...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#customer_segments_update_by_id
    class V4CustomerSegmentsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Amocrm::Models::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue] }
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
