...
module Amocrm
  module Models
    # @see Amocrm::Resources::Leads#get_by_id
    module LeadGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::LeadGetByIDResponse::Lead }

      variant -> { Amocrm::Models::LeadGetByIDResponse::Problem }
      ...
      class Lead < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::LeadGetByIDResponse::Lead::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::LeadGetByIDResponse::Lead::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue] },
                 nil?: true
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::LeadGetByIDResponse::Lead::Embedded]
        #   @param _links [Object]
        ...
        #   @param custom_fields_values [Array<Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue>, nil]
        ...
        # @see Amocrm::Models::LeadGetByIDResponse::Lead#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute catalog_elements
          #
          #   @return [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::CatalogElement>, nil]
          optional :catalog_elements,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::CatalogElement] }

          # @!attribute companies
          #
          #   @return [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Company>, nil]
          optional :companies,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Company] }

          # @!attribute contacts
          #
          #   @return [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Contact>, nil]
          optional :contacts,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Contact] }

          # @!attribute loss_reason
          #
          #   @return [Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::LossReason, nil]
          optional :loss_reason, -> { Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::LossReason }

          # @!attribute source
          #
          #   @return [Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Source, nil]
          optional :source, -> { Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Source }

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Tag] }

          # @!method initialize(catalog_elements: nil, companies: nil, contacts: nil, loss_reason: nil, source: nil, tags: nil)
          #   @param catalog_elements [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::CatalogElement>]
          #   @param companies [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Company>]
          #   @param contacts [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Contact>]
          #   @param loss_reason [Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::LossReason]
          #   @param source [Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Source]
          #   @param tags [Array<Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Tag>]
          ...
          # @see Amocrm::Models::LeadGetByIDResponse::Lead::Embedded#loss_reason
          ...
          # @see Amocrm::Models::LeadGetByIDResponse::Lead::Embedded#source
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            optional :external_id,
                     union: -> { Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Source::ExternalID }
            ...
            # External id in your system
            #
            # @see Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Source#external_id
            module ExternalID
              extend Amocrm::Internal::Type::Union
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::LeadGetByIDResponse::Lead::CustomFieldsValue::Value#value
            module Value
              extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::LeadGetByIDResponse::Lead, Amocrm::Models::LeadGetByIDResponse::Problem)]
    end
  end
end
