...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#account_get
    module APIAccountGetResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIAccountGetResponse::AccountInfo }

      variant -> { Amocrm::Models::APIAccountGetResponse::Problem }
      ...
      class AccountInfo < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded }
        ...
        #
        #   @return [Symbol, String, Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode, nil]
        optional :customers_mode, union: -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode }
        ...
        #
        #   @return [Amocrm::Models::APIAccountGetResponse::AccountInfo::InvoicesSettings, nil]
        optional :invoices_settings, -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::InvoicesSettings }
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded]
        #   @param _links [Object]
        ...
        #   @param customers_mode [Symbol, String, Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode]
        #   @param drive_url [String]
        #   @param invoices_settings [Amocrm::Models::APIAccountGetResponse::AccountInfo::InvoicesSettings]
        ...
        # @see Amocrm::Models::APIAccountGetResponse::AccountInfo#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute amojo_rights
          #
          #   @return [Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::AmojoRights, nil]
          optional :amojo_rights, -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::AmojoRights }

          # @!attribute datetime_settings
          #
          #   @return [Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::DatetimeSettings, nil]
          optional :datetime_settings,
                   -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::DatetimeSettings }

          # @!attribute task_types
          #
          #   @return [Array<Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::TaskType>, nil]
          optional :task_types,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::TaskType] }

          # @!attribute users_groups
          #
          #   @return [Array<Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::UsersGroup>, nil]
          optional :users_groups,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::UsersGroup] }

          # @!method initialize(amojo_rights: nil, datetime_settings: nil, task_types: nil, users_groups: nil)
          #   @param amojo_rights [Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::AmojoRights]
          #   @param datetime_settings [Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::DatetimeSettings]
          #   @param task_types [Array<Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::TaskType>]
          #   @param users_groups [Array<Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded::UsersGroup>]

          # @see Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded#amojo_rights
          ...
          # @see Amocrm::Models::APIAccountGetResponse::AccountInfo::Embedded#datetime_settings
        ...
        # @see Amocrm::Models::APIAccountGetResponse::AccountInfo#customers_mode
        module CustomersMode
          extend Amocrm::Internal::Type::Union

          variant const: -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode::PERIODICITY }

          variant const: -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode::DYNAMIC }

          variant const: -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode::SEGMENTS }

          variant const: -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode::DISABLED }

          variant const: -> { Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode::UNAVAILABLE }
          ...
          define_sorbet_constant!(:Variants) do
            T.type_alias { T.any(Amocrm::Models::APIAccountGetResponse::AccountInfo::CustomersMode::TaggedSymbol, String) }
          end
        ...
        # @see Amocrm::Models::APIAccountGetResponse::AccountInfo#invoices_settings
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::APIAccountGetResponse::AccountInfo, Amocrm::Models::APIAccountGetResponse::Problem)]
    end
  end
end
