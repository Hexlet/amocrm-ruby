...
module Amocrm
  module Models
    ...
    module CustomFieldGroupGetByIDResponse
      ...
      variant -> { Amocrm::Models::CustomFieldGroupGetByIDResponse::CustomFieldGroup }

      variant -> { Amocrm::Models::CustomFieldGroupGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::CustomFieldGroupGetByIDResponse::CustomFieldGroup, Amocrm::Models::CustomFieldGroupGetByIDResponse::Problem)]
    end
  end
end
