...
module Amocrm
  module Models
    ...
    module EventGetByIDResponse
      ...
      variant -> { Amocrm::Models::EventGetByIDResponse::Event }

      variant -> { Amocrm::Models::EventGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::EventGetByIDResponse::Event, Amocrm::Models::EventGetByIDResponse::Problem)]
    end
  end
end
