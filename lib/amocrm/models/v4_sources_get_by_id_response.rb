...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#sources_get_by_id
    module V4SourcesGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4SourcesGetByIDResponse::Source }

      variant -> { Amocrm::Models::V4SourcesGetByIDResponse::Problem }
      ...
      class Source < Amocrm::Internal::Type::BaseModel
        ...
        optional :external_id, union: -> { Amocrm::Models::V4SourcesGetByIDResponse::Source::ExternalID }
        ...
        optional :services, union: -> { Amocrm::Models::V4SourcesGetByIDResponse::Source::Services }
        ...
        # @see Amocrm::Models::V4SourcesGetByIDResponse::Source#external_id
        module ExternalID
          extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::V4SourcesGetByIDResponse::Source#services
        module Services
          extend Amocrm::Internal::Type::Union

          variant -> { Amocrm::Models::V4SourcesGetByIDResponse::Source::Services::UnionMember0Array }

          variant -> { Amocrm::Models::V4SourcesGetByIDResponse::Source::Services::StringArray }
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::V4SourcesGetByIDResponse::Source, Amocrm::Models::V4SourcesGetByIDResponse::Problem)]
    end
  end
end
