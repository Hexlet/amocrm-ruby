...
module Amocrm
  module Models
    ...
    module RoleGetByIDResponse
      ...
      variant -> { Amocrm::Models::RoleGetByIDResponse::Role }

      variant -> { Amocrm::Models::RoleGetByIDResponse::Problem }
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::RoleGetByIDResponse::Role::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::RoleGetByIDResponse::Role::Embedded }
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::RoleGetByIDResponse::Role::Rights, nil]
        optional :rights, -> { Amocrm::Models::RoleGetByIDResponse::Role::Rights }

        # @!method initialize(id: nil, _embedded: nil, _links: nil, name: nil, rights: nil)
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::RoleGetByIDResponse::Role::Embedded]
        #   @param _links [Object]
        #   @param name [String]
        #   @param rights [Amocrm::Models::RoleGetByIDResponse::Role::Rights]

        # @see Amocrm::Models::RoleGetByIDResponse::Role#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute users
          #
          #   @return [Array<Amocrm::Models::RoleGetByIDResponse::Role::Embedded::User>, nil]
          optional :users,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::RoleGetByIDResponse::Role::Embedded::User] }

          # @!method initialize(users: nil)
          #   @param users [Array<Amocrm::Models::RoleGetByIDResponse::Role::Embedded::User>]
        ...
        # @see Amocrm::Models::RoleGetByIDResponse::Role#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::RoleGetByIDResponse::Role::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::RoleGetByIDResponse::Role::Rights::StatusRight] },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::RoleGetByIDResponse::Role::Rights::StatusRight>, nil]
          #   @param tasks [Object]
      ...
      #   @return [Array(Amocrm::Models::RoleGetByIDResponse::Role, Amocrm::Models::RoleGetByIDResponse::Problem)]
    end
  end
end
