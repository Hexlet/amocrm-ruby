...
module Amocrm
  module Models
    ...
    module V4CustomFieldsGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4CustomFieldsGetByIDResponse::CustomField }

      variant -> { Amocrm::Models::V4CustomFieldsGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::V4CustomFieldsGetByIDResponse::CustomField, Amocrm::Models::V4CustomFieldsGetByIDResponse::Problem)]
    end
  end
end
