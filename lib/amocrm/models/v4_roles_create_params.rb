...
module Amocrm
  module Models
    ...
    class V4RolesCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4RolesCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4RolesCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::V4RolesCreateParams::Body::Rights, nil]
        optional :rights, -> { Amocrm::V4RolesCreateParams::Body::Rights }

        # @!method initialize(name:, request_id: nil, rights: nil)
        #   @param name [String]
        #   @param request_id [String]
        #   @param rights [Amocrm::Models::V4RolesCreateParams::Body::Rights]

        # @see Amocrm::Models::V4RolesCreateParams::Body#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4RolesCreateParams::Body::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> {
                     Amocrm::Internal::Type::ArrayOf[Amocrm::V4RolesCreateParams::Body::Rights::StatusRight]
                   },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::V4RolesCreateParams::Body::Rights::StatusRight>, nil]
          #   @param tasks [Object]
