...
module Amocrm
  module Models
    ...
    module APIEventsGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIEventsGetByIDResponse::Event }

      variant -> { Amocrm::Models::APIEventsGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIEventsGetByIDResponse::Event, Amocrm::Models::APIEventsGetByIDResponse::Problem)]
    end
  end
end
