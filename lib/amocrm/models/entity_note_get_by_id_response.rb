...
module Amocrm
  module Models
    ...
    module EntityNoteGetByIDResponse
      ...
      variant -> { Amocrm::Models::EntityNoteGetByIDResponse::Note }

      variant -> { Amocrm::Models::EntityNoteGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::EntityNoteGetByIDResponse::Note, Amocrm::Models::EntityNoteGetByIDResponse::Problem)]
    end
  end
end
