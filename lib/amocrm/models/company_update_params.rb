...
module Amocrm
  module Models
    # @see Amocrm::Resources::Companies#update
    class CompanyUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::CompanyUpdateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::CompanyUpdateParams::Body::Embedded, nil]
        optional :_embedded, -> { Amocrm::CompanyUpdateParams::Body::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::CompanyUpdateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateParams::Body::CustomFieldsValue] }
        ...
        #   Tags to attach
        #
        #   @return [Array<Amocrm::Models::CompanyUpdateParams::Body::TagsToAdd>, nil]
        optional :tags_to_add,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateParams::Body::TagsToAdd] }

        # @!attribute tags_to_delete
        #   Tags to delete
        #
        #   @return [Array<Amocrm::Models::CompanyUpdateParams::Body::TagsToDelete>, nil]
        optional :tags_to_delete,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateParams::Body::TagsToDelete] }
        ...
        #
        #   @param _embedded [Amocrm::Models::CompanyUpdateParams::Body::Embedded]
        #
        #   @param created_at [Integer]
        #
        #   @param created_by [Integer]
        #
        #   @param custom_fields_values [Array<Amocrm::Models::CompanyUpdateParams::Body::CustomFieldsValue>] Custom fields payload
        #
        #   @param name [String]
        #
        #   @param responsible_user_id [Integer]
        #
        #   @param tags_to_add [Array<Amocrm::Models::CompanyUpdateParams::Body::TagsToAdd>] Tags to attach
        #
        #   @param tags_to_delete [Array<Amocrm::Models::CompanyUpdateParams::Body::TagsToDelete>] Tags to delete
        #
        #   @param updated_at [Integer]
        #
        #   @param updated_by [Integer]

        # @see Amocrm::Models::CompanyUpdateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::CompanyUpdateParams::Body::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateParams::Body::Embedded::Tag] },
                   nil?: true

          # @!method initialize(tags: nil)
          #   @param tags [Array<Amocrm::Models::CompanyUpdateParams::Body::Embedded::Tag>, nil]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::CompanyUpdateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::CompanyUpdateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::CompanyUpdateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::CompanyUpdateParams::Body::CustomFieldsValue::Value#value
            module Value
