...
module Amocrm
  module Models
    ...
    class V4CustomerSegmentsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4CustomerSegmentsCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomerSegmentsCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue] }
        ...
        #   @param name [String]
        #   @param color [String]
        #   @param custom_fields_values [Array<Amocrm::Models::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value,
                     union: -> { Amocrm::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::V4CustomerSegmentsCreateParams::Body::CustomFieldsValue::Value#value
            module Value
