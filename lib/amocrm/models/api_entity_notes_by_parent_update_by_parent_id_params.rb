...
module Amocrm
  module Models
    ...
    class APIEntityNotesByParentUpdateByParentIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute entity_type
      #
      #   @return [Symbol, Amocrm::Models::APIEntityNotesByParentUpdateByParentIDParams::EntityType]
      required :entity_type, enum: -> { Amocrm::APIEntityNotesByParentUpdateByParentIDParams::EntityType }
      ...
      #   @param entity_type [Symbol, Amocrm::Models::APIEntityNotesByParentUpdateByParentIDParams::EntityType]
