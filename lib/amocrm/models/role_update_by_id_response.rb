...
module Amocrm
  module Models
    ...
    module RoleUpdateByIDResponse
      ...
      variant -> { Amocrm::Models::RoleUpdateByIDResponse::Role }

      variant -> { Amocrm::Models::RoleUpdateByIDResponse::Problem }
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded, nil]
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::RoleUpdateByIDResponse::Role::Rights, nil]
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded]
        #   @param _links [Object]
        #   @param name [String]
        #   @param rights [Amocrm::Models::RoleUpdateByIDResponse::Role::Rights]

        # @see Amocrm::Models::RoleUpdateByIDResponse::Role#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute users
          #
          #   @return [Array<Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded::User>, nil]
          optional :users,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded::User] }

          # @!method initialize(users: nil)
          #   @param users [Array<Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded::User>]
        ...
        # @see Amocrm::Models::RoleUpdateByIDResponse::Role#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::RoleUpdateByIDResponse::Role::Rights::StatusRight>, nil]
          ...
          #   @param status_rights [Array<Amocrm::Models::RoleUpdateByIDResponse::Role::Rights::StatusRight>, nil]
          #   @param tasks [Object]
      ...
      #   @return [Array(Amocrm::Models::RoleUpdateByIDResponse::Role, Amocrm::Models::RoleUpdateByIDResponse::Problem)]
    end
  end
end
