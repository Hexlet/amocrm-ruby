  ...
  module Models
    ...
    class PipelineStatusCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::PipelineStatusCreateParams::Body::Description>, nil]
        optional :descriptions,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::PipelineStatusCreateParams::Body::Description] }
        ...
        #   @param name [String]
        #   @param color [String]
        #   @param descriptions [Array<Amocrm::Models::PipelineStatusCreateParams::Body::Description>]
