...
module Amocrm
  module Models
    ...
    module WebsiteButtonGetBySourceIDResponse
      ...
      variant -> { Amocrm::Models::WebsiteButtonGetBySourceIDResponse::WebsiteButton }

      variant -> { Amocrm::Models::WebsiteButtonGetBySourceIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::WebsiteButtonGetBySourceIDResponse::WebsiteButton, Amocrm::Models::WebsiteButtonGetBySourceIDResponse::Problem)]
    end
  end
end
