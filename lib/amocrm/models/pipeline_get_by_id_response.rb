...
module Amocrm
  module Models
    # @see Amocrm::Resources::Pipelines#get_by_id
    module PipelineGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::PipelineGetByIDResponse::Pipeline }

      variant -> { Amocrm::Models::PipelineGetByIDResponse::Problem }
      ...
      class Pipeline < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded, nil]
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded]
        #   @param _links [Object]
        ...
        # @see Amocrm::Models::PipelineGetByIDResponse::Pipeline#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute statuses
          #
          #   @return [Array<Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded::Status>, nil]
          optional :statuses,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded::Status] }

          # @!method initialize(statuses: nil)
          #   @param statuses [Array<Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded::Status>]
          ...
          class Status < Amocrm::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded::Status::Description>, nil]
            optional :descriptions,
                     -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded::Status::Description] },
                     nil?: true
            ...
            #   @param account_id [Integer]
            #   @param color [String]
            #   @param descriptions [Array<Amocrm::Models::PipelineGetByIDResponse::Pipeline::Embedded::Status::Description>, nil]
      ...
      #   @return [Array(Amocrm::Models::PipelineGetByIDResponse::Pipeline, Amocrm::Models::PipelineGetByIDResponse::Problem)]
    end
  end
end
