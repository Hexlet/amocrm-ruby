...
module Amocrm
  module Models
    ...
    module EntityLinkUnlinkResponse
      ...
      variant -> { Amocrm::Models::EntityLinkUnlinkResponse::EmptyResponse }

      variant -> { Amocrm::Models::EntityLinkUnlinkResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::EntityLinkUnlinkResponse::EmptyResponse, Amocrm::Models::EntityLinkUnlinkResponse::Problem)]
    end
  end
end
