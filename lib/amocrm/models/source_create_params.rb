...
module Amocrm
  module Models
    ...
    class SourceCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::SourceCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::SourceCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        optional :services, union: -> { Amocrm::SourceCreateParams::Body::Services }
        ...
        # @see Amocrm::Models::SourceCreateParams::Body#services
        module Services
          extend Amocrm::Internal::Type::Union

          variant -> { Amocrm::Models::SourceCreateParams::Body::Services::UnionMember0Array }

          variant -> { Amocrm::Models::SourceCreateParams::Body::Services::StringArray }
