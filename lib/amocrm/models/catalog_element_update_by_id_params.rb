  ...
  module Models
    ...
    class CatalogElementUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CatalogElementUpdateByIDParams::CustomFieldsValue] }
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        # @!attribute values
        #
        #   @return [Array<Amocrm::Models::CatalogElementUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
        ...
        #   @param values [Array<Amocrm::Models::CatalogElementUpdateByIDParams::CustomFieldsValue::Value>]
