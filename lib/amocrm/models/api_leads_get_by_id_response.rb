...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#leads_get_by_id
    module APILeadsGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APILeadsGetByIDResponse::Lead }

      variant -> { Amocrm::Models::APILeadsGetByIDResponse::Problem }
      ...
      class Lead < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue] },
                 nil?: true
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded]
        #   @param _links [Object]
        ...
        #   @param custom_fields_values [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue>, nil]
        ...
        # @see Amocrm::Models::APILeadsGetByIDResponse::Lead#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute catalog_elements
          #
          #   @return [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::CatalogElement>, nil]
          optional :catalog_elements,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::CatalogElement] }

          # @!attribute companies
          #
          #   @return [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Company>, nil]
          optional :companies,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Company] }

          # @!attribute contacts
          #
          #   @return [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Contact>, nil]
          optional :contacts,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Contact] }

          # @!attribute loss_reason
          #
          #   @return [Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::LossReason, nil]
          optional :loss_reason, -> { Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::LossReason }

          # @!attribute source
          #
          #   @return [Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source, nil]
          optional :source, -> { Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source }

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Tag] }

          # @!method initialize(catalog_elements: nil, companies: nil, contacts: nil, loss_reason: nil, source: nil, tags: nil)
          #   @param catalog_elements [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::CatalogElement>]
          #   @param companies [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Company>]
          #   @param contacts [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Contact>]
          #   @param loss_reason [Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::LossReason]
          #   @param source [Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source]
          #   @param tags [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Tag>]
          ...
          # @see Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded#loss_reason
          ...
          # @see Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded#source
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            optional :external_id,
                     union: -> { Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source::ExternalID }
            ...
            # External id in your system
            #
            # @see Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source#external_id
            module ExternalID
              extend Amocrm::Internal::Type::Union
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value,
                     union: -> { Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value#value
            module Value
              extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::APILeadsGetByIDResponse::Lead, Amocrm::Models::APILeadsGetByIDResponse::Problem)]
    end
  end
end
