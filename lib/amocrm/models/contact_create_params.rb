...
module Amocrm
  module Models
    ...
    class ContactCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::ContactCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        #   Embedded entities
        #
        #   @return [Amocrm::Models::ContactCreateParams::Body::Embedded, nil]
        optional :_embedded, -> { Amocrm::ContactCreateParams::Body::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::ContactCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactCreateParams::Body::CustomFieldsValue] }
        ...
        #   Tags to attach
        #
        #   @return [Array<Amocrm::Models::ContactCreateParams::Body::TagsToAdd>, nil]
        optional :tags_to_add,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactCreateParams::Body::TagsToAdd] }
        ...
        #   @param _embedded [Amocrm::Models::ContactCreateParams::Body::Embedded] Embedded entities
        #
        #   @param created_at [Integer]
        #
        #   @param created_by [Integer]
        #
        #   @param custom_fields_values [Array<Amocrm::Models::ContactCreateParams::Body::CustomFieldsValue>] Custom fields payload
        #
        ...
        #
        #   @param tags_to_add [Array<Amocrm::Models::ContactCreateParams::Body::TagsToAdd>] Tags to attach
        #
        #   @param updated_at [Integer]
        #
        #   @param updated_by [Integer]

        # @see Amocrm::Models::ContactCreateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::ContactCreateParams::Body::Embedded::Tag>, nil]
          optional :tags, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactCreateParams::Body::Embedded::Tag] }

          # @!method initialize(tags: nil)
          #   Embedded entities
          #
          #   @param tags [Array<Amocrm::Models::ContactCreateParams::Body::Embedded::Tag>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::ContactCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
          ...
          #   @param values [Array<Amocrm::Models::ContactCreateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::ContactCreateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::ContactCreateParams::Body::CustomFieldsValue::Value#value
            module Value
