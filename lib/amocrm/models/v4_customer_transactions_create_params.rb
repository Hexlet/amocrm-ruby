...
module Amocrm
  module Models
    ...
    class V4CustomerTransactionsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4CustomerTransactionsCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomerTransactionsCreateParams::Body] }
      ...
      #   @param body [Array<Amocrm::Models::V4CustomerTransactionsCreateParams::Body>]
