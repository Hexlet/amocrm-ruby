...
module Amocrm
  module Models
    ...
    class V4CustomersUpdateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::V4CustomersUpdateParams::Body::Embedded, nil]
        optional :_embedded, -> { Amocrm::V4CustomersUpdateParams::Body::Embedded }

        # @!attribute custom_fields_values
        #
        #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue] }
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body::TagsToAdd>, nil]
        optional :tags_to_add,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body::TagsToAdd] }

        # @!attribute tags_to_delete
        #
        #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body::TagsToDelete>, nil]
        optional :tags_to_delete,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body::TagsToDelete] }
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::V4CustomersUpdateParams::Body::Embedded]
        #   @param custom_fields_values [Array<Amocrm::Models::V4CustomersUpdateParams::Body::CustomFieldsValue>]
        ...
        #   @param tags_to_add [Array<Amocrm::Models::V4CustomersUpdateParams::Body::TagsToAdd>]
        #   @param tags_to_delete [Array<Amocrm::Models::V4CustomersUpdateParams::Body::TagsToDelete>]
        #   @param updated_at [Integer]
        #   @param updated_by [Integer]

        # @see Amocrm::Models::V4CustomersUpdateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute segments
          #
          #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body::Embedded::Segment>, nil]
          optional :segments,
                   -> {
                     Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body::Embedded::Segment]
                   },
                   nil?: true

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body::Embedded::Tag>, nil]
          optional :tags,
                   -> {
                     Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body::Embedded::Tag]
                   },
                   nil?: true

          # @!method initialize(segments: nil, tags: nil)
          #   @param segments [Array<Amocrm::Models::V4CustomersUpdateParams::Body::Embedded::Segment>, nil]
          #   @param tags [Array<Amocrm::Models::V4CustomersUpdateParams::Body::Embedded::Tag>, nil]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4CustomersUpdateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::V4CustomersUpdateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::V4CustomersUpdateParams::Body::CustomFieldsValue::Value#value
            module Value
