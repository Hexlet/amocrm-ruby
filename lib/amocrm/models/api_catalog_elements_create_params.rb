...
module Amocrm
  module Models
    ...
    class APICatalogElementsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::APICatalogElementsCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICatalogElementsCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::APICatalogElementsCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICatalogElementsCreateParams::Body::CustomFieldsValue] }
        ...
        #   @param name [String]
        #   @param custom_fields_values [Array<Amocrm::Models::APICatalogElementsCreateParams::Body::CustomFieldsValue>]
        #   @param request_id [String]

        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          # @!attribute values
          #
          #   @return [Array<Amocrm::Models::APICatalogElementsCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICatalogElementsCreateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::APICatalogElementsCreateParams::Body::CustomFieldsValue::Value>]
