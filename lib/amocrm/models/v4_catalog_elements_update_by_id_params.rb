...
module Amocrm
  module Models
    ...
    class V4CatalogElementsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Amocrm::Models::V4CatalogElementsUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CatalogElementsUpdateByIDParams::CustomFieldsValue] }
      ...
      #   @param custom_fields_values [Array<Amocrm::Models::V4CatalogElementsUpdateByIDParams::CustomFieldsValue>]
      #   @param name [String]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        # @!attribute values
        #
        #   @return [Array<Amocrm::Models::V4CatalogElementsUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CatalogElementsUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::V4CatalogElementsUpdateByIDParams::CustomFieldsValue::Value>]
