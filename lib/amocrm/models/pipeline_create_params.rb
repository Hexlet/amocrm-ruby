...
module Amocrm
  module Models
    ...
    class PipelineCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::PipelineCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::PipelineCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::PipelineCreateParams::Body::Embedded, nil]
        ...
        #   @param name [String]
        #   @param _embedded [Amocrm::Models::PipelineCreateParams::Body::Embedded]
        #   @param is_main [Boolean]
        #   @param is_unsorted_on [Boolean]
        #   @param request_id [String]
        #   @param sort [Integer]

        # @see Amocrm::Models::PipelineCreateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute statuses
          #
          #   @return [Array<Amocrm::Models::PipelineCreateParams::Body::Embedded::Status>, nil]
          optional :statuses,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::PipelineCreateParams::Body::Embedded::Status] }

          # @!method initialize(statuses: nil)
          #   @param statuses [Array<Amocrm::Models::PipelineCreateParams::Body::Embedded::Status>]
          ...
          class Status < Amocrm::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Amocrm::Models::PipelineCreateParams::Body::Embedded::Status::Description>, nil]
            ...
            #   @param name [String]
            #   @param color [String]
            #   @param descriptions [Array<Amocrm::Models::PipelineCreateParams::Body::Embedded::Status::Description>]
            #   @param request_id [String]
            #   @param sort [Integer]
