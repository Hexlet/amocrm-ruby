...
module Amocrm
  module Models
    # @see Amocrm::Resources::CustomerSegments#get_by_id
    module CustomerSegmentGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment }

      variant -> { Amocrm::Models::CustomerSegmentGetByIDResponse::Problem }
      ...
      class CustomerSegment < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue>, nil]
        ...
        #   @param custom_fields_values [Array<Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue>, nil]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value,
                     union: -> { Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment::CustomFieldsValue::Value#value
            module Value
              extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::CustomerSegmentGetByIDResponse::CustomerSegment, Amocrm::Models::CustomerSegmentGetByIDResponse::Problem)]
    end
  end
end
