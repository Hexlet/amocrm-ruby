...
module Amocrm
  module Models
    ...
    module SourceDeleteResponse
      ...
      variant -> { Amocrm::Models::SourceDeleteResponse::EmptyResponse }

      variant -> { Amocrm::Models::SourceDeleteResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::SourceDeleteResponse::EmptyResponse, Amocrm::Models::SourceDeleteResponse::Problem)]
    end
  end
end
