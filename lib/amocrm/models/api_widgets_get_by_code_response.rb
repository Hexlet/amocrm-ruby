...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#widgets_get_by_code
    module APIWidgetsGetByCodeResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIWidgetsGetByCodeResponse::Widget }

      variant -> { Amocrm::Models::APIWidgetsGetByCodeResponse::Problem }
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        optional :rating, union: -> { Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::Rating }, nil?: true
        ...
        #
        #   @return [Array<Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::SettingsTemplate>, nil]
        optional :settings_template,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::SettingsTemplate] }

        # @!attribute version
        #
        #   @return [String, Integer, nil]
        optional :version, union: -> { Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::Version }, nil?: true
        ...
        #   @param settings_template [Array<Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::SettingsTemplate>]
        #   @param version [String, Integer, nil]

        # @see Amocrm::Models::APIWidgetsGetByCodeResponse::Widget#rating
        module Rating
          extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::APIWidgetsGetByCodeResponse::Widget#version
        module Version
          extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::APIWidgetsGetByCodeResponse::Widget, Amocrm::Models::APIWidgetsGetByCodeResponse::Problem)]
    end
  end
end
