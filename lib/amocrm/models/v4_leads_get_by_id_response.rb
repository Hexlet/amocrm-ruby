...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#leads_get_by_id
    module V4LeadsGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4LeadsGetByIDResponse::Lead }

      variant -> { Amocrm::Models::V4LeadsGetByIDResponse::Problem }
      ...
      class Lead < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue] },
                 nil?: true
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded]
        #   @param _links [Object]
        ...
        #   @param custom_fields_values [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue>, nil]
        ...
        # @see Amocrm::Models::V4LeadsGetByIDResponse::Lead#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute catalog_elements
          #
          #   @return [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::CatalogElement>, nil]
          optional :catalog_elements,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::CatalogElement] }

          # @!attribute companies
          #
          #   @return [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Company>, nil]
          optional :companies,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Company] }

          # @!attribute contacts
          #
          #   @return [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Contact>, nil]
          optional :contacts,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Contact] }

          # @!attribute loss_reason
          #
          #   @return [Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::LossReason, nil]
          optional :loss_reason, -> { Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::LossReason }

          # @!attribute source
          #
          #   @return [Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source, nil]
          optional :source, -> { Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source }

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Tag] }

          # @!method initialize(catalog_elements: nil, companies: nil, contacts: nil, loss_reason: nil, source: nil, tags: nil)
          #   @param catalog_elements [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::CatalogElement>]
          #   @param companies [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Company>]
          #   @param contacts [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Contact>]
          #   @param loss_reason [Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::LossReason]
          #   @param source [Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source]
          #   @param tags [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Tag>]
          ...
          # @see Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded#loss_reason
          ...
          # @see Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded#source
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            optional :external_id,
                     union: -> { Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source::ExternalID }
            ...
            # External id in your system
            #
            # @see Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source#external_id
            module ExternalID
              extend Amocrm::Internal::Type::Union
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value,
                     union: -> { Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value#value
            module Value
              extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::V4LeadsGetByIDResponse::Lead, Amocrm::Models::V4LeadsGetByIDResponse::Problem)]
    end
  end
end
