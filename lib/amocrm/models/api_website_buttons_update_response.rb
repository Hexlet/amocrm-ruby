...
module Amocrm
  module Models
    ...
    module APIWebsiteButtonsUpdateResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIWebsiteButtonsUpdateResponse::WebsiteButton }

      variant -> { Amocrm::Models::APIWebsiteButtonsUpdateResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIWebsiteButtonsUpdateResponse::WebsiteButton, Amocrm::Models::APIWebsiteButtonsUpdateResponse::Problem)]
    end
  end
end
