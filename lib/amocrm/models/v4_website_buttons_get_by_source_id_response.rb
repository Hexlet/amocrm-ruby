...
module Amocrm
  module Models
    ...
    module V4WebsiteButtonsGetBySourceIDResponse
      ...
      variant -> { Amocrm::Models::V4WebsiteButtonsGetBySourceIDResponse::WebsiteButton }

      variant -> { Amocrm::Models::V4WebsiteButtonsGetBySourceIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::V4WebsiteButtonsGetBySourceIDResponse::WebsiteButton, Amocrm::Models::V4WebsiteButtonsGetBySourceIDResponse::Problem)]
    end
  end
end
