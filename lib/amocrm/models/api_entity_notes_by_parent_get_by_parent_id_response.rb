...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#entity_notes_by_parent_get_by_parent_id
    module APIEntityNotesByParentGetByParentIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIEntityNotesByParentGetByParentIDResponse::Note }

      variant -> { Amocrm::Models::APIEntityNotesByParentGetByParentIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIEntityNotesByParentGetByParentIDResponse::Note, Amocrm::Models::APIEntityNotesByParentGetByParentIDResponse::Problem)]
    end
  end
end
