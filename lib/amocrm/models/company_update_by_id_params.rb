...
module Amocrm
  module Models
    ...
    class CompanyUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      optional :_embedded, -> { Amocrm::CompanyUpdateByIDParams::Embedded }
      ...
      #
      #   @return [Array<Amocrm::Models::CompanyUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateByIDParams::CustomFieldsValue] }
      ...
      #   Tags to attach
      #
      #   @return [Array<Amocrm::Models::CompanyUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #   Tags to delete
      #
      #   @return [Array<Amocrm::Models::CompanyUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::CompanyUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(tags: nil)
        #   @param tags [Array<Amocrm::Models::CompanyUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::CompanyUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CompanyUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::CompanyUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::CompanyUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::CompanyUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
