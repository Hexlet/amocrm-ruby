...
module Amocrm
  module Models
    ...
    module CatalogElementListResponse
      ...
      variant -> { Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse }

      variant -> { Amocrm::Models::CatalogElementListResponse::Problem }

      class CatalogElementListResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse::Embedded, nil]
        optional :_embedded,
        ...
        #   @param _embedded [Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse::Embedded]
        #   @param _links [Object]
        #   @param _page [Integer]

        # @see Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute elements
          #
          #   @return [Array<Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse::Embedded::Element>, nil]
          optional :elements,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse::Embedded::Element] }

          # @!method initialize(elements: nil)
          #   @param elements [Array<Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse::Embedded::Element>]
      ...
      #   @return [Array(Amocrm::Models::CatalogElementListResponse::CatalogElementListResponse, Amocrm::Models::CatalogElementListResponse::Problem)]
    end
  end
end
