...
module Amocrm
  module Models
    ...
    class V4CustomersCreateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4CustomersCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::V4CustomersCreateParams::Body::Embedded, nil]
        optional :_embedded, -> { Amocrm::V4CustomersCreateParams::Body::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomersCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue] }
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomersCreateParams::Body::TagsToAdd>, nil]
        optional :tags_to_add,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersCreateParams::Body::TagsToAdd] }
        ...
        #   @param _embedded [Amocrm::Models::V4CustomersCreateParams::Body::Embedded]
        #   @param created_at [Integer]
        #   @param created_by [Integer]
        #   @param custom_fields_values [Array<Amocrm::Models::V4CustomersCreateParams::Body::CustomFieldsValue>]
        ...
        #   @param tags_to_add [Array<Amocrm::Models::V4CustomersCreateParams::Body::TagsToAdd>]
        #   @param updated_by [Integer]

        # @see Amocrm::Models::V4CustomersCreateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute segments
          #
          #   @return [Array<Amocrm::Models::V4CustomersCreateParams::Body::Embedded::Segment>, nil]
          optional :segments,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersCreateParams::Body::Embedded::Segment] }

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::V4CustomersCreateParams::Body::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersCreateParams::Body::Embedded::Tag] }

          # @!method initialize(segments: nil, tags: nil)
          #   @param segments [Array<Amocrm::Models::V4CustomersCreateParams::Body::Embedded::Segment>]
          #   @param tags [Array<Amocrm::Models::V4CustomersCreateParams::Body::Embedded::Tag>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4CustomersCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::V4CustomersCreateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::V4CustomersCreateParams::Body::CustomFieldsValue::Value#value
            module Value
