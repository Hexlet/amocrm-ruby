...
module Amocrm
  module Models
    ...
    module WidgetUninstallResponse
      ...
      variant -> { Amocrm::Models::WidgetUninstallResponse::EmptyResponse }

      variant -> { Amocrm::Models::WidgetUninstallResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::WidgetUninstallResponse::EmptyResponse, Amocrm::Models::WidgetUninstallResponse::Problem)]
    end
  end
end
