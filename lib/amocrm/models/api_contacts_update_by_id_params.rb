...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#contacts_update_by_id
    class APIContactsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute _embedded
      #
      #   @return [Amocrm::Models::APIContactsUpdateByIDParams::Embedded, nil]
      optional :_embedded, -> { Amocrm::APIContactsUpdateByIDParams::Embedded }
      ...
      #
      #   @return [Array<Amocrm::Models::APIContactsUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue] }
      ...
      #   Tags to attach
      #
      #   @return [Array<Amocrm::Models::APIContactsUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIContactsUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #   Tags to delete
      #
      #   @return [Array<Amocrm::Models::APIContactsUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIContactsUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::APIContactsUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIContactsUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(tags: nil)
        #   @param tags [Array<Amocrm::Models::APIContactsUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::APIContactsUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::APIContactsUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::APIContactsUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
