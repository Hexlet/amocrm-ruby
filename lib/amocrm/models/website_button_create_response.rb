...
module Amocrm
  module Models
    # @see Amocrm::Resources::WebsiteButtons#create
    module WebsiteButtonCreateResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::WebsiteButtonCreateResponse::WebsiteButtonCreateResponse }

      variant -> { Amocrm::Models::WebsiteButtonCreateResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::WebsiteButtonCreateResponse::WebsiteButtonCreateResponse, Amocrm::Models::WebsiteButtonCreateResponse::Problem)]
    end
  end
end
