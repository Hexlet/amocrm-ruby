...
module Amocrm
  module Models
    # @see Amocrm::Resources::Catalogs#update_by_id
    module CatalogUpdateByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse }

      variant -> { Amocrm::Models::CatalogUpdateByIDResponse::Problem }

      class CatalogUpdateResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse::Embedded }
        ...
        #   @param _embedded [Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse::Embedded]
        #   @param _links [Object]

        # @see Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute catalogs
          #
          #   @return [Array<Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog>, nil]
          optional :catalogs,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog] }

          # @!method initialize(catalogs: nil)
          #   @param catalogs [Array<Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog>]
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::CatalogUpdateByIDResponse::CatalogUpdateResponse, Amocrm::Models::CatalogUpdateByIDResponse::Problem)]
    end
  end
end
