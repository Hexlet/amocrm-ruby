...
module Amocrm
  module Models
    # @see Amocrm::Resources::CustomerSegments#list
    module CustomerSegmentListResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse }

      variant -> { Amocrm::Models::CustomerSegmentListResponse::Problem }

      class CustomerSegmentListResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded, nil]
        optional :_embedded,
        ...
        #   @param _embedded [Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded]
        #   @param _links [Object]

        # @see Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute segments
          #
          #   @return [Array<Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment>, nil]
          optional :segments,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment] }

          # @!method initialize(segments: nil)
          #   @param segments [Array<Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment>]
          ...
          class Segment < Amocrm::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue>, nil]
            ...
            #   @param custom_fields_values [Array<Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue>, nil]
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::Value>]
              required :values,
                       -> do
                         Amocrm::Internal::Type::ArrayOf[
              ...
              #   @param values [Array<Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
              #
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                required :value,
                         union: -> { Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::Value::Value }
                ...
                # @see Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::Value#value
                module Value
                  extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::CustomerSegmentListResponse::CustomerSegmentListResponse, Amocrm::Models::CustomerSegmentListResponse::Problem)]
    end
  end
end
