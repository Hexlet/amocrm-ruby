...
module Amocrm
  module Models
    ...
    module SourceDeleteByIDResponse
      ...
      variant -> { Amocrm::Models::SourceDeleteByIDResponse::EmptyResponse }

      variant -> { Amocrm::Models::SourceDeleteByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::SourceDeleteByIDResponse::EmptyResponse, Amocrm::Models::SourceDeleteByIDResponse::Problem)]
    end
  end
end
