...
module Amocrm
  module Models
    ...
    module V4EntityNotesGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4EntityNotesGetByIDResponse::Note }

      variant -> { Amocrm::Models::V4EntityNotesGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::V4EntityNotesGetByIDResponse::Note, Amocrm::Models::V4EntityNotesGetByIDResponse::Problem)]
    end
  end
end
