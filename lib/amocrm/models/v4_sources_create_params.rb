...
module Amocrm
  module Models
    ...
    class V4SourcesCreateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4SourcesCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4SourcesCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        optional :services, union: -> { Amocrm::V4SourcesCreateParams::Body::Services }
        ...
        # @see Amocrm::Models::V4SourcesCreateParams::Body#services
        module Services
          extend Amocrm::Internal::Type::Union

          variant -> { Amocrm::Models::V4SourcesCreateParams::Body::Services::UnionMember0Array }

          variant -> { Amocrm::Models::V4SourcesCreateParams::Body::Services::StringArray }
