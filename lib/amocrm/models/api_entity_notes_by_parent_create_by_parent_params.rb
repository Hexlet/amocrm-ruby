...
module Amocrm
  module Models
    ...
    class APIEntityNotesByParentCreateByParentParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute entity_type
      #
      #   @return [Symbol, Amocrm::Models::APIEntityNotesByParentCreateByParentParams::EntityType]
      required :entity_type, enum: -> { Amocrm::APIEntityNotesByParentCreateByParentParams::EntityType }

      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::APIEntityNotesByParentCreateByParentParams::Body>]
      required :body,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIEntityNotesByParentCreateByParentParams::Body] }

      # @!method initialize(entity_type:, body:, request_options: {})
      #   @param entity_type [Symbol, Amocrm::Models::APIEntityNotesByParentCreateByParentParams::EntityType]
      #   @param body [Array<Amocrm::Models::APIEntityNotesByParentCreateByParentParams::Body>]
