...
module Amocrm
  module Models
    ...
    class APIWidgetBotContinueContinueParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute bot_type
      #
      #   @return [Symbol, Amocrm::Models::APIWidgetBotContinueContinueParams::BotType]
      required :bot_type, enum: -> { Amocrm::APIWidgetBotContinueContinueParams::BotType }
      ...
      #
      #   @return [Array<Amocrm::Models::APIWidgetBotContinueContinueParams::ExecuteHandler>, nil]
      optional :execute_handlers,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIWidgetBotContinueContinueParams::ExecuteHandler] }

      # @!method initialize(bot_type:, bot_id:, data: nil, execute_handlers: nil, request_options: {})
      #   @param bot_type [Symbol, Amocrm::Models::APIWidgetBotContinueContinueParams::BotType]
      #   @param bot_id [Integer]
      #   @param data [Object]
      #   @param execute_handlers [Array<Amocrm::Models::APIWidgetBotContinueContinueParams::ExecuteHandler>]
