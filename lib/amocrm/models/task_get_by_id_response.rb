...
module Amocrm
  module Models
    # @see Amocrm::Resources::Tasks#get_by_id
    module TaskGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::TaskGetByIDResponse::Task }

      variant -> { Amocrm::Models::TaskGetByIDResponse::Problem }
      ...
      class Task < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute result
        #
        #   @return [Amocrm::Models::TaskGetByIDResponse::Task::Result::Text, Object, nil]
        optional :result, union: -> { Amocrm::Models::TaskGetByIDResponse::Task::Result }
        ...
        #   @param result [Amocrm::Models::TaskGetByIDResponse::Task::Result::Text, Object]
        #   @param task_type_id [Integer]
        #   @param text [String]
        #   @param updated_at [Integer]
        #   @param updated_by [Integer]

        # @see Amocrm::Models::TaskGetByIDResponse::Task#result
        module Result
          extend Amocrm::Internal::Type::Union

          variant -> { Amocrm::Models::TaskGetByIDResponse::Task::Result::Text }
          ...
          #   @return [Array(Amocrm::Models::TaskGetByIDResponse::Task::Result::Text, Object)]
        end
      end
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::TaskGetByIDResponse::Task, Amocrm::Models::TaskGetByIDResponse::Problem)]
    end
  end
end
