...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#contacts_update_by_id
    class V4ContactsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute _embedded
      #
      #   @return [Amocrm::Models::V4ContactsUpdateByIDParams::Embedded, nil]
      optional :_embedded, -> { Amocrm::V4ContactsUpdateByIDParams::Embedded }
      ...
      #
      #   @return [Array<Amocrm::Models::V4ContactsUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsUpdateByIDParams::CustomFieldsValue] }
      ...
      #   Tags to attach
      #
      #   @return [Array<Amocrm::Models::V4ContactsUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #   Tags to delete
      #
      #   @return [Array<Amocrm::Models::V4ContactsUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::V4ContactsUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(tags: nil)
        #   @param tags [Array<Amocrm::Models::V4ContactsUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4ContactsUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::V4ContactsUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::V4ContactsUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::V4ContactsUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
