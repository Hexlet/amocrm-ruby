...
module Amocrm
  module Models
    # @see Amocrm::Resources::Sources#get_by_id
    module SourceGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::SourceGetByIDResponse::Source }

      variant -> { Amocrm::Models::SourceGetByIDResponse::Problem }
      ...
      class Source < Amocrm::Internal::Type::BaseModel
        ...
        optional :external_id, union: -> { Amocrm::Models::SourceGetByIDResponse::Source::ExternalID }
        ...
        optional :services, union: -> { Amocrm::Models::SourceGetByIDResponse::Source::Services }
        ...
        # @see Amocrm::Models::SourceGetByIDResponse::Source#external_id
        module ExternalID
          extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::SourceGetByIDResponse::Source#services
        module Services
          extend Amocrm::Internal::Type::Union

          variant -> { Amocrm::Models::SourceGetByIDResponse::Source::Services::UnionMember0Array }

          variant -> { Amocrm::Models::SourceGetByIDResponse::Source::Services::StringArray }
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::SourceGetByIDResponse::Source, Amocrm::Models::SourceGetByIDResponse::Problem)]
    end
  end
end
