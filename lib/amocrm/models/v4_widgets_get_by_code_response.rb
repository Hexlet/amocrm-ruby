...
module Amocrm
  module Models
    ...
    module V4WidgetsGetByCodeResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4WidgetsGetByCodeResponse::Widget }

      variant -> { Amocrm::Models::V4WidgetsGetByCodeResponse::Problem }
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        optional :rating, union: -> { Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::Rating }, nil?: true
        ...
        #
        #   @return [Array<Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::SettingsTemplate>, nil]
        optional :settings_template,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::SettingsTemplate] }

        # @!attribute version
        #
        #   @return [String, Integer, nil]
        optional :version, union: -> { Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::Version }, nil?: true
        ...
        #   @param settings_template [Array<Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::SettingsTemplate>]
        #   @param version [String, Integer, nil]

        # @see Amocrm::Models::V4WidgetsGetByCodeResponse::Widget#rating
        module Rating
          extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::V4WidgetsGetByCodeResponse::Widget#version
        module Version
          extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::V4WidgetsGetByCodeResponse::Widget, Amocrm::Models::V4WidgetsGetByCodeResponse::Problem)]
    end
  end
end
