...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#tasks_get_by_id
    module V4TasksGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4TasksGetByIDResponse::Task }

      variant -> { Amocrm::Models::V4TasksGetByIDResponse::Problem }
      ...
      class Task < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute result
        #
        #   @return [Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Text, Object, nil]
        optional :result, union: -> { Amocrm::Models::V4TasksGetByIDResponse::Task::Result }
        ...
        #   @param result [Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Text, Object]
        #   @param task_type_id [Integer]
        #   @param text [String]
        #   @param updated_at [Integer]
        #   @param updated_by [Integer]

        # @see Amocrm::Models::V4TasksGetByIDResponse::Task#result
        module Result
          extend Amocrm::Internal::Type::Union

          variant -> { Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Text }
          ...
          #   @return [Array(Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Text, Object)]
        end
      end
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::V4TasksGetByIDResponse::Task, Amocrm::Models::V4TasksGetByIDResponse::Problem)]
    end
  end
end
