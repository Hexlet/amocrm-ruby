...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#pipeline_statuses_get_by_id
    module APIPipelineStatusesGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status }

      variant -> { Amocrm::Models::APIPipelineStatusesGetByIDResponse::Problem }
      ...
      class Status < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status::Description>, nil]
        optional :descriptions,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status::Description] },
                 nil?: true
        ...
        #   @param color [String]
        #   @param descriptions [Array<Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status::Description>, nil]
      ...
      #   @return [Array(Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status, Amocrm::Models::APIPipelineStatusesGetByIDResponse::Problem)]
    end
  end
end
