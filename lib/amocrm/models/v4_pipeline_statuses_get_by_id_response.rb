...
module Amocrm
  module Models
    ...
    module V4PipelineStatusesGetByIDResponse
      ...
      variant -> { Amocrm::Models::V4PipelineStatusesGetByIDResponse::Status }

      variant -> { Amocrm::Models::V4PipelineStatusesGetByIDResponse::Problem }
      ...
      class Status < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4PipelineStatusesGetByIDResponse::Status::Description>, nil]
        optional :descriptions,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4PipelineStatusesGetByIDResponse::Status::Description] },
                 nil?: true
        ...
        #   @param color [String]
        #   @param descriptions [Array<Amocrm::Models::V4PipelineStatusesGetByIDResponse::Status::Description>, nil]
      ...
      #   @return [Array(Amocrm::Models::V4PipelineStatusesGetByIDResponse::Status, Amocrm::Models::V4PipelineStatusesGetByIDResponse::Problem)]
    end
  end
end
