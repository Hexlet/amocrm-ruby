...
module Amocrm
  module Models
    # @see Amocrm::Resources::Widgets#get_by_code
    module WidgetGetByCodeResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::WidgetGetByCodeResponse::Widget }

      variant -> { Amocrm::Models::WidgetGetByCodeResponse::Problem }
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::WidgetGetByCodeResponse::Widget::SettingsTemplate>, nil]
        ...
        #   @param settings_template [Array<Amocrm::Models::WidgetGetByCodeResponse::Widget::SettingsTemplate>]
        #   @param version [String, Integer, nil]

        # @see Amocrm::Models::WidgetGetByCodeResponse::Widget#rating
        module Rating
          extend Amocrm::Internal::Type::Union
        ...
        # @see Amocrm::Models::WidgetGetByCodeResponse::Widget#version
        module Version
          extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::WidgetGetByCodeResponse::Widget, Amocrm::Models::WidgetGetByCodeResponse::Problem)]
    end
  end
end
