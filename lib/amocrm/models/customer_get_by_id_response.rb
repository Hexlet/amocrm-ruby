...
module Amocrm
  module Models
    # @see Amocrm::Resources::Customers#get_by_id
    module CustomerGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::CustomerGetByIDResponse::Customer }

      variant -> { Amocrm::Models::CustomerGetByIDResponse::Problem }
      ...
      class Customer < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::CustomFieldsValue] },
                 nil?: true
        ...
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded]
        #   @param _links [Object]
        ...
        #   @param custom_fields_values [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::CustomFieldsValue>, nil]
        ...
        # @see Amocrm::Models::CustomerGetByIDResponse::Customer#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute catalog_elements
          #
          #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::CatalogElement>, nil]
          optional :catalog_elements,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::CatalogElement] }

          # @!attribute companies
          #
          #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Company>, nil]
          optional :companies,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Company] }

          # @!attribute contacts
          #
          #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Contact>, nil]
          optional :contacts,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Contact] }

          # @!attribute segments
          #
          #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Segment>, nil]
          optional :segments,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Segment] }

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Tag] }

          # @!method initialize(catalog_elements: nil, companies: nil, contacts: nil, segments: nil, tags: nil)
          #   @param catalog_elements [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::CatalogElement>]
          #   @param companies [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Company>]
          #   @param contacts [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Contact>]
          #   @param segments [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Segment>]
          #   @param tags [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::Embedded::Tag>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::CustomerGetByIDResponse::Customer::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::CustomerGetByIDResponse::Customer::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::CustomerGetByIDResponse::Customer, Amocrm::Models::CustomerGetByIDResponse::Problem)]
    end
  end
end
