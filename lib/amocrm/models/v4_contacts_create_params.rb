...
module Amocrm
  module Models
    ...
    class V4ContactsCreateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::V4ContactsCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        #   Embedded entities
        #
        #   @return [Amocrm::Models::V4ContactsCreateParams::Body::Embedded, nil]
        optional :_embedded, -> { Amocrm::V4ContactsCreateParams::Body::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::V4ContactsCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsCreateParams::Body::CustomFieldsValue] }
        ...
        #   Tags to attach
        #
        #   @return [Array<Amocrm::Models::V4ContactsCreateParams::Body::TagsToAdd>, nil]
        optional :tags_to_add,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsCreateParams::Body::TagsToAdd] }
        ...
        #   @param _embedded [Amocrm::Models::V4ContactsCreateParams::Body::Embedded] Embedded entities
        #
        #   @param created_at [Integer]
        #
        #   @param created_by [Integer]
        #
        #   @param custom_fields_values [Array<Amocrm::Models::V4ContactsCreateParams::Body::CustomFieldsValue>] Custom fields payload
        #
        ...
        #
        #   @param tags_to_add [Array<Amocrm::Models::V4ContactsCreateParams::Body::TagsToAdd>] Tags to attach
        #
        #   @param updated_at [Integer]
        #
        #   @param updated_by [Integer]

        # @see Amocrm::Models::V4ContactsCreateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::V4ContactsCreateParams::Body::Embedded::Tag>, nil]
          optional :tags,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsCreateParams::Body::Embedded::Tag] }

          # @!method initialize(tags: nil)
          #   Embedded entities
          #
          #   @param tags [Array<Amocrm::Models::V4ContactsCreateParams::Body::Embedded::Tag>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4ContactsCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4ContactsCreateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::V4ContactsCreateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::V4ContactsCreateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::V4ContactsCreateParams::Body::CustomFieldsValue::Value#value
            module Value
