...
module Amocrm
  module Models
    # @see Amocrm::Resources::CustomFields#get_by_id
    module CustomFieldGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::CustomFieldGetByIDResponse::CustomField }

      variant -> { Amocrm::Models::CustomFieldGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::CustomFieldGetByIDResponse::CustomField, Amocrm::Models::CustomFieldGetByIDResponse::Problem)]
    end
  end
end
