...
module Amocrm
  module Models
    ...
    class CustomerSegmentCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::CustomerSegmentCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerSegmentCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerSegmentCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerSegmentCreateParams::Body::CustomFieldsValue] }
        ...
        #   @param name [String]
        #   @param color [String]
        #   @param custom_fields_values [Array<Amocrm::Models::CustomerSegmentCreateParams::Body::CustomFieldsValue>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::CustomerSegmentCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerSegmentCreateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::CustomerSegmentCreateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::CustomerSegmentCreateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::CustomerSegmentCreateParams::Body::CustomFieldsValue::Value#value
            module Value
