...
module Amocrm
  module Models
    ...
    class APIRolesCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::APIRolesCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APIRolesCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::APIRolesCreateParams::Body::Rights, nil]
        optional :rights, -> { Amocrm::APIRolesCreateParams::Body::Rights }

        # @!method initialize(name:, request_id: nil, rights: nil)
        #   @param name [String]
        #   @param request_id [String]
        #   @param rights [Amocrm::Models::APIRolesCreateParams::Body::Rights]

        # @see Amocrm::Models::APIRolesCreateParams::Body#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::APIRolesCreateParams::Body::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> {
                     Amocrm::Internal::Type::ArrayOf[Amocrm::APIRolesCreateParams::Body::Rights::StatusRight]
                   },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::APIRolesCreateParams::Body::Rights::StatusRight>, nil]
          #   @param tasks [Object]
