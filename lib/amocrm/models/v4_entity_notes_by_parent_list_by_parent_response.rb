...
module Amocrm
  module Models
    ...
    module V4EntityNotesByParentListByParentResponse
      ...
      variant -> { Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse }

      variant -> { Amocrm::Models::V4EntityNotesByParentListByParentResponse::Problem }

      class NoteListResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse::Embedded, nil]
        optional :_embedded,
        ...
        #   @param _embedded [Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse::Embedded]
        #   @param _links [Object]
        #   @param _page [Integer]

        # @see Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute notes
          #
          #   @return [Array<Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse::Embedded::Note>, nil]
          optional :notes,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse::Embedded::Note] }

          # @!method initialize(notes: nil)
          #   @param notes [Array<Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse::Embedded::Note>]
      ...
      #   @return [Array(Amocrm::Models::V4EntityNotesByParentListByParentResponse::NoteListResponse, Amocrm::Models::V4EntityNotesByParentListByParentResponse::Problem)]
    end
  end
end
