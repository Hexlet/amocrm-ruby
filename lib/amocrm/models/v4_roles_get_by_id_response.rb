...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#roles_get_by_id
    module V4RolesGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4RolesGetByIDResponse::Role }

      variant -> { Amocrm::Models::V4RolesGetByIDResponse::Problem }
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded }
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::V4RolesGetByIDResponse::Role::Rights, nil]
        optional :rights, -> { Amocrm::Models::V4RolesGetByIDResponse::Role::Rights }

        # @!method initialize(id: nil, _embedded: nil, _links: nil, name: nil, rights: nil)
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded]
        #   @param _links [Object]
        #   @param name [String]
        #   @param rights [Amocrm::Models::V4RolesGetByIDResponse::Role::Rights]

        # @see Amocrm::Models::V4RolesGetByIDResponse::Role#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute users
          #
          #   @return [Array<Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded::User>, nil]
          optional :users,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded::User] }

          # @!method initialize(users: nil)
          #   @param users [Array<Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded::User>]
        ...
        # @see Amocrm::Models::V4RolesGetByIDResponse::Role#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4RolesGetByIDResponse::Role::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4RolesGetByIDResponse::Role::Rights::StatusRight] },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::V4RolesGetByIDResponse::Role::Rights::StatusRight>, nil]
          #   @param tasks [Object]
      ...
      #   @return [Array(Amocrm::Models::V4RolesGetByIDResponse::Role, Amocrm::Models::V4RolesGetByIDResponse::Problem)]
    end
  end
end
