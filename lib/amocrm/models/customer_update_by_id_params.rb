...
module Amocrm
  module Models
    # @see Amocrm::Resources::Customers#update_by_id
    class CustomerUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      optional :_embedded, -> { Amocrm::CustomerUpdateByIDParams::Embedded }

      # @!attribute custom_fields_values
      #
      #   @return [Array<Amocrm::Models::CustomerUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerUpdateByIDParams::CustomFieldsValue] }
      ...
      #
      #   @return [Array<Amocrm::Models::CustomerUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #
      #   @return [Array<Amocrm::Models::CustomerUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerUpdateByIDParams::TagsToDelete] }
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::CustomerUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::CustomerUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::CustomerUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
