...
module Amocrm
  module Models
    ...
    class ContactUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Amocrm::Models::ContactUpdateByIDParams::CustomFieldsValue>, nil]
      ...
      #   Tags to attach
      #
      #   @return [Array<Amocrm::Models::ContactUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #   Tags to delete
      #
      #   @return [Array<Amocrm::Models::ContactUpdateByIDParams::TagsToDelete>, nil]
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::ContactUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(tags: nil)
        #   @param tags [Array<Amocrm::Models::ContactUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::ContactUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::ContactUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::ContactUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::ContactUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::ContactUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
