...
module Amocrm
  module Models
    # @see Amocrm::Resources::Contacts#list
    module ContactListResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::ContactListResponse::ContactListResponse }

      variant -> { Amocrm::Models::ContactListResponse::Problem }

      class ContactListResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::ContactListResponse::ContactListResponse::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::ContactListResponse::ContactListResponse::Embedded }
        ...
        #   @param _embedded [Amocrm::Models::ContactListResponse::ContactListResponse::Embedded]
        #   @param _links [Object]
        #   @param _page [Integer]

        # @see Amocrm::Models::ContactListResponse::ContactListResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute contacts
          #
          #   @return [Array<Amocrm::Models::ContactListResponse::ContactListResponse::Embedded::Contact>, nil]
          optional :contacts,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::ContactListResponse::ContactListResponse::Embedded::Contact] }

          # @!method initialize(contacts: nil)
          #   @param contacts [Array<Amocrm::Models::ContactListResponse::ContactListResponse::Embedded::Contact>]
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::ContactListResponse::ContactListResponse, Amocrm::Models::ContactListResponse::Problem)]
    end
  end
end
