...
module Amocrm
  module Models
    ...
    module V4CustomerSegmentsGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment }

      variant -> { Amocrm::Models::V4CustomerSegmentsGetByIDResponse::Problem }
      ...
      class CustomerSegment < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue] },
                 nil?: true
        ...
        #   @param custom_fields_values [Array<Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue>, nil]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value,
                     union: -> { Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value#value
            module Value
              extend Amocrm::Internal::Type::Union
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment, Amocrm::Models::V4CustomerSegmentsGetByIDResponse::Problem)]
    end
  end
end
