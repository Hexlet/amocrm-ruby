...
module Amocrm
  module Models
    ...
    class APICustomersUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute _embedded
      #
      #   @return [Amocrm::Models::APICustomersUpdateByIDParams::Embedded, nil]
      optional :_embedded, -> { Amocrm::APICustomersUpdateByIDParams::Embedded }

      # @!attribute custom_fields_values
      #
      #   @return [Array<Amocrm::Models::APICustomersUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICustomersUpdateByIDParams::CustomFieldsValue] }
      ...
      #
      #   @return [Array<Amocrm::Models::APICustomersUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICustomersUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #
      #   @return [Array<Amocrm::Models::APICustomersUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICustomersUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute segments
        #
        #   @return [Array<Amocrm::Models::APICustomersUpdateByIDParams::Embedded::Segment>, nil]
        optional :segments,
                 -> {
                   Amocrm::Internal::Type::ArrayOf[Amocrm::APICustomersUpdateByIDParams::Embedded::Segment]
                 },
                 nil?: true

        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::APICustomersUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICustomersUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(segments: nil, tags: nil)
        #   @param segments [Array<Amocrm::Models::APICustomersUpdateByIDParams::Embedded::Segment>, nil]
        #   @param tags [Array<Amocrm::Models::APICustomersUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::APICustomersUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::APICustomersUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::APICustomersUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::APICustomersUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::APICustomersUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
