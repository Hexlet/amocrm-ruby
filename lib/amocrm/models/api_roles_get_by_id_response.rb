...
module Amocrm
  module Models
    # @see Amocrm::Resources::API#roles_get_by_id
    module APIRolesGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIRolesGetByIDResponse::Role }

      variant -> { Amocrm::Models::APIRolesGetByIDResponse::Problem }
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded }
        ...
        # @!attribute rights
        #
        #   @return [Amocrm::Models::APIRolesGetByIDResponse::Role::Rights, nil]
        optional :rights, -> { Amocrm::Models::APIRolesGetByIDResponse::Role::Rights }

        # @!method initialize(id: nil, _embedded: nil, _links: nil, name: nil, rights: nil)
        #   @param id [Integer]
        #   @param _embedded [Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded]
        #   @param _links [Object]
        #   @param name [String]
        #   @param rights [Amocrm::Models::APIRolesGetByIDResponse::Role::Rights]

        # @see Amocrm::Models::APIRolesGetByIDResponse::Role#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute users
          #
          #   @return [Array<Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded::User>, nil]
          optional :users,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded::User] }

          # @!method initialize(users: nil)
          #   @param users [Array<Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded::User>]
        ...
        # @see Amocrm::Models::APIRolesGetByIDResponse::Role#rights
        class Rights < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::APIRolesGetByIDResponse::Role::Rights::StatusRight>, nil]
          optional :status_rights,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::APIRolesGetByIDResponse::Role::Rights::StatusRight] },
                   nil?: true
          ...
          #   @param status_rights [Array<Amocrm::Models::APIRolesGetByIDResponse::Role::Rights::StatusRight>, nil]
          #   @param tasks [Object]
      ...
      #   @return [Array(Amocrm::Models::APIRolesGetByIDResponse::Role, Amocrm::Models::APIRolesGetByIDResponse::Problem)]
    end
  end
end
