...
module Amocrm
  module Models
    ...
    class V4EntityNotesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Amocrm::Models::V4EntityNotesUpdateByIDParams::EntityType]
      required :entity_type, enum: -> { Amocrm::V4EntityNotesUpdateByIDParams::EntityType }
      ...
      #   @param entity_type [Symbol, Amocrm::Models::V4EntityNotesUpdateByIDParams::EntityType]
