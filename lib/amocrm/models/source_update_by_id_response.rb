...
module Amocrm
  module Models
    # @see Amocrm::Resources::Sources#update_by_id
    module SourceUpdateByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse }

      variant -> { Amocrm::Models::SourceUpdateByIDResponse::Problem }

      class SourceUpdateResponse < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse::Embedded, nil]
        optional :_embedded, -> { Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse::Embedded }
        ...
        #   @param _embedded [Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse::Embedded]
        #   @param _links [Object]
        #   @param _total_items [Integer]

        # @see Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute sources
          #
          #   @return [Array<Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse::Embedded::Source>, nil]
          optional :sources,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse::Embedded::Source] }

          # @!method initialize(sources: nil)
          #   @param sources [Array<Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse::Embedded::Source>]
      ...
      # @!method self.variants
      #   @return [Array(Amocrm::Models::SourceUpdateByIDResponse::SourceUpdateResponse, Amocrm::Models::SourceUpdateByIDResponse::Problem)]
    end
  end
end
