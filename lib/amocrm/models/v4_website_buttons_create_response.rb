...
module Amocrm
  module Models
    ...
    module V4WebsiteButtonsCreateResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::V4WebsiteButtonsCreateResponse::WebsiteButtonCreateResponse }

      variant -> { Amocrm::Models::V4WebsiteButtonsCreateResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::V4WebsiteButtonsCreateResponse::WebsiteButtonCreateResponse, Amocrm::Models::V4WebsiteButtonsCreateResponse::Problem)]
    end
  end
end
