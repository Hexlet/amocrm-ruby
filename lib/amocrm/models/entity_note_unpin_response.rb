...
module Amocrm
  module Models
    ...
    module EntityNoteUnpinResponse
      ...
      variant -> { Amocrm::Models::EntityNoteUnpinResponse::EmptyResponse }

      variant -> { Amocrm::Models::EntityNoteUnpinResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::EntityNoteUnpinResponse::EmptyResponse, Amocrm::Models::EntityNoteUnpinResponse::Problem)]
    end
  end
end
