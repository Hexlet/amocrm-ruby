...
module Amocrm
  module Models
    ...
    module APIEntityNotesGetByIDResponse
      extend Amocrm::Internal::Type::Union

      variant -> { Amocrm::Models::APIEntityNotesGetByIDResponse::Note }

      variant -> { Amocrm::Models::APIEntityNotesGetByIDResponse::Problem }
      ...
      #   @return [Array(Amocrm::Models::APIEntityNotesGetByIDResponse::Note, Amocrm::Models::APIEntityNotesGetByIDResponse::Problem)]
    end
  end
end
