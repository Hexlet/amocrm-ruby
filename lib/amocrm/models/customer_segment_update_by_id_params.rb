...
module Amocrm
  module Models
    # @see Amocrm::Resources::CustomerSegments#update_by_id
    class CustomerSegmentUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Amocrm::Models::CustomerSegmentUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerSegmentUpdateByIDParams::CustomFieldsValue] }
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerSegmentUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerSegmentUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::CustomerSegmentUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::CustomerSegmentUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::CustomerSegmentUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
