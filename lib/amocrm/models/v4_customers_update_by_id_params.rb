...
module Amocrm
  module Models
    # @see Amocrm::Resources::V4#customers_update_by_id
    class V4CustomersUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      # @!attribute _embedded
      #
      #   @return [Amocrm::Models::V4CustomersUpdateByIDParams::Embedded, nil]
      optional :_embedded, -> { Amocrm::V4CustomersUpdateByIDParams::Embedded }

      # @!attribute custom_fields_values
      #
      #   @return [Array<Amocrm::Models::V4CustomersUpdateByIDParams::CustomFieldsValue>, nil]
      optional :custom_fields_values,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue] }
      ...
      #
      #   @return [Array<Amocrm::Models::V4CustomersUpdateByIDParams::TagsToAdd>, nil]
      optional :tags_to_add,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateByIDParams::TagsToAdd] }

      # @!attribute tags_to_delete
      #
      #   @return [Array<Amocrm::Models::V4CustomersUpdateByIDParams::TagsToDelete>, nil]
      optional :tags_to_delete,
               -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateByIDParams::TagsToDelete] }
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        # @!attribute segments
        #
        #   @return [Array<Amocrm::Models::V4CustomersUpdateByIDParams::Embedded::Segment>, nil]
        optional :segments,
                 -> {
                   Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateByIDParams::Embedded::Segment]
                 },
                 nil?: true

        # @!attribute tags
        #
        #   @return [Array<Amocrm::Models::V4CustomersUpdateByIDParams::Embedded::Tag>, nil]
        optional :tags,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateByIDParams::Embedded::Tag] },
                 nil?: true

        # @!method initialize(segments: nil, tags: nil)
        #   @param segments [Array<Amocrm::Models::V4CustomersUpdateByIDParams::Embedded::Segment>, nil]
        #   @param tags [Array<Amocrm::Models::V4CustomersUpdateByIDParams::Embedded::Tag>, nil]
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Amocrm::Models::V4CustomersUpdateByIDParams::CustomFieldsValue::Value>]
        required :values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue::Value] }
        ...
        #   @param values [Array<Amocrm::Models::V4CustomersUpdateByIDParams::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
        #
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          required :value, union: -> { Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue::Value::Value }
          ...
          # @see Amocrm::Models::V4CustomersUpdateByIDParams::CustomFieldsValue::Value#value
          module Value
