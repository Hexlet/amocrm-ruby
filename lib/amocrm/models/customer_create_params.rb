...
module Amocrm
  module Models
    ...
    class CustomerCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Amocrm::Models::CustomerCreateParams::Body>]
      required :body, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerCreateParams::Body] }
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        # @!attribute _embedded
        #
        #   @return [Amocrm::Models::CustomerCreateParams::Body::Embedded, nil]
        optional :_embedded, -> { Amocrm::CustomerCreateParams::Body::Embedded }
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerCreateParams::Body::CustomFieldsValue>, nil]
        optional :custom_fields_values,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerCreateParams::Body::CustomFieldsValue] }
        ...
        #
        #   @return [Array<Amocrm::Models::CustomerCreateParams::Body::TagsToAdd>, nil]
        optional :tags_to_add,
                 -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerCreateParams::Body::TagsToAdd] }
        ...
        #   @param _embedded [Amocrm::Models::CustomerCreateParams::Body::Embedded]
        #   @param created_at [Integer]
        #   @param created_by [Integer]
        #   @param custom_fields_values [Array<Amocrm::Models::CustomerCreateParams::Body::CustomFieldsValue>]
        ...
        #   @param tags_to_add [Array<Amocrm::Models::CustomerCreateParams::Body::TagsToAdd>]
        #   @param updated_by [Integer]

        # @see Amocrm::Models::CustomerCreateParams::Body#_embedded
        class Embedded < Amocrm::Internal::Type::BaseModel
          # @!attribute segments
          #
          #   @return [Array<Amocrm::Models::CustomerCreateParams::Body::Embedded::Segment>, nil]
          optional :segments,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerCreateParams::Body::Embedded::Segment] }

          # @!attribute tags
          #
          #   @return [Array<Amocrm::Models::CustomerCreateParams::Body::Embedded::Tag>, nil]
          optional :tags, -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerCreateParams::Body::Embedded::Tag] }

          # @!method initialize(segments: nil, tags: nil)
          #   @param segments [Array<Amocrm::Models::CustomerCreateParams::Body::Embedded::Segment>]
          #   @param tags [Array<Amocrm::Models::CustomerCreateParams::Body::Embedded::Tag>]
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Amocrm::Models::CustomerCreateParams::Body::CustomFieldsValue::Value>]
          required :values,
                   -> { Amocrm::Internal::Type::ArrayOf[Amocrm::CustomerCreateParams::Body::CustomFieldsValue::Value] }
          ...
          #   @param values [Array<Amocrm::Models::CustomerCreateParams::Body::CustomFieldsValue::Value>] Values for the field (multiple values allowed)
          #
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            required :value, union: -> { Amocrm::CustomerCreateParams::Body::CustomFieldsValue::Value::Value }
            ...
            # @see Amocrm::Models::CustomerCreateParams::Body::CustomFieldsValue::Value#value
            module Value
