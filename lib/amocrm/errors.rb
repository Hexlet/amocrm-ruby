  ...
  module Errors
    ...
    class APIStatusError < Amocrm::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Amocrm::Errors::BadRequestError.new(**kwargs)
        in 401
          Amocrm::Errors::AuthenticationError.new(**kwargs)
        in 403
          Amocrm::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Amocrm::Errors::NotFoundError.new(**kwargs)
        in 409
          Amocrm::Errors::ConflictError.new(**kwargs)
        in 422
          Amocrm::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Amocrm::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Amocrm::Errors::InternalServerError.new(**kwargs)
        else
          Amocrm::Errors::APIStatusError.new(**kwargs)
        end
      end
