  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Amocrm::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Amocrm::Internal::Util.os,
            "x-stainless-package-version" => Amocrm::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Amocrm::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Amocrm::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Amocrm::Internal::Util.uri_origin(url) != Amocrm::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Amocrm::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Amocrm::Errors::APIConnectionError | (500..)
              Amocrm::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Amocrm::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Amocrm::Internal::Transport::PooledNetRequester.new
          ...
          @base_url_components = Amocrm::Internal::Util.parse_uri(base_url)
          @base_url = Amocrm::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<Amocrm::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Amocrm::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Amocrm::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Amocrm::Internal::Util.interpolate_path(uninterpolated_path)

          query = Amocrm::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = Amocrm::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [Amocrm::Errors::APIError]
        # @return [Array(Integer, Net::HTTPResponse, Enumerable<String>)]
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          url, headers, max_retries, timeout = request.fetch_values(:url, :headers, :max_retries, :timeout)
          input = {**request.except(:timeout), deadline: Amocrm::Internal::Util.monotonic_secs + timeout}
          ...
          headers = Amocrm::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Amocrm::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in Amocrm::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              Amocrm::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end

            raise Amocrm::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | Amocrm::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param page [Class<Amocrm::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Amocrm::Internal::Type::BaseStream>, nil]
        #
        # @param model [Amocrm::Internal::Type::Converter, Class, nil]
        #
        # @param options [Amocrm::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Amocrm::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Amocrm::RequestOptions.validate!(opts)
          ...
          headers = Amocrm::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = Amocrm::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            unwrapped = Amocrm::Internal::Util.dig(decoded, unwrap)
            Amocrm::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[Amocrm::Internal::Type::BasePage[Amocrm::Internal::Type::BaseModel]]),
