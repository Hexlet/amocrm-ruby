  ...
  module Internal
    module Type
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Amocrm::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Amocrm::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Amocrm::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Amocrm::FilePart.new(value, filename: "upload") : value
            in Amocrm::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, Amocrm::FilePart)
          end
        end
      end
    end
