    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<Amocrm::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, Amocrm::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = Amocrm::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | Amocrm::Internal::Type::Converter | Class
                [Amocrm::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Amocrm::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Amocrm::Internal::OMIT) : Amocrm::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Amocrm::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [Amocrm::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Amocrm::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Amocrm::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Amocrm::Internal::OMIT ? nil : const }
                  state = Amocrm::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    Amocrm::Internal::Type::Converter.coerce(
        ...
        class << self
          # @api private
          #
          # @param value [Amocrm::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
        ...
        class << self
          # @api private
          #
          # @param model [Amocrm::Internal::Type::BaseModel]
