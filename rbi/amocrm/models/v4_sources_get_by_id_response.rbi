  ...
  module Models
    module V4SourcesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4SourcesGetByIDResponse::Source,
            Amocrm::Models::V4SourcesGetByIDResponse::Problem
          )
        end
      ...
      class Source < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4SourcesGetByIDResponse::Source::ExternalID::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4SourcesGetByIDResponse::Source::Services::Variants
            )
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4SourcesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
