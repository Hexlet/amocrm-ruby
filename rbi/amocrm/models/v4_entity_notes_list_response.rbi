  ...
  module Models
    module V4EntityNotesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityNotesListResponse::NoteListResponse,
            Amocrm::Models::V4EntityNotesListResponse::Problem
          )
        end
      ...
      class NoteListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4EntityNotesListResponse::NoteListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4EntityNotesListResponse::NoteListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4EntityNotesListResponse::NoteListResponse::Embedded::Note
                ]
              )
            )
          end
          ...
          sig do
            params(
              notes:
                T::Array[
                  Amocrm::Models::V4EntityNotesListResponse::NoteListResponse::Embedded::Note::OrHash
                ]
            ).void
          end
          attr_writer :notes
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityNotesListResponse::Variants]
        )
      end
      def self.variants
      end
