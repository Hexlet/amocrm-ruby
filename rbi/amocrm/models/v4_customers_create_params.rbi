...
module Amocrm
  module Models
    class V4CustomersCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4CustomersCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4CustomersCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4CustomersCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CustomersCreateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Amocrm::V4CustomersCreateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::V4CustomersCreateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersCreateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::V4CustomersCreateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          params(
            ...
            tags_to_add:
              T::Array[
                Amocrm::V4CustomersCreateParams::Body::TagsToAdd::OrHash
              ],
            updated_by: Integer
          ).returns(T.attached_class)
        end
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::V4CustomersCreateParams::Body::Embedded,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
                T::Array[
                  Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue
                ],
              main_user_id: Integer,
              name: String,
              next_date: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CustomersCreateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::V4CustomersCreateParams::Body::Embedded::Segment
                ]
              )
            )
          end
          ...
          sig do
            params(
              segments:
                T::Array[
                  Amocrm::V4CustomersCreateParams::Body::Embedded::Segment::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4CustomersCreateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::V4CustomersCreateParams::Body::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
          ...
          class Tag < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::V4CustomersCreateParams::Body::Embedded::Tag,
                  Amocrm::Internal::AnyHash
                )
              end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::V4CustomersCreateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CustomersCreateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
