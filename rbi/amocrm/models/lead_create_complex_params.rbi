  ...
  module Models
    class LeadCreateComplexParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Amocrm::LeadCreateComplexParams::Body::Embedded))
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::LeadCreateComplexParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              metadata:
                Amocrm::LeadCreateComplexParams::Body::Embedded::Metadata::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(Amocrm::LeadCreateComplexParams::Body::Embedded::Source)
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                Amocrm::LeadCreateComplexParams::Body::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
