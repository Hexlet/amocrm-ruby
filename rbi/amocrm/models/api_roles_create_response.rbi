  ...
  module Models
    module APIRolesCreateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse,
            Amocrm::Models::APIRolesCreateResponse::Problem
          )
        end
      ...
      class RoleCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role
                ]
              )
            )
          end
          ...
          sig do
            params(
              roles:
                T::Array[
                  Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::OrHash
                ]
            ).void
          end
          attr_writer :roles
          ...
          class Role < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              params(
                rights:
                  Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::Rights::OrHash
              ).void
            end
            attr_writer :rights
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::Embedded::User
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  users:
                    T::Array[
                      Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::Embedded::User::OrHash
                    ]
                ).void
              end
              attr_writer :users
            ...
            class Rights < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::Rights::StatusRight
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  ...
                  status_rights:
                    T.nilable(
                      T::Array[
                        Amocrm::Models::APIRolesCreateResponse::RoleCreateResponse::Embedded::Role::Rights::StatusRight::OrHash
                      ]
                    ),
                  tasks: T.anything
                ).returns(T.attached_class)
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIRolesCreateResponse::Variants]
        )
      end
      def self.variants
      end
