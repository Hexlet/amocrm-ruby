  ...
  module Models
    module V4EntityNotesPinResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityNotesPinResponse::EmptyResponse,
            Amocrm::Models::V4EntityNotesPinResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityNotesPinResponse::Variants]
        )
      end
      def self.variants
      end
