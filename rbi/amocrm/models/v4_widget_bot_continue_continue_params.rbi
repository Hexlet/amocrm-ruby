  ...
  module Models
    class V4WidgetBotContinueContinueParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4WidgetBotContinueContinueParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig do
        returns(Amocrm::V4WidgetBotContinueContinueParams::BotType::OrSymbol)
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::V4WidgetBotContinueContinueParams::ExecuteHandler]
          )
        )
      end
        ...
        override.returns(
          {
            ...
            execute_handlers:
              T::Array[
                Amocrm::V4WidgetBotContinueContinueParams::ExecuteHandler
              ],
      ...
      module BotType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Amocrm::V4WidgetBotContinueContinueParams::BotType)
          end
        ...
        SALESBOT =
          T.let(
            :salesbot,
            Amocrm::V4WidgetBotContinueContinueParams::BotType::TaggedSymbol
          )
        MARKETINGBOT =
          T.let(
            :marketingbot,
