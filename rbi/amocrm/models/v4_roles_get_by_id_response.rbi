  ...
  module Models
    module V4RolesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4RolesGetByIDResponse::Role,
            Amocrm::Models::V4RolesGetByIDResponse::Problem
          )
        end
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::V4RolesGetByIDResponse::Role::Rights)
          )
        end
        attr_reader :rights
        ...
        sig do
          params(
            rights: Amocrm::Models::V4RolesGetByIDResponse::Role::Rights::OrHash
          ).void
        end
        attr_writer :rights
        ...
        sig do
          override.returns(
            {
              id: Integer,
              _embedded: Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded,
              _links: T.anything,
              name: String,
              rights: Amocrm::Models::V4RolesGetByIDResponse::Role::Rights
            }
          )
        end
        def to_hash
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded::User
                ]
              )
            )
          end
          ...
          sig do
            params(
              users:
                T::Array[
                  Amocrm::Models::V4RolesGetByIDResponse::Role::Embedded::User::OrHash
                ]
            ).void
          end
          attr_writer :users
        ...
        class Rights < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::V4RolesGetByIDResponse::Role::Rights,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4RolesGetByIDResponse::Role::Rights::StatusRight
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::Models::V4RolesGetByIDResponse::Role::Rights::StatusRight::OrHash
                  ]
                ),
              tasks: T.anything
            ).returns(T.attached_class)
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4RolesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
