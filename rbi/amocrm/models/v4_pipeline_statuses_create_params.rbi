  ...
  module Models
    class V4PipelineStatusesCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4PipelineStatusesCreateParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig { returns(T::Array[Amocrm::V4PipelineStatusesCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4PipelineStatusesCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4PipelineStatusesCreateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::V4PipelineStatusesCreateParams::Body::Description
              ]
            )
          )
        end
        ...
        sig do
          params(
            descriptions:
              T::Array[
                Amocrm::V4PipelineStatusesCreateParams::Body::Description::OrHash
              ]
          ).void
        end
