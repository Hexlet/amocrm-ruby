  ...
  module Models
    class APICatalogElementsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APICatalogElementsUpdateByIDParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Amocrm::APICatalogElementsUpdateByIDParams::CustomFieldsValue
            ]
          )
        )
      end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Amocrm::APICatalogElementsUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::APICatalogElementsUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer,
            field_name: String,
