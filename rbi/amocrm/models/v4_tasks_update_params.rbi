...
module Amocrm
  module Models
    class V4TasksUpdateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Amocrm::V4TasksUpdateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4TasksUpdateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4TasksUpdateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::V4TasksUpdateParams::Body, Amocrm::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Amocrm::V4TasksUpdateParams::Body::Result)) }
        attr_reader :result

        sig do
          params(result: Amocrm::V4TasksUpdateParams::Body::Result::OrHash).void
        end
        attr_writer :result
        ...
        sig do
          params(
            ...
            result: Amocrm::V4TasksUpdateParams::Body::Result::OrHash,
          ...
          override.returns(
            {
              ...
              is_completed: T::Boolean,
              responsible_user_id: Integer,
              result: Amocrm::V4TasksUpdateParams::Body::Result,
              task_type_id: Integer,
              text: String
            }
          )
        ...
        class Result < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4TasksUpdateParams::Body::Result,
