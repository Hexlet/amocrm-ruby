  ...
  module Models
    module V4CatalogsCreateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse,
            Amocrm::Models::V4CatalogsCreateResponse::Problem
          )
        end
      ...
      class CatalogCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::Catalog
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalogs:
                T::Array[
                  Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::Catalog::OrHash
                ]
            ).void
          end
          ...
          class Catalog < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::Catalog::SDKWidgetCode::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::Catalog::Type::Variants
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  T.any(
                    Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::Catalog::Type::OrSymbol,
                    String
                  )
              ).void
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::Models::V4CatalogsCreateResponse::CatalogCreateResponse::Embedded::Catalog::Type
                  )
                end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CatalogsCreateResponse::Variants]
        )
      end
      def self.variants
      end
