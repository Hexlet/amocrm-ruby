  ...
  module Models
    module V4ContactsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4ContactsListResponse::ContactListResponse,
            Amocrm::Models::V4ContactsListResponse::Problem
          )
        end
      ...
      class ContactListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          class Contact < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::CustomFieldsValue
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                custom_fields_values:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::CustomFieldsValue::OrHash
                    ]
                  ),
                first_name: String,
                group_id: Integer,
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::CatalogElement
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  catalog_elements:
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::CatalogElement::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Company
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  companies:
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Company::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Customer
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  customers:
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Customer::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Lead
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  leads:
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Lead::OrHash
                    ]
                ).void
              end
              attr_writer :leads
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Tag
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  tags:
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::Embedded::Tag::OrHash
                    ]
                ).void
              end
              attr_writer :tags
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::CustomFieldsValue::Value
                  ]
                )
              end
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer
                ).returns(T.attached_class)
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Amocrm::Models::V4ContactsListResponse::ContactListResponse::Embedded::Contact::CustomFieldsValue::Value::Value::Variants
                  )
                end
                attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4ContactsListResponse::Variants]
        )
      end
      def self.variants
      end
