...
module Amocrm
  module Models
    class APIEntityNotesCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APIEntityNotesCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APIEntityNotesCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APIEntityNotesCreateParams::Body],
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Amocrm::APIEntityNotesCreateParams::EntityType)
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::APIEntityNotesCreateParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIEntityNotesCreateParams::Body,
