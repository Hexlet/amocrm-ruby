  ...
  module Models
    module V4CatalogsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CatalogsGetByIDResponse::Catalog,
            Amocrm::Models::V4CatalogsGetByIDResponse::Problem
          )
        end
      ...
      class Catalog < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CatalogsGetByIDResponse::Catalog::SDKWidgetCode::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CatalogsGetByIDResponse::Catalog::Type::Variants
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              T.any(
                Amocrm::Models::V4CatalogsGetByIDResponse::Catalog::Type::OrSymbol,
                String
              )
          ).void
        end
        ...
        module Type
          ...
          Variants =
            T.type_alias do
              T.any(
                Amocrm::Models::V4CatalogsGetByIDResponse::Catalog::Type::TaggedSymbol,
                String
              )
            end
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Amocrm::Models::V4CatalogsGetByIDResponse::Catalog::Type
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CatalogsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
