  ...
  module Models
    module V4PipelinesDeleteByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4PipelinesDeleteByIDResponse::EmptyResponse,
            Amocrm::Models::V4PipelinesDeleteByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4PipelinesDeleteByIDResponse::Variants]
        )
      end
      def self.variants
      end
