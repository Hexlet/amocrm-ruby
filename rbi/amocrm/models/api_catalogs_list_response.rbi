  ...
  module Models
    module APICatalogsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICatalogsListResponse::CatalogListResponse,
            Amocrm::Models::APICatalogsListResponse::Problem
          )
        end
      ...
      class CatalogListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::Catalog
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalogs:
                T::Array[
                  Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::Catalog::OrHash
                ]
            ).void
          end
          ...
          class Catalog < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::Catalog::SDKWidgetCode::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::Catalog::Type::Variants
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  T.any(
                    Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::Catalog::Type::OrSymbol,
                    String
                  )
              ).void
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::Models::APICatalogsListResponse::CatalogListResponse::Embedded::Catalog::Type
                  )
                end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICatalogsListResponse::Variants]
        )
      end
      def self.variants
      end
