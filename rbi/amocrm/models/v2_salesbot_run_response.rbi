    ...
    module V2SalesbotRunResponse
      ...
      class SalesbotRunResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _links:
              Amocrm::Models::V2SalesbotRunResponse::SalesbotRunResponse::Links::OrHash
          ).void
        end
        attr_writer :_links
        ...
        class Links < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              self_:
                Amocrm::Models::V2SalesbotRunResponse::SalesbotRunResponse::Links::Self::OrHash
            ).void
          end
          attr_writer :self_
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V2SalesbotRunResponse::Variants]
        )
      end
      def self.variants
      end
