...
module Amocrm
  module Models
    class V4UsersCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4UsersCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4UsersCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4UsersCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::V4UsersCreateParams::Body, Amocrm::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Amocrm::V4UsersCreateParams::Body::Rights)) }
        attr_reader :rights

        sig do
          params(rights: Amocrm::V4UsersCreateParams::Body::Rights::OrHash).void
        end
        attr_writer :rights
        ...
        sig do
          params(
            ...
            lang: String,
            request_id: String,
            rights: Amocrm::V4UsersCreateParams::Body::Rights::OrHash
          ).returns(T.attached_class)
        end
        def self.new(
          email:,
          ...
          override.returns(
            {
              ...
              lang: String,
              request_id: String,
              rights: Amocrm::V4UsersCreateParams::Body::Rights
            }
          )
        end
        def to_hash
        ...
        class Rights < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4UsersCreateParams::Body::Rights,
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4UsersCreateParams::Body::Rights::StatusRight]
              )
            )
          end
          ...
          sig do
            params(
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::V4UsersCreateParams::Body::Rights::StatusRight::OrHash
                  ]
                ),
              tasks: T.anything
            ).returns(T.attached_class)
            ...
            override.returns(
              {
                ...
                status_rights:
                  T.nilable(
                    T::Array[
                      Amocrm::V4UsersCreateParams::Body::Rights::StatusRight
                    ]
                  ),
                tasks: T.anything
              }
