  ...
  module Models
    module APIEntityFollowersRemoveResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityFollowersRemoveResponse::EmptyResponse,
            Amocrm::Models::APIEntityFollowersRemoveResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityFollowersRemoveResponse::Variants]
        )
      end
      def self.variants
      end
