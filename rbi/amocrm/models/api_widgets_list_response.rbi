  ...
  module Models
    module APIWidgetsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWidgetsListResponse::WidgetListResponse,
            Amocrm::Models::APIWidgetsListResponse::Problem
          )
        end
      ...
      class WidgetListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::Widget
                ]
              )
            )
          end
          ...
          sig do
            params(
              widgets:
                T::Array[
                  Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::Widget::OrHash
                ]
            ).void
          end
          attr_writer :widgets
          ...
          class Widget < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::Widget::Rating::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::Widget::SettingsTemplate
                  ]
                )
              )
            end
            ...
            sig do
              params(
                settings_template:
                  T::Array[
                    Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::Widget::SettingsTemplate::OrHash
                  ]
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APIWidgetsListResponse::WidgetListResponse::Embedded::Widget::Version::Variants
                )
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWidgetsListResponse::Variants]
        )
      end
      def self.variants
      end
