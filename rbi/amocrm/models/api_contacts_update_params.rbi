...
module Amocrm
  module Models
    class APIContactsUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APIContactsUpdateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APIContactsUpdateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APIContactsUpdateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIContactsUpdateParams::Body,
        ...
        sig do
          returns(T.nilable(Amocrm::APIContactsUpdateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::APIContactsUpdateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIContactsUpdateParams::Body::CustomFieldsValue]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APIContactsUpdateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIContactsUpdateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::APIContactsUpdateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIContactsUpdateParams::Body::TagsToDelete]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[
                Amocrm::APIContactsUpdateParams::Body::TagsToDelete::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            ...
            tags_to_add:
              T::Array[
                Amocrm::APIContactsUpdateParams::Body::TagsToAdd::OrHash
              ],
            tags_to_delete:
              T::Array[
                Amocrm::APIContactsUpdateParams::Body::TagsToDelete::OrHash
        ...
        sig do
          override.returns(
            {
              id: Integer,
              _embedded: Amocrm::APIContactsUpdateParams::Body::Embedded,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
                T::Array[
                  Amocrm::APIContactsUpdateParams::Body::CustomFieldsValue
                ],
              first_name: String,
              last_name: String,
              name: String,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APIContactsUpdateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APIContactsUpdateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_accessor :tags
          ...
          sig do
            params(
              tags:
                T.nilable(
                  T::Array[
                    Amocrm::APIContactsUpdateParams::Body::Embedded::Tag::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
            ...
            override.returns(
              {
                tags:
                  T.nilable(
                    T::Array[
                      Amocrm::APIContactsUpdateParams::Body::Embedded::Tag
                    ]
                  )
              }
            )
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APIContactsUpdateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APIContactsUpdateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APIContactsUpdateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APIContactsUpdateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
        ...
        class TagsToDelete < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APIContactsUpdateParams::Body::TagsToDelete,
                Amocrm::Internal::AnyHash
              )
            end
