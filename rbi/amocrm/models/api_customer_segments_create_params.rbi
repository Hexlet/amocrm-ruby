  ...
  module Models
    class APICustomerSegmentsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APICustomerSegmentsCreateParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig { returns(T::Array[Amocrm::APICustomerSegmentsCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APICustomerSegmentsCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICustomerSegmentsCreateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::APICustomerSegmentsCreateParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APICustomerSegmentsCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APICustomerSegmentsCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APICustomerSegmentsCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APICustomerSegmentsCreateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
