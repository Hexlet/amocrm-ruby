    ...
    module CustomerTransactionListResponse
      ...
      class CustomerTransactionListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::CustomerTransactionListResponse::CustomerTransactionListResponse::Embedded::OrHash
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::CustomerTransactionListResponse::Variants]
        )
      end
      def self.variants
      end
