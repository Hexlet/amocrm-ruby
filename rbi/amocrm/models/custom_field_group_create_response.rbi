    ...
    module CustomFieldGroupCreateResponse
      ...
      class CustomFieldGroupCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::CustomFieldGroupCreateResponse::CustomFieldGroupCreateResponse::Embedded::OrHash
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::CustomFieldGroupCreateResponse::Variants]
        )
      end
      def self.variants
      end
