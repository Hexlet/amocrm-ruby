  ...
  module Models
    module V4TasksListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4TasksListResponse::TaskListResponse,
            Amocrm::Models::V4TasksListResponse::Problem
          )
        end
      ...
      class TaskListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded::Task
                ]
              )
            )
          end
          ...
          sig do
            params(
              tasks:
                T::Array[
                  Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded::Task::OrHash
                ]
            ).void
          end
          attr_writer :tasks
          ...
          class Task < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded::Task::Result::Variants
                )
              )
            end
            attr_reader :result
            ...
            sig do
              params(
                result:
                  T.any(
                    Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded::Task::Result::Text::OrHash,
                    T.anything
                  )
              ).void
            end
            ...
            module Result
              ...
              Variants =
                T.type_alias do
                  T.any(
                    Amocrm::Models::V4TasksListResponse::TaskListResponse::Embedded::Task::Result::Text,
                    T.anything
                  )
                end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4TasksListResponse::Variants]
        )
      end
      def self.variants
      end
