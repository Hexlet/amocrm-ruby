  ...
  module Models
    module V4CustomerSegmentsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment,
            Amocrm::Models::V4CustomerSegmentsGetByIDResponse::Problem
          )
        end
      ...
      class CustomerSegment < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::OrHash
                ]
              ),
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::Models::V4CustomerSegmentsGetByIDResponse::CustomerSegment::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomerSegmentsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
