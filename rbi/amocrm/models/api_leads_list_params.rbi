...
module Amocrm
  module Models
    class APILeadsListParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Amocrm::APILeadsListParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Amocrm::APILeadsListParams::Query::Variants)) }
      attr_reader :query

      sig { params(query: Amocrm::APILeadsListParams::Query::Variants).void }
      attr_writer :query
      ...
      module Query
        ...
        sig do
          override.returns(
            T::Array[Amocrm::APILeadsListParams::Query::Variants]
          )
        end
        def self.variants
        end
