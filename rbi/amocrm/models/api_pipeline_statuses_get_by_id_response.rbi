  ...
  module Models
    module APIPipelineStatusesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status,
            Amocrm::Models::APIPipelineStatusesGetByIDResponse::Problem
          )
        end
      ...
      class Status < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status::Description
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            descriptions:
              T.nilable(
                T::Array[
                  Amocrm::Models::APIPipelineStatusesGetByIDResponse::Status::Description::OrHash
                ]
              ),
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIPipelineStatusesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
