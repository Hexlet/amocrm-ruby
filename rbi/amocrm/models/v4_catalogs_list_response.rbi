  ...
  module Models
    module V4CatalogsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CatalogsListResponse::CatalogListResponse,
            Amocrm::Models::V4CatalogsListResponse::Problem
          )
        end
      ...
      class CatalogListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::Catalog
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalogs:
                T::Array[
                  Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::Catalog::OrHash
                ]
            ).void
          end
          ...
          class Catalog < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::Catalog::SDKWidgetCode::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::Catalog::Type::Variants
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  T.any(
                    Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::Catalog::Type::OrSymbol,
                    String
                  )
              ).void
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::Models::V4CatalogsListResponse::CatalogListResponse::Embedded::Catalog::Type
                  )
                end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CatalogsListResponse::Variants]
        )
      end
      def self.variants
      end
