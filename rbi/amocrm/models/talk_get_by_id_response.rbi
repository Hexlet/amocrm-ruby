  ...
  module Models
    module TalkGetByIDResponse
      ...
      class Talk < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::TalkGetByIDResponse::Talk::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::TalkGetByIDResponse::Talk::Embedded::OrHash
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::TalkGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
