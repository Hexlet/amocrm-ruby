  ...
  module Models
    module V4WebhooksListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WebhooksListResponse::WebhookListResponse,
            Amocrm::Models::V4WebhooksListResponse::Problem
          )
        end
      ...
      class WebhookListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4WebhooksListResponse::WebhookListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4WebhooksListResponse::WebhookListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4WebhooksListResponse::WebhookListResponse::Embedded::Webhook
                ]
              )
            )
          end
          ...
          sig do
            params(
              webhooks:
                T::Array[
                  Amocrm::Models::V4WebhooksListResponse::WebhookListResponse::Embedded::Webhook::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WebhooksListResponse::Variants]
        )
      end
      def self.variants
      end
