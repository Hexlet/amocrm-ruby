...
module Amocrm
  module Models
    class V4CompaniesListParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4CompaniesListParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Amocrm::V4CompaniesListParams::Query::Variants)) }
      attr_reader :query

      sig { params(query: Amocrm::V4CompaniesListParams::Query::Variants).void }
      attr_writer :query
      ...
      module Query
        ...
        sig do
          override.returns(
            T::Array[Amocrm::V4CompaniesListParams::Query::Variants]
          )
        end
        def self.variants
        end
