  ...
  module Models
    module APIPipelinesDeleteByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIPipelinesDeleteByIDResponse::EmptyResponse,
            Amocrm::Models::APIPipelinesDeleteByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIPipelinesDeleteByIDResponse::Variants]
        )
      end
      def self.variants
      end
