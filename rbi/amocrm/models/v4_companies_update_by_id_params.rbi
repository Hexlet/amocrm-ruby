...
module Amocrm
  module Models
    class V4CompaniesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4CompaniesUpdateByIDParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T.nilable(Amocrm::V4CompaniesUpdateByIDParams::Embedded)) }
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::V4CompaniesUpdateByIDParams::TagsToAdd])
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::V4CompaniesUpdateByIDParams::TagsToDelete])
        )
      end
      ...
      sig do
        override.returns(
          {
            _embedded: Amocrm::V4CompaniesUpdateByIDParams::Embedded,
            created_at: Integer,
            created_by: Integer,
            custom_fields_values:
              T::Array[Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue],
            ...
            responsible_user_id: Integer,
            tags_to_add:
              T::Array[Amocrm::V4CompaniesUpdateByIDParams::TagsToAdd],
            tags_to_delete:
              T::Array[Amocrm::V4CompaniesUpdateByIDParams::TagsToDelete],
            updated_at: Integer,
            updated_by: Integer,
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CompaniesUpdateByIDParams::Embedded,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CompaniesUpdateByIDParams::Embedded::Tag]
            )
          )
        end
        attr_accessor :tags
        ...
        sig do
          params(
            tags:
              T.nilable(
                T::Array[
                  Amocrm::V4CompaniesUpdateByIDParams::Embedded::Tag::OrHash
                ]
              )
          ).returns(T.attached_class)
        end
        ...
        class Tag < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CompaniesUpdateByIDParams::Embedded::Tag,
                Amocrm::Internal::AnyHash
              )
            end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::V4CompaniesUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
      ...
      class TagsToAdd < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CompaniesUpdateByIDParams::TagsToAdd,
              Amocrm::Internal::AnyHash
            )
          end
      ...
      class TagsToDelete < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CompaniesUpdateByIDParams::TagsToDelete,
              Amocrm::Internal::AnyHash
            )
          end
