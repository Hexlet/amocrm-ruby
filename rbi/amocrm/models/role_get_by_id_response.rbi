  ...
  module Models
    module RoleGetByIDResponse
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::RoleGetByIDResponse::Role::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::RoleGetByIDResponse::Role::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(T.nilable(Amocrm::Models::RoleGetByIDResponse::Role::Rights))
        end
        attr_reader :rights
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::RoleGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
