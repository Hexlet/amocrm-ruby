  ...
  module Models
    module APIUsersGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIUsersGetByIDResponse::User,
            Amocrm::Models::APIUsersGetByIDResponse::Problem
          )
        end
      ...
      class User < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::APIUsersGetByIDResponse::User::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::APIUsersGetByIDResponse::User::Rights)
          )
        end
        attr_reader :rights
        ...
        sig do
          params(
            rights:
              Amocrm::Models::APIUsersGetByIDResponse::User::Rights::OrHash
          ).void
        end
        attr_writer :rights
          ...
          override.returns(
            {
              id: Integer,
              _embedded:
                Amocrm::Models::APIUsersGetByIDResponse::User::Embedded,
              _links: T.anything,
              amojo_id: T.nilable(String),
              email: String,
              lang: String,
              name: String,
              phone_number: T.nilable(String),
              rights: Amocrm::Models::APIUsersGetByIDResponse::User::Rights,
              user_rank: T.nilable(String),
              uuid: T.nilable(String)
            }
          )
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Group
                ]
              )
            )
          end
          ...
          sig do
            params(
              groups:
                T::Array[
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Group::OrHash
                ]
            ).void
          end
          attr_writer :groups
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role
                ]
              )
            )
          end
          ...
          sig do
            params(
              roles:
                T::Array[
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::OrHash
                ]
            ).void
          end
          attr_writer :roles
          ...
          class Role < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Embedded
                )
              )
            end
            attr_reader :_embedded
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Rights
                )
              )
            end
            attr_reader :rights
            ...
            sig do
              params(
                rights:
                  Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Rights::OrHash
              ).void
            end
            attr_writer :rights
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Embedded::User
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  users:
                    T::Array[
                      Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Embedded::User::OrHash
                    ]
                ).void
              end
              attr_writer :users
            ...
            class Rights < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Rights::StatusRight
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  ...
                  status_rights:
                    T.nilable(
                      T::Array[
                        Amocrm::Models::APIUsersGetByIDResponse::User::Embedded::Role::Rights::StatusRight::OrHash
                      ]
                    ),
                  tasks: T.anything
                ).returns(T.attached_class)
        ...
        class Rights < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::APIUsersGetByIDResponse::User::Rights,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIUsersGetByIDResponse::User::Rights::StatusRight
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::Models::APIUsersGetByIDResponse::User::Rights::StatusRight::OrHash
                  ]
                ),
              tasks: T.anything
            ).returns(T.attached_class)
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIUsersGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
