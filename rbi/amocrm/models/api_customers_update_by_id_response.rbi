  ...
  module Models
    module APICustomersUpdateByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICustomersUpdateByIDResponse::CustomerUpdateResponse,
            Amocrm::Models::APICustomersUpdateByIDResponse::Problem
          )
        end
      ...
      class CustomerUpdateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICustomersUpdateByIDResponse::CustomerUpdateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICustomersUpdateByIDResponse::CustomerUpdateResponse::Embedded::Customer
                ]
              )
            )
          end
          ...
          sig do
            params(
              customers:
                T::Array[
                  Amocrm::Models::APICustomersUpdateByIDResponse::CustomerUpdateResponse::Embedded::Customer::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICustomersUpdateByIDResponse::Variants]
        )
      end
      def self.variants
      end
