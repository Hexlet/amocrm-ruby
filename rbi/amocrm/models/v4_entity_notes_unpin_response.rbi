  ...
  module Models
    module V4EntityNotesUnpinResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityNotesUnpinResponse::EmptyResponse,
            Amocrm::Models::V4EntityNotesUnpinResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityNotesUnpinResponse::Variants]
        )
      end
      def self.variants
      end
