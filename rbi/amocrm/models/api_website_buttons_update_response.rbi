  ...
  module Models
    module APIWebsiteButtonsUpdateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWebsiteButtonsUpdateResponse::WebsiteButton,
            Amocrm::Models::APIWebsiteButtonsUpdateResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWebsiteButtonsUpdateResponse::Variants]
        )
      end
      def self.variants
      end
