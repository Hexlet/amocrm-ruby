  ...
  module Models
    module V4EntityLinksLinkByEntityResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityLinksLinkByEntityResponse::EmptyResponse,
            Amocrm::Models::V4EntityLinksLinkByEntityResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityLinksLinkByEntityResponse::Variants]
        )
      end
      def self.variants
      end
