  ...
  module Models
    module AccountGetResponse
      ...
      class AccountInfo < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::AccountGetResponse::AccountInfo::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::AccountGetResponse::AccountInfo::Embedded::OrHash
          ).void
        end
        ...
        sig do
          params(
            invoices_settings:
              Amocrm::Models::AccountGetResponse::AccountInfo::InvoicesSettings::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              amojo_rights:
                Amocrm::Models::AccountGetResponse::AccountInfo::Embedded::AmojoRights::OrHash
            ).void
          end
          ...
          sig do
            params(
              datetime_settings:
                Amocrm::Models::AccountGetResponse::AccountInfo::Embedded::DatetimeSettings::OrHash
            ).void
          end
      ...
      sig do
        override.returns(T::Array[Amocrm::Models::AccountGetResponse::Variants])
      end
      def self.variants
      end
    end
