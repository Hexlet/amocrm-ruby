...
module Amocrm
  module Models
    class APITasksUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APITasksUpdateByIDParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Amocrm::APITasksUpdateByIDParams::Result)) }
      attr_reader :result

      sig do
        params(result: Amocrm::APITasksUpdateByIDParams::Result::OrHash).void
      end
      attr_writer :result
        ...
        override.returns(
          {
            ...
            is_completed: T::Boolean,
            responsible_user_id: Integer,
            result: Amocrm::APITasksUpdateByIDParams::Result,
            task_type_id: Integer,
            text: String,
      ...
      class Result < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APITasksUpdateByIDParams::Result,
