  ...
  module Models
    module APIWebhooksUnsubscribeResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWebhooksUnsubscribeResponse::EmptyResponse,
            Amocrm::Models::APIWebhooksUnsubscribeResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWebhooksUnsubscribeResponse::Variants]
        )
      end
      def self.variants
      end
