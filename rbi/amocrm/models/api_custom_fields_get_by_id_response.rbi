  ...
  module Models
    module APICustomFieldsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICustomFieldsGetByIDResponse::CustomField,
            Amocrm::Models::APICustomFieldsGetByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICustomFieldsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
