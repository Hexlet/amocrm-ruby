...
module Amocrm
  module Models
    class V4RolesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Amocrm::V4RolesUpdateByIDParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Amocrm::V4RolesUpdateByIDParams::Rights)) }
      attr_reader :rights
        ...
        override.returns(
          {
            name: String,
            request_id: String,
            rights: T.nilable(Amocrm::V4RolesUpdateByIDParams::Rights),
      ...
      class Rights < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4RolesUpdateByIDParams::Rights,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4RolesUpdateByIDParams::Rights::StatusRight]
            )
          )
        end
        ...
        sig do
          params(
            ...
            status_rights:
              T.nilable(
                T::Array[
                  Amocrm::V4RolesUpdateByIDParams::Rights::StatusRight::OrHash
                ]
              ),
            tasks: T.anything
          ).returns(T.attached_class)
        ...
        class StatusRight < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4RolesUpdateByIDParams::Rights::StatusRight,
                Amocrm::Internal::AnyHash
              )
            end
