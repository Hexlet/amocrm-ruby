  ...
  module Models
    module APISourcesDeleteByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APISourcesDeleteByIDResponse::EmptyResponse,
            Amocrm::Models::APISourcesDeleteByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APISourcesDeleteByIDResponse::Variants]
        )
      end
      def self.variants
      end
