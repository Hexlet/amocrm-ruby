  ...
  module Models
    module APICatalogsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICatalogsGetByIDResponse::Catalog,
            Amocrm::Models::APICatalogsGetByIDResponse::Problem
          )
        end
      ...
      class Catalog < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APICatalogsGetByIDResponse::Catalog::SDKWidgetCode::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APICatalogsGetByIDResponse::Catalog::Type::Variants
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              T.any(
                Amocrm::Models::APICatalogsGetByIDResponse::Catalog::Type::OrSymbol,
                String
              )
          ).void
        end
        ...
        module Type
          ...
          Variants =
            T.type_alias do
              T.any(
                Amocrm::Models::APICatalogsGetByIDResponse::Catalog::Type::TaggedSymbol,
                String
              )
            end
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Amocrm::Models::APICatalogsGetByIDResponse::Catalog::Type
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICatalogsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
