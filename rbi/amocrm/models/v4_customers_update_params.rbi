...
module Amocrm
  module Models
    class V4CustomersUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4CustomersUpdateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4CustomersUpdateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4CustomersUpdateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CustomersUpdateParams::Body,
        ...
        sig do
          returns(T.nilable(Amocrm::V4CustomersUpdateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::V4CustomersUpdateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersUpdateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::V4CustomersUpdateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersUpdateParams::Body::TagsToDelete]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[
                Amocrm::V4CustomersUpdateParams::Body::TagsToDelete::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            ...
            tags_to_add:
              T::Array[
                Amocrm::V4CustomersUpdateParams::Body::TagsToAdd::OrHash
              ],
            tags_to_delete:
              T::Array[
                Amocrm::V4CustomersUpdateParams::Body::TagsToDelete::OrHash
        ...
        sig do
          override.returns(
            {
              id: Integer,
              _embedded: Amocrm::V4CustomersUpdateParams::Body::Embedded,
              custom_fields_values:
                T::Array[
                  Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue
                ],
              main_user_id: Integer,
              name: String,
              next_date: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CustomersUpdateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::V4CustomersUpdateParams::Body::Embedded::Segment
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4CustomersUpdateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_accessor :tags
          ...
          sig do
            params(
              segments:
                T.nilable(
                  T::Array[
                    Amocrm::V4CustomersUpdateParams::Body::Embedded::Segment::OrHash
                  ]
                ),
              tags:
                T.nilable(
                  T::Array[
                    Amocrm::V4CustomersUpdateParams::Body::Embedded::Tag::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
            ...
            override.returns(
              {
                ...
                tags:
                  T.nilable(
                    T::Array[
                      Amocrm::V4CustomersUpdateParams::Body::Embedded::Tag
                    ]
                  )
              }
            )
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::V4CustomersUpdateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CustomersUpdateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
        ...
        class TagsToDelete < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CustomersUpdateParams::Body::TagsToDelete,
                Amocrm::Internal::AnyHash
              )
            end
