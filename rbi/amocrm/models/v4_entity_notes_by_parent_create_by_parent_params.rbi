  ...
  module Models
    class V4EntityNotesByParentCreateByParentParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4EntityNotesByParentCreateByParentParams,
      ...
      sig do
        returns(
          T::Array[Amocrm::V4EntityNotesByParentCreateByParentParams::Body]
        )
      end
      attr_accessor :body
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Amocrm::V4EntityNotesByParentCreateByParentParams::EntityType
            )
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::V4EntityNotesByParentCreateByParentParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4EntityNotesByParentCreateByParentParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
