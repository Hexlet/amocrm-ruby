    ...
    module V4AccountGetResponse
      ...
      class AccountInfo < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4AccountGetResponse::AccountInfo::CustomersMode::Variants
            )
          )
        end
        ...
        sig do
          params(
            customers_mode:
              T.any(
                Amocrm::Models::V4AccountGetResponse::AccountInfo::CustomersMode::OrSymbol,
                String
              )
          ).void
        end
        ...
        sig do
          params(
            invoices_settings:
              Amocrm::Models::V4AccountGetResponse::AccountInfo::InvoicesSettings::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              amojo_rights:
                Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::AmojoRights::OrHash
            ).void
          end
          ...
          sig do
            params(
              datetime_settings:
                Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::DatetimeSettings::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::TaskType
                ]
              )
            )
          end
          ...
          sig do
            params(
              task_types:
                T::Array[
                  Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::TaskType::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::UsersGroup
                ]
              )
            )
          end
          ...
          sig do
            params(
              users_groups:
                T::Array[
                  Amocrm::Models::V4AccountGetResponse::AccountInfo::Embedded::UsersGroup::OrHash
                ]
            ).void
          end
        ...
        module CustomersMode
          ...
          Variants =
            T.type_alias do
              T.any(
                Amocrm::Models::V4AccountGetResponse::AccountInfo::CustomersMode::TaggedSymbol,
                String
              )
            end
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Amocrm::Models::V4AccountGetResponse::AccountInfo::CustomersMode
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4AccountGetResponse::Variants]
        )
      end
      def self.variants
      end
