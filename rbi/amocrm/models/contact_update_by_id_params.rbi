...
module Amocrm
  module Models
    class ContactUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      sig do
        params(
          custom_fields_values:
            T::Array[Amocrm::ContactUpdateByIDParams::CustomFieldsValue::OrHash]
        ).void
      end
      ...
      # Tags to attach
      sig do
        returns(T.nilable(T::Array[Amocrm::ContactUpdateByIDParams::TagsToAdd]))
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::ContactUpdateByIDParams::TagsToDelete])
        )
      end
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::ContactUpdateByIDParams::Embedded::Tag])
          )
        end
        attr_accessor :tags
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[Amocrm::ContactUpdateByIDParams::CustomFieldsValue::Value]
          )
        end
