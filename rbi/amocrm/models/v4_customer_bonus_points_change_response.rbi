  ...
  module Models
    module V4CustomerBonusPointsChangeResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomerBonusPointsChangeResponse::CustomerBonusPointsResponse,
            Amocrm::Models::V4CustomerBonusPointsChangeResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[
            Amocrm::Models::V4CustomerBonusPointsChangeResponse::Variants
          ]
        )
      end
      def self.variants
