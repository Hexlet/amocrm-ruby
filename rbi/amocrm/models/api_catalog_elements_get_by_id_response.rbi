  ...
  module Models
    module APICatalogElementsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement,
            Amocrm::Models::APICatalogElementsGetByIDResponse::Problem
          )
        end
      ...
      class CatalogElement < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::CustomFieldsValue::OrHash
                ]
              ),
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              warning:
                T.nilable(
                  Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::Embedded::Warning::OrHash
                )
            ).void
          end
          attr_writer :warning
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::APICatalogElementsGetByIDResponse::CatalogElement::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer,
              field_name: String,
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICatalogElementsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
