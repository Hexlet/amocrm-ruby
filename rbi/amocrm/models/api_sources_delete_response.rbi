  ...
  module Models
    module APISourcesDeleteResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APISourcesDeleteResponse::EmptyResponse,
            Amocrm::Models::APISourcesDeleteResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APISourcesDeleteResponse::Variants]
        )
      end
      def self.variants
      end
