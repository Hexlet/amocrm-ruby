  ...
  module Models
    module V4RolesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4RolesListResponse::RoleListResponse,
            Amocrm::Models::V4RolesListResponse::Problem
          )
        end
      ...
      class RoleListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role
                ]
              )
            )
          end
          ...
          sig do
            params(
              roles:
                T::Array[
                  Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::OrHash
                ]
            ).void
          end
          attr_writer :roles
          ...
          class Role < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Rights
                )
              )
            end
            attr_reader :rights
            ...
            sig do
              params(
                rights:
                  Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Rights::OrHash
              ).void
            end
            attr_writer :rights
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Embedded::User
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  users:
                    T::Array[
                      Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Embedded::User::OrHash
                    ]
                ).void
              end
              attr_writer :users
            ...
            class Rights < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Rights::StatusRight
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  ...
                  status_rights:
                    T.nilable(
                      T::Array[
                        Amocrm::Models::V4RolesListResponse::RoleListResponse::Embedded::Role::Rights::StatusRight::OrHash
                      ]
                    ),
                  tasks: T.anything
                ).returns(T.attached_class)
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4RolesListResponse::Variants]
        )
      end
      def self.variants
      end
