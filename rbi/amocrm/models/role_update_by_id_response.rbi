  ...
  module Models
    module RoleUpdateByIDResponse
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::RoleUpdateByIDResponse::Role::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::RoleUpdateByIDResponse::Role::Rights)
          )
        end
        attr_reader :rights
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::RoleUpdateByIDResponse::Variants]
        )
      end
      def self.variants
      end
