...
module Amocrm
  module Models
    class APILeadsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APILeadsUpdateByIDParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T.nilable(Amocrm::APILeadsUpdateByIDParams::Embedded)) }
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::APILeadsUpdateByIDParams::TagsToAdd])
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::APILeadsUpdateByIDParams::TagsToDelete])
        )
      end
      ...
      sig do
        override.returns(
          {
            _embedded: Amocrm::APILeadsUpdateByIDParams::Embedded,
            closed_at: Integer,
            custom_fields_values:
              T::Array[Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue],
            group_id: Integer,
            ...
            responsible_user_id: Integer,
            status_id: Integer,
            tags_to_add: T::Array[Amocrm::APILeadsUpdateByIDParams::TagsToAdd],
            tags_to_delete:
              T::Array[Amocrm::APILeadsUpdateByIDParams::TagsToDelete],
            updated_at: Integer,
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APILeadsUpdateByIDParams::Embedded,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APILeadsUpdateByIDParams::Embedded::Company]
            )
          )
        end
        ...
        sig do
          params(
            companies:
              T::Array[
                Amocrm::APILeadsUpdateByIDParams::Embedded::Company::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APILeadsUpdateByIDParams::Embedded::Contact]
            )
          )
        end
        ...
        sig do
          params(
            contacts:
              T::Array[
                Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata)
          )
        end
        ...
        sig do
          params(
            metadata:
              Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::OrHash
          ).void
        end
        attr_writer :metadata

        sig do
          returns(T.nilable(Amocrm::APILeadsUpdateByIDParams::Embedded::Source))
        end
        attr_reader :source

        sig do
          params(
            source: Amocrm::APILeadsUpdateByIDParams::Embedded::Source::OrHash
          ).void
        end
        attr_writer :source
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::APILeadsUpdateByIDParams::Embedded::Tag])
          )
        end
        attr_reader :tags
        ...
        sig do
          params(
            tags:
              T::Array[Amocrm::APILeadsUpdateByIDParams::Embedded::Tag::OrHash]
          ).void
        end
        attr_writer :tags
          ...
          override.returns(
            {
              ...
              contacts:
                T::Array[Amocrm::APILeadsUpdateByIDParams::Embedded::Contact],
              metadata: Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata,
              source: Amocrm::APILeadsUpdateByIDParams::Embedded::Source,
              tags: T::Array[Amocrm::APILeadsUpdateByIDParams::Embedded::Tag]
            }
          )
        end
        def to_hash
        ...
        class Company < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Company,
                Amocrm::Internal::AnyHash
              )
            end
        ...
        class Contact < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Contact,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue
                ]
              )
            )
          end
          ...
          sig do
            params(
              custom_fields_values:
                T::Array[
                  Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::OrHash
                ]
            ).void
          end
          attr_writer :custom_fields_values
          ...
          class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value
                ]
              )
            end
            ...
            sig do
              params(
                values:
                  T::Array[
                    Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value::OrHash
                  ],
                field_code: String,
                field_id: Integer
              ).returns(T.attached_class)
            ...
            class Value < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Amocrm::APILeadsUpdateByIDParams::Embedded::Contact::CustomFieldsValue::Value::Value::Variants
                )
              end
              attr_accessor :value
        ...
        class Metadata < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::Category::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::FormID::Variants
              )
            )
          end
          attr_reader :form_id
          ...
          module Category
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::Category
                )
              end
            ...
            SIP =
              T.let(
                :sip,
                Amocrm::APILeadsUpdateByIDParams::Embedded::Metadata::Category::TaggedSymbol
              )
            FORMS =
              T.let(
                :forms,
        ...
        class Source < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Source,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Source::ExternalID::Variants
              )
            )
          end
        ...
        class Tag < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsUpdateByIDParams::Embedded::Tag,
                Amocrm::Internal::AnyHash
              )
            end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue::Value]
          )
        end
        attr_accessor :values
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
          ...
          override.returns(
            {
              values:
                T::Array[
                  Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue::Value
                ],
              field_code: String,
              field_id: Integer
            }
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::APILeadsUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
      ...
      class TagsToAdd < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APILeadsUpdateByIDParams::TagsToAdd,
              Amocrm::Internal::AnyHash
            )
          end
      ...
      class TagsToDelete < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APILeadsUpdateByIDParams::TagsToDelete,
              Amocrm::Internal::AnyHash
            )
          end
