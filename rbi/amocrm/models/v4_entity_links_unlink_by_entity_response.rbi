  ...
  module Models
    module V4EntityLinksUnlinkByEntityResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityLinksUnlinkByEntityResponse::EmptyResponse,
            Amocrm::Models::V4EntityLinksUnlinkByEntityResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[
            Amocrm::Models::V4EntityLinksUnlinkByEntityResponse::Variants
          ]
        )
      end
      def self.variants
