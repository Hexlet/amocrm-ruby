  ...
  module Models
    module V4TasksGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4TasksGetByIDResponse::Task,
            Amocrm::Models::V4TasksGetByIDResponse::Problem
          )
        end
      ...
      class Task < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Variants
            )
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.any(
                Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Text::OrHash,
                T.anything
              )
          ).void
        end
        ...
        module Result
          ...
          Variants =
            T.type_alias do
              T.any(
                Amocrm::Models::V4TasksGetByIDResponse::Task::Result::Text,
                T.anything
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4TasksGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
