  ...
  module Models
    module APICatalogElementsUpdateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse,
            Amocrm::Models::APICatalogElementsUpdateResponse::Problem
          )
        end
      ...
      class CatalogElementUpdateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::Element
                ]
              )
            )
          end
          ...
          sig do
            params(
              elements:
                T::Array[
                  Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::Element::OrHash
                ]
            ).void
          end
          ...
          class Element < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::Element::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              params(
                ...
                custom_fields_values:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::Element::CustomFieldsValue::OrHash
                    ]
                  ),
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  warning:
                    T.nilable(
                      Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::Element::Embedded::Warning::OrHash
                    )
                ).void
              end
              attr_writer :warning
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::Models::APICatalogElementsUpdateResponse::CatalogElementUpdateResponse::Embedded::Element::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer,
                  field_name: String,
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICatalogElementsUpdateResponse::Variants]
        )
      end
      def self.variants
      end
