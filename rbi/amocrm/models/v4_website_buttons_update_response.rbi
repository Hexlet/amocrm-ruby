  ...
  module Models
    module V4WebsiteButtonsUpdateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WebsiteButtonsUpdateResponse::WebsiteButton,
            Amocrm::Models::V4WebsiteButtonsUpdateResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WebsiteButtonsUpdateResponse::Variants]
        )
      end
      def self.variants
      end
