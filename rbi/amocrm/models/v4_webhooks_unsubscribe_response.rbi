  ...
  module Models
    module V4WebhooksUnsubscribeResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WebhooksUnsubscribeResponse::EmptyResponse,
            Amocrm::Models::V4WebhooksUnsubscribeResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WebhooksUnsubscribeResponse::Variants]
        )
      end
      def self.variants
      end
