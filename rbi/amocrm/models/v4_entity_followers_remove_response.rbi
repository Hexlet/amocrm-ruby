  ...
  module Models
    module V4EntityFollowersRemoveResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityFollowersRemoveResponse::EmptyResponse,
            Amocrm::Models::V4EntityFollowersRemoveResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityFollowersRemoveResponse::Variants]
        )
      end
      def self.variants
      end
