...
module Amocrm
  module Models
    class APIContactsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APIContactsCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APIContactsCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APIContactsCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIContactsCreateParams::Body,
        ...
        # Embedded entities
        sig do
          returns(T.nilable(Amocrm::APIContactsCreateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::APIContactsCreateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIContactsCreateParams::Body::CustomFieldsValue]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APIContactsCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIContactsCreateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::APIContactsCreateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          params(
            ...
            tags_to_add:
              T::Array[
                Amocrm::APIContactsCreateParams::Body::TagsToAdd::OrHash
              ],
            updated_at: Integer,
            updated_by: Integer
          ).returns(T.attached_class)
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::APIContactsCreateParams::Body::Embedded,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
                T::Array[
                  Amocrm::APIContactsCreateParams::Body::CustomFieldsValue
                ],
              first_name: String,
              last_name: String,
              name: String,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APIContactsCreateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APIContactsCreateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::APIContactsCreateParams::Body::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
          ...
          class Tag < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::APIContactsCreateParams::Body::Embedded::Tag,
                  Amocrm::Internal::AnyHash
                )
              end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APIContactsCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APIContactsCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APIContactsCreateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APIContactsCreateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
