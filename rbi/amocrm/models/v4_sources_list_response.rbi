  ...
  module Models
    module V4SourcesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4SourcesListResponse::SourceListResponse,
            Amocrm::Models::V4SourcesListResponse::Problem
          )
        end
      ...
      class SourceListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4SourcesListResponse::SourceListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4SourcesListResponse::SourceListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4SourcesListResponse::SourceListResponse::Embedded::Source
                ]
              )
            )
          end
          ...
          sig do
            params(
              sources:
                T::Array[
                  Amocrm::Models::V4SourcesListResponse::SourceListResponse::Embedded::Source::OrHash
                ]
            ).void
          end
          attr_writer :sources
          ...
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4SourcesListResponse::SourceListResponse::Embedded::Source::ExternalID::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4SourcesListResponse::SourceListResponse::Embedded::Source::Services::Variants
                )
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4SourcesListResponse::Variants]
        )
      end
      def self.variants
      end
