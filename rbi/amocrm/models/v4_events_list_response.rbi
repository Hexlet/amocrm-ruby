  ...
  module Models
    module V4EventsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EventsListResponse::EventListResponse,
            Amocrm::Models::V4EventsListResponse::Problem
          )
        end
      ...
      class EventListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4EventsListResponse::EventListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4EventsListResponse::EventListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4EventsListResponse::EventListResponse::Embedded::Event
                ]
              )
            )
          end
          ...
          sig do
            params(
              events:
                T::Array[
                  Amocrm::Models::V4EventsListResponse::EventListResponse::Embedded::Event::OrHash
                ]
            ).void
          end
          attr_writer :events
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EventsListResponse::Variants]
        )
      end
      def self.variants
      end
