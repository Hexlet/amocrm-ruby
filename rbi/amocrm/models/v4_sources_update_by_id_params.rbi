...
module Amocrm
  module Models
    class V4SourcesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4SourcesUpdateByIDParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(Amocrm::V4SourcesUpdateByIDParams::Services::Variants)
        )
      end
      ...
      module Services
        ...
        sig do
          override.returns(
            T::Array[Amocrm::V4SourcesUpdateByIDParams::Services::Variants]
          )
        end
        def self.variants
        end
