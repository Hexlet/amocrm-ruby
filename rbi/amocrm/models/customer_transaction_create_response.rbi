    ...
    module CustomerTransactionCreateResponse
      ...
      class CustomerTransactionCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::CustomerTransactionCreateResponse::CustomerTransactionCreateResponse::Embedded::OrHash
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::CustomerTransactionCreateResponse::Variants]
        )
      end
      def self.variants
      end
