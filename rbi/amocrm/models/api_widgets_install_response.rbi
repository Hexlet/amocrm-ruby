  ...
  module Models
    module APIWidgetsInstallResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWidgetsInstallResponse::Widget,
            Amocrm::Models::APIWidgetsInstallResponse::Problem
          )
        end
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIWidgetsInstallResponse::Widget::Rating::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::APIWidgetsInstallResponse::Widget::SettingsTemplate
              ]
            )
          )
        end
        ...
        sig do
          params(
            settings_template:
              T::Array[
                Amocrm::Models::APIWidgetsInstallResponse::Widget::SettingsTemplate::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIWidgetsInstallResponse::Widget::Version::Variants
            )
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWidgetsInstallResponse::Variants]
        )
      end
      def self.variants
      end
