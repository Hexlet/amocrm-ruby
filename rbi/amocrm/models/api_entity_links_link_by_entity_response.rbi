  ...
  module Models
    module APIEntityLinksLinkByEntityResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityLinksLinkByEntityResponse::EmptyResponse,
            Amocrm::Models::APIEntityLinksLinkByEntityResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityLinksLinkByEntityResponse::Variants]
        )
      end
      def self.variants
      end
