...
module Amocrm
  module Models
    class APILeadsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APILeadsCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APILeadsCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APILeadsCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::APILeadsCreateParams::Body, Amocrm::Internal::AnyHash)
          end

        # Embedded entities (lead/contact/company/source)
        sig { returns(T.nilable(Amocrm::APILeadsCreateParams::Body::Embedded)) }
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::APILeadsCreateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APILeadsCreateParams::Body::CustomFieldsValue]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APILeadsCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::APILeadsCreateParams::Body::TagsToAdd])
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::APILeadsCreateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::APILeadsCreateParams::Body::Embedded,
              closed_at: Integer,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
              ...
              status_id: Integer,
              tags_to_add:
                T::Array[Amocrm::APILeadsCreateParams::Body::TagsToAdd],
              updated_at: Integer,
              updated_by: Integer,
              visitor_uid: String
            }
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsCreateParams::Body::Embedded,
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APILeadsCreateParams::Body::Embedded::Company]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::APILeadsCreateParams::Body::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APILeadsCreateParams::Body::Embedded::Contact]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::APILeadsCreateParams::Body::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(Amocrm::APILeadsCreateParams::Body::Embedded::Metadata)
            )
          end
          ...
          sig do
            params(
              metadata:
                Amocrm::APILeadsCreateParams::Body::Embedded::Metadata::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(Amocrm::APILeadsCreateParams::Body::Embedded::Source)
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                Amocrm::APILeadsCreateParams::Body::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APILeadsCreateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::APILeadsCreateParams::Body::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
            ...
            override.returns(
              {
                companies:
                  T::Array[
                    Amocrm::APILeadsCreateParams::Body::Embedded::Company
                  ],
                contacts:
                  T::Array[
                    Amocrm::APILeadsCreateParams::Body::Embedded::Contact
                  ],
                metadata:
                  Amocrm::APILeadsCreateParams::Body::Embedded::Metadata,
                source: Amocrm::APILeadsCreateParams::Body::Embedded::Source,
                tags:
                  T::Array[Amocrm::APILeadsCreateParams::Body::Embedded::Tag]
              }
            )
          ...
          class Contact < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::APILeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue
                  ]
                )
              )
            end
            ...
            sig do
              params(
                custom_fields_values:
                  T::Array[
                    Amocrm::APILeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::OrHash
                  ]
              ).void
            end
            attr_writer :custom_fields_values
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Amocrm::APILeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::Value
                  ]
                )
              end
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::APILeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer
                ).returns(T.attached_class)
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Amocrm::APILeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::Value::Value::Variants
                  )
                end
                attr_accessor :value
          ...
          class Metadata < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::APILeadsCreateParams::Body::Embedded::Metadata::Category::OrSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::APILeadsCreateParams::Body::Embedded::Metadata::FormID::Variants
                )
              )
            end
            attr_reader :form_id
            ...
            module Category
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::APILeadsCreateParams::Body::Embedded::Metadata::Category
                  )
                end
              ...
              SIP =
                T.let(
                  :sip,
                  Amocrm::APILeadsCreateParams::Body::Embedded::Metadata::Category::TaggedSymbol
                )
              FORMS =
                T.let(
                  :forms,
          ...
          class Source < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::APILeadsCreateParams::Body::Embedded::Source,
                  Amocrm::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::APILeadsCreateParams::Body::Embedded::Source::ExternalID::Variants
                )
              )
            end
          ...
          class Tag < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::APILeadsCreateParams::Body::Embedded::Tag,
                  Amocrm::Internal::AnyHash
                )
              end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsCreateParams::Body::CustomFieldsValue,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APILeadsCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          attr_accessor :values
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APILeadsCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APILeadsCreateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APILeadsCreateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
