  ...
  module Models
    class LeadUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::LeadUpdateParams::Body::TagsToAdd])
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::LeadUpdateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::LeadUpdateParams::Body::TagsToDelete])
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[Amocrm::LeadUpdateParams::Body::TagsToDelete::OrHash]
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(Amocrm::LeadUpdateParams::Body::Embedded::Metadata)
            )
          end
          ...
          sig do
            params(
              metadata:
                Amocrm::LeadUpdateParams::Body::Embedded::Metadata::OrHash
            ).void
          end
          attr_writer :metadata

          sig do
            returns(T.nilable(Amocrm::LeadUpdateParams::Body::Embedded::Source))
          end
          attr_reader :source
          ...
          sig do
            returns(
              T.nilable(T::Array[Amocrm::LeadUpdateParams::Body::Embedded::Tag])
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[Amocrm::LeadUpdateParams::Body::Embedded::Tag::OrHash]
            ).void
          end
          attr_writer :tags
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[Amocrm::LeadUpdateParams::Body::CustomFieldsValue::Value]
            )
          end
          attr_accessor :values
