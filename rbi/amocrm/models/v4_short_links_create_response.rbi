  ...
  module Models
    module V4ShortLinksCreateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4ShortLinksCreateResponse::ShortLinkCreateResponse,
            Amocrm::Models::V4ShortLinksCreateResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4ShortLinksCreateResponse::Variants]
        )
      end
      def self.variants
      end
