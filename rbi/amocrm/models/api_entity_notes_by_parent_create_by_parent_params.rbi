  ...
  module Models
    class APIEntityNotesByParentCreateByParentParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APIEntityNotesByParentCreateByParentParams,
      ...
      sig do
        returns(
          T::Array[Amocrm::APIEntityNotesByParentCreateByParentParams::Body]
        )
      end
      attr_accessor :body
        ...
        override.returns(
          {
            ...
            body:
              T::Array[
                Amocrm::APIEntityNotesByParentCreateByParentParams::Body
              ],
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Amocrm::APIEntityNotesByParentCreateByParentParams::EntityType
            )
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::APIEntityNotesByParentCreateByParentParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
