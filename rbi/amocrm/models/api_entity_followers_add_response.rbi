  ...
  module Models
    module APIEntityFollowersAddResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityFollowersAddResponse::EntityFollowerCreateResponse,
            Amocrm::Models::APIEntityFollowersAddResponse::Problem
          )
        end
      ...
      class EntityFollowerCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIEntityFollowersAddResponse::EntityFollowerCreateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIEntityFollowersAddResponse::EntityFollowerCreateResponse::Embedded::Follower
                ]
              )
            )
          end
          ...
          sig do
            params(
              followers:
                T::Array[
                  Amocrm::Models::APIEntityFollowersAddResponse::EntityFollowerCreateResponse::Embedded::Follower::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityFollowersAddResponse::Variants]
        )
      end
      def self.variants
      end
