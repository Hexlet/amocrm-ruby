...
module Amocrm
  module Models
    class APICustomersCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APICustomersCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APICustomersCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APICustomersCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICustomersCreateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end

        sig do
          returns(T.nilable(Amocrm::APICustomersCreateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::APICustomersCreateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::APICustomersCreateParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APICustomersCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APICustomersCreateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[
                Amocrm::APICustomersCreateParams::Body::TagsToAdd::OrHash
              ]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::APICustomersCreateParams::Body::Embedded,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
                T::Array[
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICustomersCreateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::APICustomersCreateParams::Body::Embedded::Segment
                ]
              )
            )
          end
          ...
          sig do
            params(
              segments:
                T::Array[
                  Amocrm::APICustomersCreateParams::Body::Embedded::Segment::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APICustomersCreateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::APICustomersCreateParams::Body::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
            ...
            override.returns(
              {
                ...
                tags:
                  T::Array[
                    Amocrm::APICustomersCreateParams::Body::Embedded::Tag
                  ]
              }
            )
          end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APICustomersCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APICustomersCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APICustomersCreateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICustomersCreateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
