  ...
  module Models
    class CallCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.any(Amocrm::CallCreateParams::Body::Direction::OrSymbol, String)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::CallCreateParams::Body::CallResponsible::Variants)
          )
        end
        ...
        module Direction
          ...
          sig do
            override.returns(
              T::Array[Amocrm::CallCreateParams::Body::Direction::Variants]
            )
          end
          def self.variants
          end
