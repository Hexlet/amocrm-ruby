  ...
  module Models
    module LeadGetByIDResponse
      ...
      class Lead < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::LeadGetByIDResponse::Lead::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              loss_reason:
                Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::LossReason::OrHash
            ).void
          end
          ...
          sig do
            params(
              source:
                Amocrm::Models::LeadGetByIDResponse::Lead::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::LeadGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
