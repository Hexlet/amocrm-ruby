  ...
  module Models
    module V4WidgetsUninstallResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WidgetsUninstallResponse::EmptyResponse,
            Amocrm::Models::V4WidgetsUninstallResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WidgetsUninstallResponse::Variants]
        )
      end
      def self.variants
      end
