  ...
  module Models
    module V4ContactsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4ContactsGetByIDResponse::Contact,
            Amocrm::Models::V4ContactsGetByIDResponse::Problem
          )
        end
      ...
      class Contact < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::V4ContactsGetByIDResponse::Contact::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::CustomFieldsValue::OrHash
                ]
              ),
            first_name: String,
            group_id: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::CatalogElement
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalog_elements:
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::CatalogElement::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Company
                ]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Customer
                ]
              )
            )
          end
          ...
          sig do
            params(
              customers:
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Customer::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Lead
                ]
              )
            )
          end
          ...
          sig do
            params(
              leads:
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Lead::OrHash
                ]
            ).void
          end
          attr_writer :leads
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::V4ContactsGetByIDResponse::Contact::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::V4ContactsGetByIDResponse::Contact::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::Models::V4ContactsGetByIDResponse::Contact::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4ContactsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
