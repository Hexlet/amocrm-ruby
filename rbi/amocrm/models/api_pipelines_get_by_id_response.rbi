  ...
  module Models
    module APIPipelinesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline,
            Amocrm::Models::APIPipelinesGetByIDResponse::Problem
          )
        end
      ...
      class Pipeline < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline::Embedded::Status
                ]
              )
            )
          end
          ...
          sig do
            params(
              statuses:
                T::Array[
                  Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline::Embedded::Status::OrHash
                ]
            ).void
          end
          ...
          class Status < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline::Embedded::Status::Description
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                descriptions:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APIPipelinesGetByIDResponse::Pipeline::Embedded::Status::Description::OrHash
                    ]
                  ),
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIPipelinesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
