  ...
  module Models
    module V4WidgetsGetByCodeResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WidgetsGetByCodeResponse::Widget,
            Amocrm::Models::V4WidgetsGetByCodeResponse::Problem
          )
        end
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::Rating::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::SettingsTemplate
              ]
            )
          )
        end
        ...
        sig do
          params(
            settings_template:
              T::Array[
                Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::SettingsTemplate::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4WidgetsGetByCodeResponse::Widget::Version::Variants
            )
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WidgetsGetByCodeResponse::Variants]
        )
      end
      def self.variants
      end
