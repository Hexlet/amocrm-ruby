  ...
  module Models
    module APIPipelineStatusesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse,
            Amocrm::Models::APIPipelineStatusesListResponse::Problem
          )
        end
      ...
      class StatusListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse::Embedded::Status
                ]
              )
            )
          end
          ...
          sig do
            params(
              statuses:
                T::Array[
                  Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse::Embedded::Status::OrHash
                ]
            ).void
          end
          ...
          class Status < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse::Embedded::Status::Description
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                descriptions:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APIPipelineStatusesListResponse::StatusListResponse::Embedded::Status::Description::OrHash
                    ]
                  ),
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIPipelineStatusesListResponse::Variants]
        )
      end
      def self.variants
      end
