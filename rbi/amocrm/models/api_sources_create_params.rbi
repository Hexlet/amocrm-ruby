...
module Amocrm
  module Models
    class APISourcesCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APISourcesCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APISourcesCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APISourcesCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APISourcesCreateParams::Body,
        ...
        sig do
          returns(
            T.nilable(Amocrm::APISourcesCreateParams::Body::Services::Variants)
          )
        end
        ...
        sig do
          params(
            services: Amocrm::APISourcesCreateParams::Body::Services::Variants
          ).void
        end
        ...
        module Services
          ...
          sig do
            override.returns(
              T::Array[Amocrm::APISourcesCreateParams::Body::Services::Variants]
            )
          end
          def self.variants
          end
