...
module Amocrm
  module Models
    class LeadUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      sig do
        params(_embedded: Amocrm::LeadUpdateByIDParams::Embedded::OrHash).void
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::LeadUpdateByIDParams::CustomFieldsValue])
        )
      end
      ...
      # Tags to attach
      sig do
        returns(T.nilable(T::Array[Amocrm::LeadUpdateByIDParams::TagsToAdd]))
      end
      ...
      # Tags to delete
      sig do
        returns(T.nilable(T::Array[Amocrm::LeadUpdateByIDParams::TagsToDelete]))
      end
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::LeadUpdateByIDParams::Embedded::Company])
          )
        end
        ...
        sig do
          params(
            companies:
              T::Array[Amocrm::LeadUpdateByIDParams::Embedded::Company::OrHash]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::LeadUpdateByIDParams::Embedded::Contact])
          )
        end
        ...
        sig do
          params(
            contacts:
              T::Array[Amocrm::LeadUpdateByIDParams::Embedded::Contact::OrHash]
          ).void
        end
        attr_writer :contacts

        sig do
          returns(T.nilable(Amocrm::LeadUpdateByIDParams::Embedded::Metadata))
        end
        ...
        sig do
          returns(T.nilable(Amocrm::LeadUpdateByIDParams::Embedded::Source))
        end
        attr_reader :source
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::LeadUpdateByIDParams::Embedded::Tag])
          )
        end
        attr_reader :tags
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[Amocrm::LeadUpdateByIDParams::CustomFieldsValue::Value]
          )
        end
        attr_accessor :values
