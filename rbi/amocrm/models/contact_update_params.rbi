  ...
  module Models
    class ContactUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::ContactUpdateParams::Body::TagsToAdd])
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::ContactUpdateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::ContactUpdateParams::Body::TagsToDelete])
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[Amocrm::ContactUpdateParams::Body::TagsToDelete::OrHash]
          ).void
        end
