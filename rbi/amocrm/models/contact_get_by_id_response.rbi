  ...
  module Models
    module ContactGetByIDResponse
      ...
      class Contact < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::ContactGetByIDResponse::Contact::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::ContactGetByIDResponse::Contact::Embedded::OrHash
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::ContactGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
