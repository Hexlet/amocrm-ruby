  ...
  module Models
    module APIRolesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIRolesGetByIDResponse::Role,
            Amocrm::Models::APIRolesGetByIDResponse::Problem
          )
        end
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::APIRolesGetByIDResponse::Role::Rights)
          )
        end
        attr_reader :rights
        ...
        sig do
          params(
            rights:
              Amocrm::Models::APIRolesGetByIDResponse::Role::Rights::OrHash
          ).void
        end
        attr_writer :rights
          ...
          override.returns(
            {
              id: Integer,
              _embedded:
                Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded,
              _links: T.anything,
              name: String,
              rights: Amocrm::Models::APIRolesGetByIDResponse::Role::Rights
            }
          )
        end
        def to_hash
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded::User
                ]
              )
            )
          end
          ...
          sig do
            params(
              users:
                T::Array[
                  Amocrm::Models::APIRolesGetByIDResponse::Role::Embedded::User::OrHash
                ]
            ).void
          end
          attr_writer :users
        ...
        class Rights < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::APIRolesGetByIDResponse::Role::Rights,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIRolesGetByIDResponse::Role::Rights::StatusRight
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::Models::APIRolesGetByIDResponse::Role::Rights::StatusRight::OrHash
                  ]
                ),
              tasks: T.anything
            ).returns(T.attached_class)
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIRolesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
