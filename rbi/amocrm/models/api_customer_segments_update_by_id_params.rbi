  ...
  module Models
    class APICustomerSegmentsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APICustomerSegmentsUpdateByIDParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Amocrm::APICustomerSegmentsUpdateByIDParams::CustomFieldsValue
            ]
          )
        )
      end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Amocrm::APICustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::APICustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::APICustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
