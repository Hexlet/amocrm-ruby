  ...
  module Models
    class V4CustomerSegmentsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4CustomerSegmentsUpdateByIDParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue
            ]
          )
        )
      end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::V4CustomerSegmentsUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
