  ...
  module Models
    module V4TalksGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4TalksGetByIDResponse::Talk,
            Amocrm::Models::V4TalksGetByIDResponse::Problem
          )
        end
      ...
      class Talk < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded,
              _links: T.anything,
              account_id: Integer,
              chat_id: String,
              contact_id: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::Customer
                ]
              )
            )
          end
          ...
          sig do
            params(
              customers:
                T::Array[
                  Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::Customer::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::Lead
                ]
              )
            )
          end
          ...
          sig do
            params(
              leads:
                T::Array[
                  Amocrm::Models::V4TalksGetByIDResponse::Talk::Embedded::Lead::OrHash
                ]
            ).void
          end
          attr_writer :leads
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4TalksGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
