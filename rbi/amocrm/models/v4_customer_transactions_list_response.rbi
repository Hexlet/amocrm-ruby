  ...
  module Models
    module V4CustomerTransactionsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomerTransactionsListResponse::CustomerTransactionListResponse,
            Amocrm::Models::V4CustomerTransactionsListResponse::Problem
          )
        end
      ...
      class CustomerTransactionListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CustomerTransactionsListResponse::CustomerTransactionListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomerTransactionsListResponse::CustomerTransactionListResponse::Embedded::Transaction
                ]
              )
            )
          end
          ...
          sig do
            params(
              transactions:
                T::Array[
                  Amocrm::Models::V4CustomerTransactionsListResponse::CustomerTransactionListResponse::Embedded::Transaction::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomerTransactionsListResponse::Variants]
        )
      end
      def self.variants
      end
