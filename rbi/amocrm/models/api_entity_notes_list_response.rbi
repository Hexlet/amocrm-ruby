  ...
  module Models
    module APIEntityNotesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityNotesListResponse::NoteListResponse,
            Amocrm::Models::APIEntityNotesListResponse::Problem
          )
        end
      ...
      class NoteListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIEntityNotesListResponse::NoteListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIEntityNotesListResponse::NoteListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIEntityNotesListResponse::NoteListResponse::Embedded::Note
                ]
              )
            )
          end
          ...
          sig do
            params(
              notes:
                T::Array[
                  Amocrm::Models::APIEntityNotesListResponse::NoteListResponse::Embedded::Note::OrHash
                ]
            ).void
          end
          attr_writer :notes
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityNotesListResponse::Variants]
        )
      end
      def self.variants
      end
