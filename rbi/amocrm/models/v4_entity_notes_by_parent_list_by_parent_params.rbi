  ...
  module Models
    class V4EntityNotesByParentListByParentParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4EntityNotesByParentListByParentParams,
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Amocrm::V4EntityNotesByParentListByParentParams::EntityType
            )
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::V4EntityNotesByParentListByParentParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
