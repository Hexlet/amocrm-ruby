...
module Amocrm
  module Models
    class V4ContactChatsLinkParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4ContactChatsLinkParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4ContactChatsLinkParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4ContactChatsLinkParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4ContactChatsLinkParams::Body,
