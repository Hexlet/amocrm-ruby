  ...
  module Models
    module V4CatalogsUpdateByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse,
            Amocrm::Models::V4CatalogsUpdateByIDResponse::Problem
          )
        end
      ...
      class CatalogUpdateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalogs:
                T::Array[
                  Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog::OrHash
                ]
            ).void
          end
          ...
          class Catalog < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog::SDKWidgetCode::Variants
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog::Type::Variants
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  T.any(
                    Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog::Type::OrSymbol,
                    String
                  )
              ).void
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::Models::V4CatalogsUpdateByIDResponse::CatalogUpdateResponse::Embedded::Catalog::Type
                  )
                end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CatalogsUpdateByIDResponse::Variants]
        )
      end
      def self.variants
      end
