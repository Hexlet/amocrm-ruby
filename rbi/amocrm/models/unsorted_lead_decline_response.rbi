    ...
    module UnsortedLeadDeclineResponse
      ...
      class UnsortedAcceptResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::UnsortedLeadDeclineResponse::UnsortedAcceptResponse::Embedded::OrHash
          ).void
        end
        ...
        sig do
          params(
            category:
              Amocrm::Models::UnsortedLeadDeclineResponse::UnsortedAcceptResponse::Category::OrSymbol
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::UnsortedLeadDeclineResponse::Variants]
        )
      end
      def self.variants
      end
