...
module Amocrm
  module Models
    class V4RolesCreateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Amocrm::V4RolesCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4RolesCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4RolesCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::V4RolesCreateParams::Body, Amocrm::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Amocrm::V4RolesCreateParams::Body::Rights)) }
        attr_reader :rights

        sig do
          params(rights: Amocrm::V4RolesCreateParams::Body::Rights::OrHash).void
        end
        attr_writer :rights
        ...
        sig do
          params(
            name: String,
            request_id: String,
            rights: Amocrm::V4RolesCreateParams::Body::Rights::OrHash
          ).returns(T.attached_class)
        end
          ...
          override.returns(
            {
              name: String,
              request_id: String,
              rights: Amocrm::V4RolesCreateParams::Body::Rights
            }
          )
        end
        def to_hash
        ...
        class Rights < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4RolesCreateParams::Body::Rights,
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4RolesCreateParams::Body::Rights::StatusRight]
              )
            )
          end
          ...
          sig do
            params(
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::V4RolesCreateParams::Body::Rights::StatusRight::OrHash
                  ]
                ),
              tasks: T.anything
            ).returns(T.attached_class)
            ...
            override.returns(
              {
                ...
                status_rights:
                  T.nilable(
                    T::Array[
                      Amocrm::V4RolesCreateParams::Body::Rights::StatusRight
                    ]
                  ),
                tasks: T.anything
              }
