  ...
  module Models
    module APIEntityNotesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityNotesGetByIDResponse::Note,
            Amocrm::Models::APIEntityNotesGetByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityNotesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
