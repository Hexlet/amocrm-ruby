...
module Amocrm
  module Models
    class APIRolesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APIRolesUpdateByIDParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Amocrm::APIRolesUpdateByIDParams::Rights)) }
      attr_reader :rights
        ...
        override.returns(
          {
            name: String,
            request_id: String,
            rights: T.nilable(Amocrm::APIRolesUpdateByIDParams::Rights),
      ...
      class Rights < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIRolesUpdateByIDParams::Rights,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIRolesUpdateByIDParams::Rights::StatusRight]
            )
          )
        end
        ...
        sig do
          params(
            ...
            status_rights:
              T.nilable(
                T::Array[
                  Amocrm::APIRolesUpdateByIDParams::Rights::StatusRight::OrHash
                ]
              ),
            tasks: T.anything
          ).returns(T.attached_class)
          ...
          override.returns(
            {
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::APIRolesUpdateByIDParams::Rights::StatusRight
                  ]
                ),
              tasks: T.anything
            }
