    ...
    module LeadListResponse
      ...
      class LeadListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::LeadListResponse::LeadListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          class Lead < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::LeadListResponse::LeadListResponse::Embedded::Lead::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  loss_reason:
                    Amocrm::Models::LeadListResponse::LeadListResponse::Embedded::Lead::Embedded::LossReason::OrHash
                ).void
              end
              ...
              sig do
                params(
                  source:
                    Amocrm::Models::LeadListResponse::LeadListResponse::Embedded::Lead::Embedded::Source::OrHash
                ).void
              end
              attr_writer :source
      ...
      sig do
        override.returns(T::Array[Amocrm::Models::LeadListResponse::Variants])
      end
      def self.variants
      end
    end
