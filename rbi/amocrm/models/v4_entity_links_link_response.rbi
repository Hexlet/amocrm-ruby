  ...
  module Models
    module V4EntityLinksLinkResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityLinksLinkResponse::EmptyResponse,
            Amocrm::Models::V4EntityLinksLinkResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityLinksLinkResponse::Variants]
        )
      end
      def self.variants
      end
