    ...
    module RoleCreateResponse
      ...
      class RoleCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::RoleCreateResponse::RoleCreateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          class Role < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::RoleCreateResponse::RoleCreateResponse::Embedded::Role::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              params(
                rights:
                  Amocrm::Models::RoleCreateResponse::RoleCreateResponse::Embedded::Role::Rights::OrHash
              ).void
            end
            attr_writer :rights
      ...
      sig do
        override.returns(T::Array[Amocrm::Models::RoleCreateResponse::Variants])
      end
      def self.variants
      end
    end
