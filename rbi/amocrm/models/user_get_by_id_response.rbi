  ...
  module Models
    module UserGetByIDResponse
      ...
      class User < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::UserGetByIDResponse::User::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::UserGetByIDResponse::User::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(T.nilable(Amocrm::Models::UserGetByIDResponse::User::Rights))
        end
        attr_reader :rights
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          class Role < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::UserGetByIDResponse::User::Embedded::Role::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              params(
                rights:
                  Amocrm::Models::UserGetByIDResponse::User::Embedded::Role::Rights::OrHash
              ).void
            end
            attr_writer :rights
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::UserGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
