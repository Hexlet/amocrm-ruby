  ...
  module Models
    module V4EntityLinksUnlinkResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityLinksUnlinkResponse::EmptyResponse,
            Amocrm::Models::V4EntityLinksUnlinkResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityLinksUnlinkResponse::Variants]
        )
      end
      def self.variants
      end
