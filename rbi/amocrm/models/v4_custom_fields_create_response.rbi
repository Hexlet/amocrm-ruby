  ...
  module Models
    module V4CustomFieldsCreateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomFieldsCreateResponse::CustomFieldCreateResponse,
            Amocrm::Models::V4CustomFieldsCreateResponse::Problem
          )
        end
      ...
      class CustomFieldCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CustomFieldsCreateResponse::CustomFieldCreateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomFieldsCreateResponse::CustomFieldCreateResponse::Embedded::CustomField
                ]
              )
            )
          end
          ...
          sig do
            params(
              custom_fields:
                T::Array[
                  Amocrm::Models::V4CustomFieldsCreateResponse::CustomFieldCreateResponse::Embedded::CustomField::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomFieldsCreateResponse::Variants]
        )
      end
      def self.variants
      end
