  ...
  module Models
    class APIPipelineStatusesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APIPipelineStatusesUpdateByIDParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::APIPipelineStatusesUpdateByIDParams::Description]
          )
        )
      end
        ...
        override.returns(
          {
            ...
            descriptions:
              T::Array[
                Amocrm::APIPipelineStatusesUpdateByIDParams::Description
              ],
            name: String,
            request_id: String,
            sort: Integer,
