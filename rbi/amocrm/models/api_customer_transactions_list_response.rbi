  ...
  module Models
    module APICustomerTransactionsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICustomerTransactionsListResponse::CustomerTransactionListResponse,
            Amocrm::Models::APICustomerTransactionsListResponse::Problem
          )
        end
      ...
      class CustomerTransactionListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICustomerTransactionsListResponse::CustomerTransactionListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            params(
              transactions:
                T::Array[
                  Amocrm::Models::APICustomerTransactionsListResponse::CustomerTransactionListResponse::Embedded::Transaction::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[
            Amocrm::Models::APICustomerTransactionsListResponse::Variants
          ]
        )
      end
      def self.variants
