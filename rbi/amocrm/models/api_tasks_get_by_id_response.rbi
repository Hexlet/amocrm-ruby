  ...
  module Models
    module APITasksGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APITasksGetByIDResponse::Task,
            Amocrm::Models::APITasksGetByIDResponse::Problem
          )
        end
      ...
      class Task < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APITasksGetByIDResponse::Task::Result::Variants
            )
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.any(
                Amocrm::Models::APITasksGetByIDResponse::Task::Result::Text::OrHash,
                T.anything
              )
          ).void
        end
        ...
        module Result
          ...
          Variants =
            T.type_alias do
              T.any(
                Amocrm::Models::APITasksGetByIDResponse::Task::Result::Text,
                T.anything
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APITasksGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
