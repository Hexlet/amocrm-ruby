  ...
  module Models
    module APIWidgetsGetByCodeResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWidgetsGetByCodeResponse::Widget,
            Amocrm::Models::APIWidgetsGetByCodeResponse::Problem
          )
        end
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::Rating::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::SettingsTemplate
              ]
            )
          )
        end
        ...
        sig do
          params(
            settings_template:
              T::Array[
                Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::SettingsTemplate::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIWidgetsGetByCodeResponse::Widget::Version::Variants
            )
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWidgetsGetByCodeResponse::Variants]
        )
      end
      def self.variants
      end
