  ...
  module Models
    class APIEntityNotesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APIEntityNotesUpdateByIDParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig do
        returns(Amocrm::APIEntityNotesUpdateByIDParams::EntityType::OrSymbol)
      end
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Amocrm::APIEntityNotesUpdateByIDParams::EntityType)
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::APIEntityNotesUpdateByIDParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
