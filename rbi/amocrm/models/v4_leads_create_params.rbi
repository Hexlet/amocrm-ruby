...
module Amocrm
  module Models
    class V4LeadsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4LeadsCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4LeadsCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4LeadsCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::V4LeadsCreateParams::Body, Amocrm::Internal::AnyHash)
          end

        # Embedded entities (lead/contact/company/source)
        sig { returns(T.nilable(Amocrm::V4LeadsCreateParams::Body::Embedded)) }
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::V4LeadsCreateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4LeadsCreateParams::Body::CustomFieldsValue]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::V4LeadsCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::V4LeadsCreateParams::Body::TagsToAdd])
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::V4LeadsCreateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::V4LeadsCreateParams::Body::Embedded,
              closed_at: Integer,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
              ...
              status_id: Integer,
              tags_to_add:
                T::Array[Amocrm::V4LeadsCreateParams::Body::TagsToAdd],
              updated_at: Integer,
              updated_by: Integer,
              visitor_uid: String
            }
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4LeadsCreateParams::Body::Embedded,
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4LeadsCreateParams::Body::Embedded::Company]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4LeadsCreateParams::Body::Embedded::Contact]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata)
            )
          end
          ...
          sig do
            params(
              metadata:
                Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(Amocrm::V4LeadsCreateParams::Body::Embedded::Source)
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                Amocrm::V4LeadsCreateParams::Body::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::V4LeadsCreateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
            ...
            override.returns(
              {
                companies:
                  T::Array[
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Company
                  ],
                contacts:
                  T::Array[
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Contact
                  ],
                metadata: Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata,
                source: Amocrm::V4LeadsCreateParams::Body::Embedded::Source,
                tags: T::Array[Amocrm::V4LeadsCreateParams::Body::Embedded::Tag]
              }
            )
          end
          def to_hash
          ...
          class Contact < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue
                  ]
                )
              )
            end
            ...
            sig do
              params(
                custom_fields_values:
                  T::Array[
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::OrHash
                  ]
              ).void
            end
            attr_writer :custom_fields_values
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::Value
                  ]
                )
              end
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::V4LeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer
                ).returns(T.attached_class)
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Contact::CustomFieldsValue::Value::Value::Variants
                  )
                end
                attr_accessor :value
          ...
          class Metadata < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata,
                  Amocrm::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata::Category::OrSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata::FormID::Variants
                )
              )
            end
            attr_reader :form_id
            ...
            module Category
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata::Category
                  )
                end
              ...
              SIP =
                T.let(
                  :sip,
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Metadata::Category::TaggedSymbol
                )
              FORMS =
                T.let(
                  :forms,
          ...
          class Source < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Source,
                  Amocrm::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Source::ExternalID::Variants
                )
              )
            end
          ...
          class Tag < Amocrm::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Amocrm::V4LeadsCreateParams::Body::Embedded::Tag,
                  Amocrm::Internal::AnyHash
                )
              end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4LeadsCreateParams::Body::CustomFieldsValue,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T::Array[
                Amocrm::V4LeadsCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          attr_accessor :values
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::V4LeadsCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::V4LeadsCreateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4LeadsCreateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
