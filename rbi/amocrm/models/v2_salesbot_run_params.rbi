...
module Amocrm
  module Models
    class V2SalesbotRunParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V2SalesbotRunParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V2SalesbotRunParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V2SalesbotRunParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::V2SalesbotRunParams::Body, Amocrm::Internal::AnyHash)
          end
