  ...
  module Models
    module APICompaniesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICompaniesGetByIDResponse::Company,
            Amocrm::Models::APICompaniesGetByIDResponse::Problem
          )
        end
      ...
      class Company < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::APICompaniesGetByIDResponse::Company::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::CustomFieldsValue::OrHash
                ]
              ),
            group_id: Integer,
            name: String,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::CatalogElement
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalog_elements:
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::CatalogElement::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Customer
                ]
              )
            )
          end
          ...
          sig do
            params(
              customers:
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Customer::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Lead
                ]
              )
            )
          end
          ...
          sig do
            params(
              leads:
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Lead::OrHash
                ]
            ).void
          end
          attr_writer :leads
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::APICompaniesGetByIDResponse::Company::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::APICompaniesGetByIDResponse::Company::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::Models::APICompaniesGetByIDResponse::Company::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICompaniesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
