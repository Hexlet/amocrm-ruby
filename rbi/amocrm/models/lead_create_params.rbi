  ...
  module Models
    class LeadCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::LeadCreateParams::Body::TagsToAdd])
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::LeadCreateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(Amocrm::LeadCreateParams::Body::Embedded::Metadata)
            )
          end
          ...
          sig do
            params(
              metadata:
                Amocrm::LeadCreateParams::Body::Embedded::Metadata::OrHash
            ).void
          end
          attr_writer :metadata

          sig do
            returns(T.nilable(Amocrm::LeadCreateParams::Body::Embedded::Source))
          end
          attr_reader :source
          ...
          sig do
            returns(
              T.nilable(T::Array[Amocrm::LeadCreateParams::Body::Embedded::Tag])
            )
          end
          attr_reader :tags
          ...
          sig do
            params(
              tags:
                T::Array[Amocrm::LeadCreateParams::Body::Embedded::Tag::OrHash]
            ).void
          end
          attr_writer :tags
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[Amocrm::LeadCreateParams::Body::CustomFieldsValue::Value]
            )
          end
          attr_accessor :values
