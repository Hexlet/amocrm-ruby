  ...
  module Models
    module APIRolesUpdateByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIRolesUpdateByIDResponse::Role,
            Amocrm::Models::APIRolesUpdateByIDResponse::Problem
          )
        end
      ...
      class Role < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights)
          )
        end
        attr_reader :rights
        ...
        sig do
          params(
            rights:
              Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights::OrHash
          ).void
        end
        attr_writer :rights
          ...
          override.returns(
            {
              ...
              _links: T.anything,
              name: String,
              rights: Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights
            }
          )
        end
        def to_hash
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded::User
                ]
              )
            )
          end
          ...
          sig do
            params(
              users:
                T::Array[
                  Amocrm::Models::APIRolesUpdateByIDResponse::Role::Embedded::User::OrHash
                ]
            ).void
          end
          attr_writer :users
        ...
        class Rights < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights::StatusRight
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              status_rights:
                T.nilable(
                  T::Array[
                    Amocrm::Models::APIRolesUpdateByIDResponse::Role::Rights::StatusRight::OrHash
                  ]
                ),
              tasks: T.anything
            ).returns(T.attached_class)
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIRolesUpdateByIDResponse::Variants]
        )
      end
      def self.variants
      end
