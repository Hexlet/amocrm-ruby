  ...
  module Models
    class V4EntityNotesByParentUpdateByParentParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4EntityNotesByParentUpdateByParentParams,
      ...
      sig do
        returns(
          T::Array[Amocrm::V4EntityNotesByParentUpdateByParentParams::Body]
        )
      end
      attr_accessor :body
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Amocrm::V4EntityNotesByParentUpdateByParentParams::EntityType
            )
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::V4EntityNotesByParentUpdateByParentParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4EntityNotesByParentUpdateByParentParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
