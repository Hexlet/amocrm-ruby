  ...
  module Models
    module V4PipelineStatusesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse,
            Amocrm::Models::V4PipelineStatusesListResponse::Problem
          )
        end
      ...
      class StatusListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse::Embedded::Status
                ]
              )
            )
          end
          ...
          sig do
            params(
              statuses:
                T::Array[
                  Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse::Embedded::Status::OrHash
                ]
            ).void
          end
          ...
          class Status < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse::Embedded::Status::Description
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                descriptions:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4PipelineStatusesListResponse::StatusListResponse::Embedded::Status::Description::OrHash
                    ]
                  ),
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4PipelineStatusesListResponse::Variants]
        )
      end
      def self.variants
      end
