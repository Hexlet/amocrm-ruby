  ...
  module Models
    module V4CustomFieldsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomFieldsGetByIDResponse::CustomField,
            Amocrm::Models::V4CustomFieldsGetByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomFieldsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
