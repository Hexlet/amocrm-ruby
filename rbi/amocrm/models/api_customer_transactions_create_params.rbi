  ...
  module Models
    class APICustomerTransactionsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APICustomerTransactionsCreateParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig do
        returns(T::Array[Amocrm::APICustomerTransactionsCreateParams::Body])
      end
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APICustomerTransactionsCreateParams::Body],
            accrue_bonus: T::Boolean,
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICustomerTransactionsCreateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
