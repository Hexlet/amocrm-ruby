  ...
  module Models
    module V4PipelinesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline,
            Amocrm::Models::V4PipelinesGetByIDResponse::Problem
          )
        end
      ...
      class Pipeline < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline::Embedded::Status
                ]
              )
            )
          end
          ...
          sig do
            params(
              statuses:
                T::Array[
                  Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline::Embedded::Status::OrHash
                ]
            ).void
          end
          ...
          class Status < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline::Embedded::Status::Description
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                descriptions:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4PipelinesGetByIDResponse::Pipeline::Embedded::Status::Description::OrHash
                    ]
                  ),
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4PipelinesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
