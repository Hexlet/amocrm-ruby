  ...
  module Models
    module APICustomerSegmentsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse,
            Amocrm::Models::APICustomerSegmentsListResponse::Problem
          )
        end
      ...
      class CustomerSegmentListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse::Embedded::Segment
                ]
              )
            )
          end
          ...
          sig do
            params(
              segments:
                T::Array[
                  Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse::Embedded::Segment::OrHash
                ]
            ).void
          end
            ...
            sig do
              params(
                ...
                custom_fields_values:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::OrHash
                    ]
                  ),
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer
                ).returns(T.attached_class)
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Amocrm::Models::APICustomerSegmentsListResponse::CustomerSegmentListResponse::Embedded::Segment::CustomFieldsValue::Value::Value::Variants
                  )
                end
                attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICustomerSegmentsListResponse::Variants]
        )
      end
      def self.variants
      end
