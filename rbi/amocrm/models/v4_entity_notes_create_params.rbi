...
module Amocrm
  module Models
    class V4EntityNotesCreateParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Amocrm::V4EntityNotesCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4EntityNotesCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4EntityNotesCreateParams::Body],
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Amocrm::V4EntityNotesCreateParams::EntityType)
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::V4EntityNotesCreateParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4EntityNotesCreateParams::Body,
