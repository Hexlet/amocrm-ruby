...
module Amocrm
  module Models
    class V4CustomersUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4CustomersUpdateByIDParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T.nilable(Amocrm::V4CustomersUpdateByIDParams::Embedded)) }
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::V4CustomersUpdateByIDParams::TagsToAdd])
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::V4CustomersUpdateByIDParams::TagsToDelete])
        )
      end
      ...
      sig do
        override.returns(
          {
            _embedded: Amocrm::V4CustomersUpdateByIDParams::Embedded,
            custom_fields_values:
              T::Array[Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue],
            main_user_id: Integer,
            name: String,
            ...
            status_id: Integer,
            tags_to_add:
              T::Array[Amocrm::V4CustomersUpdateByIDParams::TagsToAdd],
            tags_to_delete:
              T::Array[Amocrm::V4CustomersUpdateByIDParams::TagsToDelete],
            updated_at: Integer,
            updated_by: Integer,
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CustomersUpdateByIDParams::Embedded,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersUpdateByIDParams::Embedded::Segment]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4CustomersUpdateByIDParams::Embedded::Tag]
            )
          )
        end
        attr_accessor :tags
        ...
        sig do
          params(
            segments:
              T.nilable(
                T::Array[
                  Amocrm::V4CustomersUpdateByIDParams::Embedded::Segment::OrHash
                ]
              ),
            tags:
              T.nilable(
                T::Array[
                  Amocrm::V4CustomersUpdateByIDParams::Embedded::Tag::OrHash
                ]
              )
          ).returns(T.attached_class)
        end
          ...
          override.returns(
            {
              segments:
                T.nilable(
                  T::Array[
                    Amocrm::V4CustomersUpdateByIDParams::Embedded::Segment
                  ]
                ),
              tags:
                T.nilable(
        ...
        class Tag < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4CustomersUpdateByIDParams::Embedded::Tag,
                Amocrm::Internal::AnyHash
              )
            end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::V4CustomersUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
      ...
      class TagsToAdd < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CustomersUpdateByIDParams::TagsToAdd,
              Amocrm::Internal::AnyHash
            )
          end
      ...
      class TagsToDelete < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CustomersUpdateByIDParams::TagsToDelete,
              Amocrm::Internal::AnyHash
            )
          end
