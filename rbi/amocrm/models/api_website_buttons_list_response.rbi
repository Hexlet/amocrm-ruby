  ...
  module Models
    module APIWebsiteButtonsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWebsiteButtonsListResponse::WebsiteButtonListResponse,
            Amocrm::Models::APIWebsiteButtonsListResponse::Problem
          )
        end
      ...
      class WebsiteButtonListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIWebsiteButtonsListResponse::WebsiteButtonListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIWebsiteButtonsListResponse::WebsiteButtonListResponse::Embedded::WebsiteButton
                ]
              )
            )
          end
          ...
          sig do
            params(
              website_buttons:
                T::Array[
                  Amocrm::Models::APIWebsiteButtonsListResponse::WebsiteButtonListResponse::Embedded::WebsiteButton::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWebsiteButtonsListResponse::Variants]
        )
      end
      def self.variants
      end
