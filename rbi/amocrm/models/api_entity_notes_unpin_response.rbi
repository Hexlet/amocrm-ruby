  ...
  module Models
    module APIEntityNotesUnpinResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityNotesUnpinResponse::EmptyResponse,
            Amocrm::Models::APIEntityNotesUnpinResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityNotesUnpinResponse::Variants]
        )
      end
      def self.variants
      end
