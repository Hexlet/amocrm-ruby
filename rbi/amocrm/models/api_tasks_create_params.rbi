...
module Amocrm
  module Models
    class APITasksCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APITasksCreateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APITasksCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APITasksCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Amocrm::APITasksCreateParams::Body, Amocrm::Internal::AnyHash)
          end
