  ...
  module Models
    class V4EntityNotesByParentUpdateByParentIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4EntityNotesByParentUpdateByParentIDParams,
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Amocrm::V4EntityNotesByParentUpdateByParentIDParams::EntityType
            )
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::V4EntityNotesByParentUpdateByParentIDParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
