  ...
  module Models
    module APIEntityLinksUnlinkResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityLinksUnlinkResponse::EmptyResponse,
            Amocrm::Models::APIEntityLinksUnlinkResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityLinksUnlinkResponse::Variants]
        )
      end
      def self.variants
      end
