...
module Amocrm
  module Models
    class APISourcesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APISourcesUpdateByIDParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(Amocrm::APISourcesUpdateByIDParams::Services::Variants)
        )
      end
      ...
      module Services
        ...
        sig do
          override.returns(
            T::Array[Amocrm::APISourcesUpdateByIDParams::Services::Variants]
          )
        end
        def self.variants
        end
