  ...
  module Models
    module APIRolesDeleteByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIRolesDeleteByIDResponse::EmptyResponse,
            Amocrm::Models::APIRolesDeleteByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIRolesDeleteByIDResponse::Variants]
        )
      end
      def self.variants
      end
