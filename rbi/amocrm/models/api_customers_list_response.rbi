  ...
  module Models
    module APICustomersListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APICustomersListResponse::CustomerListResponse,
            Amocrm::Models::APICustomersListResponse::Problem
          )
        end
      ...
      class CustomerListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer
                ]
              )
            )
          end
          ...
          sig do
            params(
              customers:
                T::Array[
                  Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::OrHash
                ]
            ).void
          end
          ...
          class Customer < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::CustomFieldsValue
                  ]
                )
              )
            end
            ...
            sig do
              params(
                ...
                custom_fields_values:
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::CustomFieldsValue::OrHash
                    ]
                  ),
                group_id: Integer,
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  catalog_elements:
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::CatalogElement::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Company
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  companies:
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Company::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Contact
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  contacts:
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Contact::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Segment
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  segments:
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Segment::OrHash
                    ]
                ).void
              end
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Tag
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  tags:
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::Embedded::Tag::OrHash
                    ]
                ).void
              end
              attr_writer :tags
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer
                ).returns(T.attached_class)
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Amocrm::Models::APICustomersListResponse::CustomerListResponse::Embedded::Customer::CustomFieldsValue::Value::Value::Variants
                  )
                end
                attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APICustomersListResponse::Variants]
        )
      end
      def self.variants
      end
