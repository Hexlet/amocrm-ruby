  ...
  module Models
    class APIEntityNotesByParentUpdateByParentIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APIEntityNotesByParentUpdateByParentIDParams,
      ...
      module EntityType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Amocrm::APIEntityNotesByParentUpdateByParentIDParams::EntityType
            )
          end
        ...
        LEADS =
          T.let(
            :leads,
            Amocrm::APIEntityNotesByParentUpdateByParentIDParams::EntityType::TaggedSymbol
          )
        CONTACTS =
          T.let(
            :contacts,
