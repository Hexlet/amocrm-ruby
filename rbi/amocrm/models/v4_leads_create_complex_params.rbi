...
module Amocrm
  module Models
    class V4LeadsCreateComplexParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::V4LeadsCreateComplexParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::V4LeadsCreateComplexParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4LeadsCreateComplexParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4LeadsCreateComplexParams::Body,
        ...
        sig do
          returns(T.nilable(Amocrm::V4LeadsCreateComplexParams::Body::Embedded))
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::V4LeadsCreateComplexParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::V4LeadsCreateComplexParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::V4LeadsCreateComplexParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::V4LeadsCreateComplexParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[
                Amocrm::V4LeadsCreateComplexParams::Body::TagsToAdd::OrHash
              ]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              _embedded: Amocrm::V4LeadsCreateComplexParams::Body::Embedded,
              closed_at: Integer,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4LeadsCreateComplexParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Company
                ]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Metadata
              )
            )
          end
          ...
          sig do
            params(
              metadata:
                Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Metadata::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Source
              )
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
          ...
          class Contact < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact::CustomFieldsValue
                  ]
                )
              )
            end
            ...
            sig do
              params(
                custom_fields_values:
                  T::Array[
                    Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact::CustomFieldsValue::OrHash
                  ]
              ).void
            end
            attr_writer :custom_fields_values
            ...
            class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact::CustomFieldsValue::Value
                  ]
                )
              end
              ...
              sig do
                params(
                  values:
                    T::Array[
                      Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact::CustomFieldsValue::Value::OrHash
                    ],
                  field_code: String,
                  field_id: Integer
                ).returns(T.attached_class)
              ...
              class Value < Amocrm::Internal::Type::BaseModel
                ...
                sig do
                  returns(
                    Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Contact::CustomFieldsValue::Value::Value::Variants
                  )
                end
                attr_accessor :value
          ...
          class Metadata < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Metadata::Category::OrSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Metadata::FormID::Variants
                )
              )
            end
            attr_reader :form_id
            ...
            module Category
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Metadata::Category
                  )
                end
              ...
              SIP =
                T.let(
                  :sip,
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Metadata::Category::TaggedSymbol
                )
              FORMS =
                T.let(
                  :forms,
          ...
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::V4LeadsCreateComplexParams::Body::Embedded::Source::ExternalID::Variants
                )
              )
            end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::V4LeadsCreateComplexParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          attr_accessor :values
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::V4LeadsCreateComplexParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::V4LeadsCreateComplexParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::V4LeadsCreateComplexParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
