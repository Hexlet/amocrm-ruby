  ...
  module Models
    module V4LeadsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4LeadsGetByIDResponse::Lead,
            Amocrm::Models::V4LeadsGetByIDResponse::Problem
          )
        end
      ...
      class Lead < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::OrHash
                ]
              ),
            group_id: Integer,
        ...
        sig do
          override.returns(
            {
              id: Integer,
              _embedded: Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded,
              _links: T.anything,
              account_id: Integer,
              closed_at: Integer,
              closest_task_at: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::CatalogElement
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalog_elements:
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::CatalogElement::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Company
                ]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::LossReason
              )
            )
          end
          ...
          sig do
            params(
              loss_reason:
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::LossReason::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source
              )
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
          ...
          class Contact < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(id: Integer, is_main: T::Boolean).returns(T.attached_class)
            end
          ...
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::Embedded::Source::ExternalID::Variants
                )
              )
            end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::Models::V4LeadsGetByIDResponse::Lead::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4LeadsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
