  ...
  module Models
    module V4SourcesDeleteByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4SourcesDeleteByIDResponse::EmptyResponse,
            Amocrm::Models::V4SourcesDeleteByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4SourcesDeleteByIDResponse::Variants]
        )
      end
      def self.variants
      end
