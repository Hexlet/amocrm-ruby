  ...
  module Models
    module V4CustomFieldGroupsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomFieldGroupsGetByIDResponse::CustomFieldGroup,
            Amocrm::Models::V4CustomFieldGroupsGetByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomFieldGroupsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
