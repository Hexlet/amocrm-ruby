  ...
  module Models
    class V4CatalogElementsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4CatalogElementsUpdateByIDParams,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Amocrm::V4CatalogElementsUpdateByIDParams::CustomFieldsValue
            ]
          )
        )
      end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Amocrm::V4CatalogElementsUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::V4CatalogElementsUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer,
            field_name: String,
