...
module Amocrm
  module Models
    class APIContactsUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APIContactsUpdateByIDParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T.nilable(Amocrm::APIContactsUpdateByIDParams::Embedded)) }
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::APIContactsUpdateByIDParams::TagsToAdd])
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::APIContactsUpdateByIDParams::TagsToDelete])
        )
      end
      ...
      sig do
        override.returns(
          {
            _embedded: Amocrm::APIContactsUpdateByIDParams::Embedded,
            created_at: Integer,
            created_by: Integer,
            custom_fields_values:
              T::Array[Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue],
            ...
            responsible_user_id: Integer,
            tags_to_add:
              T::Array[Amocrm::APIContactsUpdateByIDParams::TagsToAdd],
            tags_to_delete:
              T::Array[Amocrm::APIContactsUpdateByIDParams::TagsToDelete],
            updated_at: Integer,
            updated_by: Integer,
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIContactsUpdateByIDParams::Embedded,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APIContactsUpdateByIDParams::Embedded::Tag]
            )
          )
        end
        attr_accessor :tags
        ...
        sig do
          params(
            tags:
              T.nilable(
                T::Array[
                  Amocrm::APIContactsUpdateByIDParams::Embedded::Tag::OrHash
                ]
              )
          ).returns(T.attached_class)
        end
        ...
        class Tag < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APIContactsUpdateByIDParams::Embedded::Tag,
                Amocrm::Internal::AnyHash
              )
            end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::APIContactsUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
      ...
      class TagsToAdd < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIContactsUpdateByIDParams::TagsToAdd,
              Amocrm::Internal::AnyHash
            )
          end
      ...
      class TagsToDelete < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APIContactsUpdateByIDParams::TagsToDelete,
              Amocrm::Internal::AnyHash
            )
          end
