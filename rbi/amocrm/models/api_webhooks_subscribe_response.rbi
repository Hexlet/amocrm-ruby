  ...
  module Models
    module APIWebhooksSubscribeResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWebhooksSubscribeResponse::Webhook,
            Amocrm::Models::APIWebhooksSubscribeResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWebhooksSubscribeResponse::Variants]
        )
      end
      def self.variants
      end
