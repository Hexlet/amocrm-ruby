  ...
  module Models
    module V4CustomFieldsListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomFieldsListResponse::CustomFieldListResponse,
            Amocrm::Models::V4CustomFieldsListResponse::Problem
          )
        end
      ...
      class CustomFieldListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CustomFieldsListResponse::CustomFieldListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CustomFieldsListResponse::CustomFieldListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomFieldsListResponse::CustomFieldListResponse::Embedded::CustomField
                ]
              )
            )
          end
          ...
          sig do
            params(
              custom_fields:
                T::Array[
                  Amocrm::Models::V4CustomFieldsListResponse::CustomFieldListResponse::Embedded::CustomField::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomFieldsListResponse::Variants]
        )
      end
      def self.variants
      end
