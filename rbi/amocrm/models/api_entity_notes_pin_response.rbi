  ...
  module Models
    module APIEntityNotesPinResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityNotesPinResponse::EmptyResponse,
            Amocrm::Models::APIEntityNotesPinResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityNotesPinResponse::Variants]
        )
      end
      def self.variants
      end
