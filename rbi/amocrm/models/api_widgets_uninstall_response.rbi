  ...
  module Models
    module APIWidgetsUninstallResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIWidgetsUninstallResponse::EmptyResponse,
            Amocrm::Models::APIWidgetsUninstallResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIWidgetsUninstallResponse::Variants]
        )
      end
      def self.variants
      end
