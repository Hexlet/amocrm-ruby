...
module Amocrm
  module Models
    class APICompaniesUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APICompaniesUpdateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APICompaniesUpdateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APICompaniesUpdateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICompaniesUpdateParams::Body,
        ...
        sig do
          returns(T.nilable(Amocrm::APICompaniesUpdateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::APICompaniesUpdateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::APICompaniesUpdateParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APICompaniesUpdateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APICompaniesUpdateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[
                Amocrm::APICompaniesUpdateParams::Body::TagsToAdd::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APICompaniesUpdateParams::Body::TagsToDelete]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[
                Amocrm::APICompaniesUpdateParams::Body::TagsToDelete::OrHash
              ]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              id: Integer,
              _embedded: Amocrm::APICompaniesUpdateParams::Body::Embedded,
              created_at: Integer,
              created_by: Integer,
              custom_fields_values:
                T::Array[
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICompaniesUpdateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APICompaniesUpdateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_accessor :tags
          ...
          sig do
            params(
              tags:
                T.nilable(
                  T::Array[
                    Amocrm::APICompaniesUpdateParams::Body::Embedded::Tag::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
            ...
            override.returns(
              {
                tags:
                  T.nilable(
                    T::Array[
                      Amocrm::APICompaniesUpdateParams::Body::Embedded::Tag
                    ]
                  )
              }
            )
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APICompaniesUpdateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APICompaniesUpdateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APICompaniesUpdateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICompaniesUpdateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
        ...
        class TagsToDelete < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICompaniesUpdateParams::Body::TagsToDelete,
                Amocrm::Internal::AnyHash
              )
            end
