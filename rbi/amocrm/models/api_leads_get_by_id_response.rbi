  ...
  module Models
    module APILeadsGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APILeadsGetByIDResponse::Lead,
            Amocrm::Models::APILeadsGetByIDResponse::Problem
          )
        end
      ...
      class Lead < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::OrHash
                ]
              ),
            group_id: Integer,
          ...
          override.returns(
            {
              id: Integer,
              _embedded:
                Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded,
              _links: T.anything,
              account_id: Integer,
              closed_at: Integer,
              closest_task_at: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::CatalogElement
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalog_elements:
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::CatalogElement::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Company
                ]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::LossReason
              )
            )
          end
          ...
          sig do
            params(
              loss_reason:
                Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::LossReason::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source
              )
            )
          end
          attr_reader :source
          ...
          sig do
            params(
              source:
                Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source::OrHash
            ).void
          end
          attr_writer :source
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
          ...
          class Source < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::Embedded::Source::ExternalID::Variants
                )
              )
            end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::Models::APILeadsGetByIDResponse::Lead::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APILeadsGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
