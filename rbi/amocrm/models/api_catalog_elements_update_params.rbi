  ...
  module Models
    class APICatalogElementsUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::APICatalogElementsUpdateParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig { returns(T::Array[Amocrm::APICatalogElementsUpdateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APICatalogElementsUpdateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICatalogElementsUpdateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::APICatalogElementsUpdateParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APICatalogElementsUpdateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APICatalogElementsUpdateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APICatalogElementsUpdateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer,
              field_name: String,
