  ...
  module Models
    module APIEntityNotesByParentUpdateByParentIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityNotesByParentUpdateByParentIDResponse::NoteCreateResponse,
            Amocrm::Models::APIEntityNotesByParentUpdateByParentIDResponse::Problem
          )
        end
      ...
      class NoteCreateResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIEntityNotesByParentUpdateByParentIDResponse::NoteCreateResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIEntityNotesByParentUpdateByParentIDResponse::NoteCreateResponse::Embedded::Note
                ]
              )
            )
          end
          ...
          sig do
            params(
              notes:
                T::Array[
                  Amocrm::Models::APIEntityNotesByParentUpdateByParentIDResponse::NoteCreateResponse::Embedded::Note::OrHash
                ]
            ).void
          end
          attr_writer :notes
