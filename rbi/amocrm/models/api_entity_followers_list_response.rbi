  ...
  module Models
    module APIEntityFollowersListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::APIEntityFollowersListResponse::EntityFollowerListResponse,
            Amocrm::Models::APIEntityFollowersListResponse::Problem
          )
        end
      ...
      class EntityFollowerListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::APIEntityFollowersListResponse::EntityFollowerListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::APIEntityFollowersListResponse::EntityFollowerListResponse::Embedded::Follower
                ]
              )
            )
          end
          ...
          sig do
            params(
              followers:
                T::Array[
                  Amocrm::Models::APIEntityFollowersListResponse::EntityFollowerListResponse::Embedded::Follower::OrHash
                ]
            ).void
          end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::APIEntityFollowersListResponse::Variants]
        )
      end
      def self.variants
      end
