  ...
  module Models
    module V4CustomersGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4CustomersGetByIDResponse::Customer,
            Amocrm::Models::V4CustomersGetByIDResponse::Problem
          )
        end
      ...
      class Customer < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::V4CustomersGetByIDResponse::Customer::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            ...
            custom_fields_values:
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::CustomFieldsValue::OrHash
                ]
              ),
            group_id: Integer,
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::CatalogElement
                ]
              )
            )
          end
          ...
          sig do
            params(
              catalog_elements:
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::CatalogElement::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Company
                ]
              )
            )
          end
          ...
          sig do
            params(
              companies:
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Company::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Contact
                ]
              )
            )
          end
          ...
          sig do
            params(
              contacts:
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Contact::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Segment
                ]
              )
            )
          end
          ...
          sig do
            params(
              segments:
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Segment::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              tags:
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::Embedded::Tag::OrHash
                ]
            ).void
          end
          attr_writer :tags
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::Models::V4CustomersGetByIDResponse::Customer::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::Models::V4CustomersGetByIDResponse::Customer::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::Models::V4CustomersGetByIDResponse::Customer::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4CustomersGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
