  ...
  module Models
    module V4WebsiteButtonsCreateResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WebsiteButtonsCreateResponse::WebsiteButtonCreateResponse,
            Amocrm::Models::V4WebsiteButtonsCreateResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WebsiteButtonsCreateResponse::Variants]
        )
      end
      def self.variants
      end
