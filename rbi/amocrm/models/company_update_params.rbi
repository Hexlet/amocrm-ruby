  ...
  module Models
    class CompanyUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::CompanyUpdateParams::Body::TagsToAdd])
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[Amocrm::CompanyUpdateParams::Body::TagsToAdd::OrHash]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::CompanyUpdateParams::Body::TagsToDelete])
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[Amocrm::CompanyUpdateParams::Body::TagsToDelete::OrHash]
          ).void
        end
