  ...
  module Models
    module V4WidgetsInstallResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WidgetsInstallResponse::Widget,
            Amocrm::Models::V4WidgetsInstallResponse::Problem
          )
        end
      ...
      class Widget < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4WidgetsInstallResponse::Widget::Rating::Variants
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::Models::V4WidgetsInstallResponse::Widget::SettingsTemplate
              ]
            )
          )
        end
        ...
        sig do
          params(
            settings_template:
              T::Array[
                Amocrm::Models::V4WidgetsInstallResponse::Widget::SettingsTemplate::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4WidgetsInstallResponse::Widget::Version::Variants
            )
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4WidgetsInstallResponse::Variants]
        )
      end
      def self.variants
      end
