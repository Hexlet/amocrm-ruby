  ...
  module Models
    class SourceListParams < Amocrm::Internal::Type::BaseModel
      ...
      class Filter < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::SourceListParams::Filter::ExternalID::Variants)
          )
        end
        ...
        sig do
          params(
            external_id: Amocrm::SourceListParams::Filter::ExternalID::Variants
          ).void
        end
        ...
        module ExternalID
          ...
          sig do
            override.returns(
              T::Array[Amocrm::SourceListParams::Filter::ExternalID::Variants]
            )
          end
          def self.variants
          end
