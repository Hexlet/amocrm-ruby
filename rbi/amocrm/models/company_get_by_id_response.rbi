  ...
  module Models
    module CompanyGetByIDResponse
      ...
      class Company < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Amocrm::Models::CompanyGetByIDResponse::Company::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::CompanyGetByIDResponse::Company::Embedded::OrHash
          ).void
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::CompanyGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
