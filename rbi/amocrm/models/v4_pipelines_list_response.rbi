  ...
  module Models
    module V4PipelinesListResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4PipelinesListResponse::PipelineListResponse,
            Amocrm::Models::V4PipelinesListResponse::Problem
          )
        end
      ...
      class PipelineListResponse < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded
            )
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::Pipeline
                ]
              )
            )
          end
          ...
          sig do
            params(
              pipelines:
                T::Array[
                  Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::Pipeline::OrHash
                ]
            ).void
          end
          ...
          class Pipeline < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::Pipeline::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::Pipeline::Embedded::Status
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  statuses:
                    T::Array[
                      Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::Pipeline::Embedded::Status::OrHash
                    ]
                ).void
              end
                ...
                sig do
                  params(
                    ...
                    descriptions:
                      T.nilable(
                        T::Array[
                          Amocrm::Models::V4PipelinesListResponse::PipelineListResponse::Embedded::Pipeline::Embedded::Status::Description::OrHash
                        ]
                      ),
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4PipelinesListResponse::Variants]
        )
      end
      def self.variants
      end
