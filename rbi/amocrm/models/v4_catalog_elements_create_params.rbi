  ...
  module Models
    class V4CatalogElementsCreateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Amocrm::V4CatalogElementsCreateParams,
            Amocrm::Internal::AnyHash
          )
        end

      sig { returns(T::Array[Amocrm::V4CatalogElementsCreateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::V4CatalogElementsCreateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4CatalogElementsCreateParams::Body,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::V4CatalogElementsCreateParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::V4CatalogElementsCreateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::V4CatalogElementsCreateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::V4CatalogElementsCreateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer,
              field_name: String,
