    ...
    class UnsortedLeadCreateFormsParams < Amocrm::Internal::Type::BaseModel
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          params(
            metadata:
              Amocrm::UnsortedLeadCreateFormsParams::Body::Metadata::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Amocrm::UnsortedLeadCreateFormsParams::Body::Embedded)
          )
        end
        ...
        sig do
          params(
            _embedded:
              Amocrm::UnsortedLeadCreateFormsParams::Body::Embedded::OrHash
          ).void
        end
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          ...
          class Lead < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              params(
                _embedded:
                  Amocrm::UnsortedLeadCreateFormsParams::Body::Embedded::Lead::Embedded::OrHash
              ).void
            end
            attr_writer :_embedded
            ...
            class Embedded < Amocrm::Internal::Type::BaseModel
              ...
              sig do
                params(
                  metadata:
                    Amocrm::UnsortedLeadCreateFormsParams::Body::Embedded::Lead::Embedded::Metadata::OrHash
                ).void
              end
              attr_writer :metadata
              ...
              sig do
                params(
                  source:
                    Amocrm::UnsortedLeadCreateFormsParams::Body::Embedded::Lead::Embedded::Source::OrHash
                ).void
              end
              attr_writer :source
