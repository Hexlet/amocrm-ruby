...
module Amocrm
  module Models
    class CustomerUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::CustomerUpdateByIDParams::TagsToAdd])
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::CustomerUpdateByIDParams::TagsToDelete])
        )
      end
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Amocrm::CustomerUpdateByIDParams::Embedded::Tag])
          )
        end
        attr_accessor :tags
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[Amocrm::CustomerUpdateByIDParams::CustomFieldsValue::Value]
          )
        end
