  ...
  module Models
    module V4SourcesDeleteResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4SourcesDeleteResponse::EmptyResponse,
            Amocrm::Models::V4SourcesDeleteResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4SourcesDeleteResponse::Variants]
        )
      end
      def self.variants
      end
