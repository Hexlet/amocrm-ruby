...
module Amocrm
  module Models
    class V4TasksUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      extend Amocrm::Internal::Type::RequestParameters::Converter
      include Amocrm::Internal::Type::RequestParameters

      OrHash =
        T.type_alias do
          T.any(Amocrm::V4TasksUpdateByIDParams, Amocrm::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Amocrm::V4TasksUpdateByIDParams::Result)) }
      attr_reader :result

      sig do
        params(result: Amocrm::V4TasksUpdateByIDParams::Result::OrHash).void
      end
      attr_writer :result
        ...
        override.returns(
          {
            ...
            is_completed: T::Boolean,
            responsible_user_id: Integer,
            result: Amocrm::V4TasksUpdateByIDParams::Result,
            task_type_id: Integer,
            text: String,
      ...
      class Result < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::V4TasksUpdateByIDParams::Result,
