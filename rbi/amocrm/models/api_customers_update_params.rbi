...
module Amocrm
  module Models
    class APICustomersUpdateParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APICustomersUpdateParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T::Array[Amocrm::APICustomersUpdateParams::Body]) }
      attr_accessor :body
      ...
      sig do
        override.returns(
          {
            body: T::Array[Amocrm::APICustomersUpdateParams::Body],
      ...
      class Body < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICustomersUpdateParams::Body,
        ...
        sig do
          returns(T.nilable(Amocrm::APICustomersUpdateParams::Body::Embedded))
        end
        attr_reader :_embedded

        sig do
          params(
            _embedded: Amocrm::APICustomersUpdateParams::Body::Embedded::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Amocrm::APICustomersUpdateParams::Body::CustomFieldsValue
              ]
            )
          )
        end
        ...
        sig do
          params(
            custom_fields_values:
              T::Array[
                Amocrm::APICustomersUpdateParams::Body::CustomFieldsValue::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APICustomersUpdateParams::Body::TagsToAdd]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_add:
              T::Array[
                Amocrm::APICustomersUpdateParams::Body::TagsToAdd::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APICustomersUpdateParams::Body::TagsToDelete]
            )
          )
        end
        ...
        sig do
          params(
            tags_to_delete:
              T::Array[
                Amocrm::APICustomersUpdateParams::Body::TagsToDelete::OrHash
              ]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              id: Integer,
              _embedded: Amocrm::APICustomersUpdateParams::Body::Embedded,
              custom_fields_values:
                T::Array[
                  Amocrm::APICustomersUpdateParams::Body::CustomFieldsValue
                ],
        ...
        class Embedded < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICustomersUpdateParams::Body::Embedded,
                Amocrm::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Amocrm::APICustomersUpdateParams::Body::Embedded::Segment
                ]
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Amocrm::APICustomersUpdateParams::Body::Embedded::Tag]
              )
            )
          end
          attr_accessor :tags
          ...
          sig do
            params(
              segments:
                T.nilable(
                  T::Array[
                    Amocrm::APICustomersUpdateParams::Body::Embedded::Segment::OrHash
                  ]
                ),
              tags:
                T.nilable(
                  T::Array[
                    Amocrm::APICustomersUpdateParams::Body::Embedded::Tag::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
            ...
            override.returns(
              {
                ...
                tags:
                  T.nilable(
                    T::Array[
                      Amocrm::APICustomersUpdateParams::Body::Embedded::Tag
                    ]
                  )
              }
            )
        ...
        class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Amocrm::APICustomersUpdateParams::Body::CustomFieldsValue::Value
              ]
            )
          end
          ...
          sig do
            params(
              values:
                T::Array[
                  Amocrm::APICustomersUpdateParams::Body::CustomFieldsValue::Value::OrHash
                ],
              field_code: String,
              field_id: Integer
            ).returns(T.attached_class)
          ...
          class Value < Amocrm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Amocrm::APICustomersUpdateParams::Body::CustomFieldsValue::Value::Value::Variants
              )
            end
            attr_accessor :value
        ...
        class TagsToAdd < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICustomersUpdateParams::Body::TagsToAdd,
                Amocrm::Internal::AnyHash
              )
            end
        ...
        class TagsToDelete < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICustomersUpdateParams::Body::TagsToDelete,
                Amocrm::Internal::AnyHash
              )
            end
