  ...
  module Models
    module V4RolesDeleteByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4RolesDeleteByIDResponse::EmptyResponse,
            Amocrm::Models::V4RolesDeleteByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4RolesDeleteByIDResponse::Variants]
        )
      end
      def self.variants
      end
