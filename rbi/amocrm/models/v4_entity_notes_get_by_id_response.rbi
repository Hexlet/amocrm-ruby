  ...
  module Models
    module V4EntityNotesGetByIDResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4EntityNotesGetByIDResponse::Note,
            Amocrm::Models::V4EntityNotesGetByIDResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[Amocrm::Models::V4EntityNotesGetByIDResponse::Variants]
        )
      end
      def self.variants
      end
