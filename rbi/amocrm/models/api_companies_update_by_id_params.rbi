...
module Amocrm
  module Models
    class APICompaniesUpdateByIDParams < Amocrm::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Amocrm::APICompaniesUpdateByIDParams, Amocrm::Internal::AnyHash)
        end

      sig { returns(T.nilable(Amocrm::APICompaniesUpdateByIDParams::Embedded)) }
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::APICompaniesUpdateByIDParams::CustomFieldsValue]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Amocrm::APICompaniesUpdateByIDParams::TagsToAdd])
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Amocrm::APICompaniesUpdateByIDParams::TagsToDelete]
          )
        )
      end
      ...
      sig do
        params(
          tags_to_delete:
            T::Array[Amocrm::APICompaniesUpdateByIDParams::TagsToDelete::OrHash]
        ).void
      end
      ...
      sig do
        override.returns(
          {
            _embedded: Amocrm::APICompaniesUpdateByIDParams::Embedded,
            created_at: Integer,
            created_by: Integer,
            custom_fields_values:
              T::Array[Amocrm::APICompaniesUpdateByIDParams::CustomFieldsValue],
            ...
            responsible_user_id: Integer,
            tags_to_add:
              T::Array[Amocrm::APICompaniesUpdateByIDParams::TagsToAdd],
            tags_to_delete:
              T::Array[Amocrm::APICompaniesUpdateByIDParams::TagsToDelete],
            updated_at: Integer,
            updated_by: Integer,
      ...
      class Embedded < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICompaniesUpdateByIDParams::Embedded,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Amocrm::APICompaniesUpdateByIDParams::Embedded::Tag]
            )
          )
        end
        attr_accessor :tags
        ...
        sig do
          params(
            tags:
              T.nilable(
                T::Array[
                  Amocrm::APICompaniesUpdateByIDParams::Embedded::Tag::OrHash
                ]
              )
          ).returns(T.attached_class)
        end
        ...
        class Tag < Amocrm::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Amocrm::APICompaniesUpdateByIDParams::Embedded::Tag,
                Amocrm::Internal::AnyHash
              )
            end
      ...
      class CustomFieldsValue < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICompaniesUpdateByIDParams::CustomFieldsValue,
              Amocrm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              Amocrm::APICompaniesUpdateByIDParams::CustomFieldsValue::Value
            ]
          )
        end
        ...
        sig do
          params(
            values:
              T::Array[
                Amocrm::APICompaniesUpdateByIDParams::CustomFieldsValue::Value::OrHash
              ],
            field_code: String,
            field_id: Integer
          ).returns(T.attached_class)
        ...
        class Value < Amocrm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Amocrm::APICompaniesUpdateByIDParams::CustomFieldsValue::Value::Value::Variants
            )
          end
          attr_accessor :value
      ...
      class TagsToAdd < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICompaniesUpdateByIDParams::TagsToAdd,
              Amocrm::Internal::AnyHash
            )
          end
      ...
      class TagsToDelete < Amocrm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Amocrm::APICompaniesUpdateByIDParams::TagsToDelete,
              Amocrm::Internal::AnyHash
            )
          end
