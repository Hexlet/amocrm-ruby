  ...
  module Models
    module V4WidgetBotContinueContinueResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Amocrm::Models::V4WidgetBotContinueContinueResponse::EmptyResponse,
            Amocrm::Models::V4WidgetBotContinueContinueResponse::Problem
          )
        end
      ...
      sig do
        override.returns(
          T::Array[
            Amocrm::Models::V4WidgetBotContinueContinueResponse::Variants
          ]
        )
      end
      def self.variants
