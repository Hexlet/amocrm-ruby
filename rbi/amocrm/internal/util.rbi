      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Amocrm::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Amocrm::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Amocrm::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Amocrm::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
